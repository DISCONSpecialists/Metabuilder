/*
	...
	Important: Do not modify this file. Edit the file METAView_BusinessCompetency_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_BusinessCompetency_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_BusinessCompetency_ListingBase")]
	public abstract partial class METAView_BusinessCompetency_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_BusinessCompetency_ListingBase"/> instance.
		///</summary>
		public METAView_BusinessCompetency_ListingBase()
		{
		}		
		...
		public METAView_BusinessCompetency_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_BusinessCompetency_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_vCMachineID"></param>
		///<param name="_name"></param>
		public static METAView_BusinessCompetency_Listing CreateMETAView_BusinessCompetency_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
			METAView_BusinessCompetency_Listing newMETAView_BusinessCompetency_Listing = new METAView_BusinessCompetency_Listing();
			newMETAView_BusinessCompetency_Listing.WorkspaceName = _workspaceName;
			newMETAView_BusinessCompetency_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_BusinessCompetency_Listing.VCStatusID = _vCStatusID;
			newMETAView_BusinessCompetency_Listing.pkid = _pkid;
			newMETAView_BusinessCompetency_Listing.Machine = _machine;
			newMETAView_BusinessCompetency_Listing.VCMachineID = _vCMachineID;
			newMETAView_BusinessCompetency_Listing.Name = _name;
			return newMETAView_BusinessCompetency_Listing;
		}
		...
		{
			get { return "METAView_BusinessCompetency_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_BusinessCompetency_ListingBase Entity 
		///</summary>
		public virtual METAView_BusinessCompetency_ListingBase Copy()
		{
			//shallow copy entity
			METAView_BusinessCompetency_Listing copy = new METAView_BusinessCompetency_Listing();
				...
				copy.Name = this.Name;
			copy.AcceptChanges();
			return (METAView_BusinessCompetency_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_BusinessCompetency_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_BusinessCompetency_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_BusinessCompetency_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_BusinessCompetency_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_BusinessCompetency_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_BusinessCompetency_ListingBase Object1, METAView_BusinessCompetency_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_BusinessCompetency_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_BusinessCompetency_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_BusinessCompetency_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_BusinessCompetency_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
