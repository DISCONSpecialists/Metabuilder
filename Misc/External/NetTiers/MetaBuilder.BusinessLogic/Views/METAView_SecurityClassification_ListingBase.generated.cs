/*
	...
	Important: Do not modify this file. Edit the file METAView_SecurityClassification_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_SecurityClassification_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_SecurityClassification_ListingBase")]
	public abstract partial class METAView_SecurityClassification_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_SecurityClassification_ListingBase"/> instance.
		///</summary>
		public METAView_SecurityClassification_ListingBase()
		{
		}		
		...
		public METAView_SecurityClassification_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_SecurityClassification_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_SecurityClassification_Listing CreateMETAView_SecurityClassification_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_SecurityClassification_Listing newMETAView_SecurityClassification_Listing = new METAView_SecurityClassification_Listing();
			newMETAView_SecurityClassification_Listing.WorkspaceName = _workspaceName;
			newMETAView_SecurityClassification_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_SecurityClassification_Listing.VCStatusID = _vCStatusID;
			newMETAView_SecurityClassification_Listing.pkid = _pkid;
			newMETAView_SecurityClassification_Listing.Machine = _machine;
			newMETAView_SecurityClassification_Listing.VCMachineID = _vCMachineID;
			return newMETAView_SecurityClassification_Listing;
		}
		...
		{
			get { return "METAView_SecurityClassification_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_SecurityClassification_ListingBase Entity 
		///</summary>
		public virtual METAView_SecurityClassification_ListingBase Copy()
		{
			//shallow copy entity
			METAView_SecurityClassification_Listing copy = new METAView_SecurityClassification_Listing();
			...
			copy.AcceptChanges();
			return (METAView_SecurityClassification_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_SecurityClassification_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_SecurityClassification_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_SecurityClassification_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_SecurityClassification_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_SecurityClassification_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_SecurityClassification_ListingBase Object1, METAView_SecurityClassification_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_SecurityClassification_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_SecurityClassification_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_SecurityClassification_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_SecurityClassification_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
