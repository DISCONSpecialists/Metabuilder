/*
	...
	Important: Do not modify this file. Edit the file METAViewCADListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewCADListingBase")]
	public abstract partial class METAViewCADListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewCADListingBase"/> instance.
		///</summary>
		public METAViewCADListingBase()
		{
		}		
		...
		public METAViewCADListingBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewCADListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAViewCADListing CreateMETAViewCADListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAViewCADListing newMETAViewCADListing = new METAViewCADListing();
			newMETAViewCADListing.WorkspaceName = _workspaceName;
			newMETAViewCADListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewCADListing.VCStatusID = _vCStatusID;
			newMETAViewCADListing.Pkid = _pkid;
			newMETAViewCADListing.Machine = _machine;
			newMETAViewCADListing.VCMachineID = _vCMachineID;
			return newMETAViewCADListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewCADListingBase Entity 
		///</summary>
		public virtual METAViewCADListingBase Copy()
		{
			//shallow copy entity
			METAViewCADListing copy = new METAViewCADListing();
			...
			copy.AcceptChanges();
			return (METAViewCADListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewCADListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewCADListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewCADListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewCADListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewCADListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewCADListingBase Object1, METAViewCADListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewCADListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewCADListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewCADListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewCADListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
