		...
		protected VList<METAView_JobPosition_Listing> Fill(IDataReader reader, VList<METAView_JobPosition_Listing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.Description = (reader.IsDBNull(((int)METAView_JobPosition_ListingColumn.Description)))?null:(System.String)reader[((int)METAView_JobPosition_ListingColumn.Description)];
					//entity.Description = (Convert.IsDBNull(reader["Description"]))?string.Empty:(System.String)reader["Description"];
					entity.Abbreviation = (reader.IsDBNull(((int)METAView_JobPosition_ListingColumn.Abbreviation)))?null:(System.String)reader[((int)METAView_JobPosition_ListingColumn.Abbreviation)];
					//entity.Abbreviation = (Convert.IsDBNull(reader["Abbreviation"]))?string.Empty:(System.String)reader["Abbreviation"];
					entity.IsBusinessExternal = (reader.IsDBNull(((int)METAView_JobPosition_ListingColumn.IsBusinessExternal)))?null:(System.String)reader[((int)METAView_JobPosition_ListingColumn.IsBusinessExternal)];
					...
					entity.DataSourceID = (reader.IsDBNull(((int)METAView_JobPosition_ListingColumn.DataSourceID)))?null:(System.String)reader[((int)METAView_JobPosition_ListingColumn.DataSourceID)];
					//entity.DataSourceID = (Convert.IsDBNull(reader["DataSourceID"]))?string.Empty:(System.String)reader["DataSourceID"];
					entity.DataSourceName = (reader.IsDBNull(((int)METAView_JobPosition_ListingColumn.DataSourceName)))?null:(System.String)reader[((int)METAView_JobPosition_ListingColumn.DataSourceName)];
					//entity.DataSourceName = (Convert.IsDBNull(reader["DataSourceName"]))?string.Empty:(System.String)reader["DataSourceName"];
					entity.GeneralRemarks = (reader.IsDBNull(((int)METAView_JobPosition_ListingColumn.GeneralRemarks)))?null:(System.String)reader[((int)METAView_JobPosition_ListingColumn.GeneralRemarks)];
