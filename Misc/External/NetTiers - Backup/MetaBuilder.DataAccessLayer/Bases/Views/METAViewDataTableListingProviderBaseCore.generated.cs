		...
		protected VList<METAViewDataTableListing> Fill(IDataReader reader, VList<METAViewDataTableListing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.InitialPopulation = (reader.IsDBNull(reader.GetOrdinal("InitialPopulation")))?null:(System.Int32?)reader["InitialPopulation"];
					//entity.InitialPopulation = (Convert.IsDBNull(reader["InitialPopulation"]))?(int)0:(System.Int32?)reader["InitialPopulation"];
					entity.GrowthRateOverTime = (reader.IsDBNull(reader.GetOrdinal("GrowthRateOverTime")))?null:(System.String)reader["GrowthRateOverTime"];
					...
					entity.RecordSize = (reader.IsDBNull(reader.GetOrdinal("RecordSize")))?null:(System.String)reader["RecordSize"];
