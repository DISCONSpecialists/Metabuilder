...
namespace MetaBuilder.BusinessLogic
{
	...
	{		
		...
		public UserBase(System.String _name, System.String _password, System.DateTime? _createDate, 
		...
		///<param name="_createDate"></param>
		///<param name="_lastLogin"></param>
		public static User CreateUser(System.String _name, System.String _password, System.DateTime? _createDate, 
			System.DateTime? _lastLogin)
		{
			User newUser = new User();
			newUser.Name = _name;
			newUser.Password = _password;
			newUser.CreateDate = _createDate;
		...
		public virtual System.Int32 pkid
		{
			...
			set
			{
				...
				OnColumnChanging(UserColumn.pkid, this.entityData.pkid);
				this.entityData.pkid = value;
				this.EntityId.pkid = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.pkid, this.entityData.pkid);
		...
		public virtual System.DateTime? CreateDate
		{
			...
			set
			{
				...
				OnColumnChanging(UserColumn.CreateDate, this.entityData.CreateDate);
				this.entityData.CreateDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.CreateDate, this.entityData.CreateDate);
				OnPropertyChanged("CreateDate");
			}
		}
		
		/// <summary>
		/// 	Gets or sets the LastLogin property. 
		///		
		/// </summary>
		/// <value>This type is datetime.</value>
		/// <remarks>
		/// This property can be set to null. 
		/// If this column is null, this property will return DateTime.MinValue. It is up to the developer
		/// to check the value of IsLastLoginNull() and perform business logic appropriately.
		/// </remarks>
		...
		public virtual System.DateTime? LastLogin
		{
			get
			{
				return this.entityData.LastLogin; 
			}
			
			set
			{
				if (this.entityData.LastLogin == value)
					return;
					
				OnColumnChanging(UserColumn.LastLogin, this.entityData.LastLogin);
				this.entityData.LastLogin = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.LastLogin, this.entityData.LastLogin);
		...
		///	which are related to this object through the relation FK_UserPermission_User
		/// </summary>	
		...
		///	which are related to this object through the relation FK_Object_User
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		...
		/// <summary>
		///	Holds a collection of WorkspaceFromUserPermission objects
		///	which are related to this object through the junction table UserPermission
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		public virtual TList<Workspace> WorkspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission
		{
			get { return entityData.WorkspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission; }
			set { entityData.WorkspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission = value; }	
		}
		...
		protected override void AddValidationRules()
		{
			...
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("Password", "Password", 100));
		}
   		#endregion
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"pkid", "Name", "Password", "CreateDate", "LastLogin"};
			}
		}
		#endregion 
		...
		protected virtual User Copy(IDictionary existingCopies)
		{
			...
			copy.WorkspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission = (TList<Workspace>) MakeCopyOf(this.WorkspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission, existingCopies); 
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.LastLogin != _originalData.LastLogin;
			return result;
		}	
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.pkid.GetHashCode() ^ 
					...
					((this.LastLogin == null) ? string.Empty : this.LastLogin.ToString()).GetHashCode();
        }
		...
		public static bool ValueEquals(UserBase Object1, UserBase Object2)
		{
			...
			if ( Object1.LastLogin != null && Object2.LastLogin != null )
			{
				if (Object1.LastLogin != Object2.LastLogin)
					equal = false;
			}
			else if (Object1.LastLogin == null ^ Object2.LastLogin == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(User rhs, UserColumn which)
        {
            switch (which)
            {
            	...
            	case UserColumn.LastLogin:
            		return this.LastLogin.Value.CompareTo(rhs.LastLogin.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{6}{5}- pkid: {0}{5}- Name: {1}{5}- Password: {2}{5}- CreateDate: {3}{5}- LastLogin: {4}{5}{7}", 
				this.pkid,
				this.Name,
				this.Password,
				(this.CreateDate == null) ? string.Empty : this.CreateDate.ToString(),
				(this.LastLogin == null) ? string.Empty : this.LastLogin.ToString(),
	...
	internal protected class UserEntityData : ICloneable, ICloneableEx
	{
		...
		/// LastLogin : 
		/// </summary>
		public System.DateTime?		  LastLogin = null;
		#endregion
		...
		private TList<UserPermission> _userPermissionUserID;
		...
		public TList<UserPermission> UserPermissionCollection
		{
			get
			{
				if (_userPermissionUserID == null)
				{
				_userPermissionUserID = new TList<UserPermission>();
				}
	
				return _userPermissionUserID;
			}
			set { _userPermissionUserID = value; }
		}
		...
		private TList<MetaObject> _metaObjectUserID;
		...
		public TList<MetaObject> MetaObjectCollection
		{
			get
			{
				if (_metaObjectUserID == null)
				{
				_metaObjectUserID = new TList<MetaObject>();
				}
	
				return _metaObjectUserID;
			}
			set { _metaObjectUserID = value; }
		}
		...
		private TList<Workspace> workspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission;
		...
		public TList<Workspace> WorkspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission
		{
			get
			{
				if (workspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission == null)
				{
				workspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission = new TList<Workspace>();
				}
	
				return workspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission;
			}
			set { workspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission = value; }
		}
		...
		public Object Clone()
		{
			...
			//deep copy nested objects
			if (this._userPermissionUserID != null)
				_tmp.UserPermissionCollection = (TList<UserPermission>) MakeCopyOf(this.UserPermissionCollection); 
			if (this._metaObjectUserID != null)
				_tmp.MetaObjectCollection = (TList<MetaObject>) MakeCopyOf(this.MetaObjectCollection); 
			if (this.workspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission != null)
				_tmp.WorkspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission = (TList<Workspace>) MakeCopyOf(this.WorkspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission); 
		...
		public object Clone(IDictionary existingCopies)
		{
			...
			_tmp.WorkspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission = (TList<Workspace>) MakeCopyOf(this.WorkspaceNameWorkspaceTypeIdWorkspaceCollection_From_UserPermission, existingCopies); 
			#endregion Child Collections
	...
	public class UserKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the UserKey class.
		/// </summary>
		public UserKey(System.Int32 _pkid)
		{
			#region Init Properties
	...
	public enum UserColumn : int
	{
		...
		[ColumnEnum("Password", typeof(System.String), System.Data.DbType.AnsiString, false, false, false, 100)]
		Password = 3,
		/// <summary>
		/// CreateDate : 
		/// </summary>
		...
		/// LastLogin : 
		/// </summary>
		[EnumTextValue("LastLogin")]
		[ColumnEnum("LastLogin", typeof(System.DateTime), System.Data.DbType.DateTime, false, false, true)]
		LastLogin = 5
	}//End enum
