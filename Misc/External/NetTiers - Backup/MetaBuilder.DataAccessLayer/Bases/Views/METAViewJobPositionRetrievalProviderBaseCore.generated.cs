		...
		protected VList<METAViewJobPositionRetrieval> Fill(IDataReader reader, VList<METAViewJobPositionRetrieval> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.TotalRequired = (reader.IsDBNull(reader.GetOrdinal("TotalRequired")))?null:(System.Int32?)reader["TotalRequired"];
					//entity.TotalRequired = (Convert.IsDBNull(reader["TotalRequired"]))?(int)0:(System.Int32?)reader["TotalRequired"];
					entity.TotalOccupied = (reader.IsDBNull(reader.GetOrdinal("TotalOccupied")))?null:(System.Int32?)reader["TotalOccupied"];
					//entity.TotalOccupied = (Convert.IsDBNull(reader["TotalOccupied"]))?(int)0:(System.Int32?)reader["TotalOccupied"];
					entity.TotalAvailable = (reader.IsDBNull(reader.GetOrdinal("TotalAvailable")))?null:(System.Int32?)reader["TotalAvailable"];
					//entity.TotalAvailable = (Convert.IsDBNull(reader["TotalAvailable"]))?(int)0:(System.Int32?)reader["TotalAvailable"];
					entity.TimeStamp = (reader.IsDBNull(reader.GetOrdinal("TimeStamp")))?null:(System.DateTime?)reader["TimeStamp"];
