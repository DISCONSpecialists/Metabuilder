...
{	
		...
		protected VList<METAViewIterationRetrieval> Fill(IDataReader reader, VList<METAViewIterationRetrieval> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.WorkspaceName = (System.String)reader[((int)METAViewIterationRetrievalColumn.WorkspaceName)];
					//entity.WorkspaceName = (Convert.IsDBNull(reader["WorkspaceName"]))?string.Empty:(System.String)reader["WorkspaceName"];
					entity.WorkspaceTypeID = (reader.IsDBNull(((int)METAViewIterationRetrievalColumn.WorkspaceTypeID)))?null:(System.Int32?)reader[((int)METAViewIterationRetrievalColumn.WorkspaceTypeID)];
					//entity.WorkspaceTypeID = (Convert.IsDBNull(reader["WorkspaceTypeID"]))?(int)0:(System.Int32?)reader["WorkspaceTypeID"];
					entity.VCStatusID = (System.Int32)reader[((int)METAViewIterationRetrievalColumn.VCStatusID)];
					//entity.VCStatusID = (Convert.IsDBNull(reader["VCStatusID"]))?(int)0:(System.Int32)reader["VCStatusID"];
					entity.Pkid = (System.Int32)reader[((int)METAViewIterationRetrievalColumn.Pkid)];
					//entity.Pkid = (Convert.IsDBNull(reader["pkid"]))?(int)0:(System.Int32)reader["pkid"];
					entity.Machine = (System.String)reader[((int)METAViewIterationRetrievalColumn.Machine)];
					//entity.Machine = (Convert.IsDBNull(reader["Machine"]))?string.Empty:(System.String)reader["Machine"];
					entity.VCMachineID = (reader.IsDBNull(((int)METAViewIterationRetrievalColumn.VCMachineID)))?null:(System.String)reader[((int)METAViewIterationRetrievalColumn.VCMachineID)];
					//entity.VCMachineID = (Convert.IsDBNull(reader["VCMachineID"]))?string.Empty:(System.String)reader["VCMachineID"];
					entity.Name = (reader.IsDBNull(((int)METAViewIterationRetrievalColumn.Name)))?null:(System.String)reader[((int)METAViewIterationRetrievalColumn.Name)];
					//entity.Name = (Convert.IsDBNull(reader["Name"]))?string.Empty:(System.String)reader["Name"];
					entity.IterationType = (reader.IsDBNull(((int)METAViewIterationRetrievalColumn.IterationType)))?null:(System.String)reader[((int)METAViewIterationRetrievalColumn.IterationType)];
					//entity.IterationType = (Convert.IsDBNull(reader["IterationType"]))?string.Empty:(System.String)reader["IterationType"];
					entity.CustomField1 = (reader.IsDBNull(((int)METAViewIterationRetrievalColumn.CustomField1)))?null:(System.String)reader[((int)METAViewIterationRetrievalColumn.CustomField1)];
					//entity.CustomField1 = (Convert.IsDBNull(reader["CustomField1"]))?string.Empty:(System.String)reader["CustomField1"];
					entity.CustomField2 = (reader.IsDBNull(((int)METAViewIterationRetrievalColumn.CustomField2)))?null:(System.String)reader[((int)METAViewIterationRetrievalColumn.CustomField2)];
					//entity.CustomField2 = (Convert.IsDBNull(reader["CustomField2"]))?string.Empty:(System.String)reader["CustomField2"];
					entity.CustomField3 = (reader.IsDBNull(((int)METAViewIterationRetrievalColumn.CustomField3)))?null:(System.String)reader[((int)METAViewIterationRetrievalColumn.CustomField3)];
					//entity.CustomField3 = (Convert.IsDBNull(reader["CustomField3"]))?string.Empty:(System.String)reader["CustomField3"];
					entity.GapType = (reader.IsDBNull(((int)METAViewIterationRetrievalColumn.GapType)))?null:(System.String)reader[((int)METAViewIterationRetrievalColumn.GapType)];
	...
	#region METAViewIterationRetrievalSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class METAViewIterationRetrievalSortBuilder : SqlSortBuilder<METAViewIterationRetrievalColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the METAViewIterationRetrievalSqlSortBuilder class.
		/// </summary>
		public METAViewIterationRetrievalSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion METAViewIterationRetrievalSortBuilder
