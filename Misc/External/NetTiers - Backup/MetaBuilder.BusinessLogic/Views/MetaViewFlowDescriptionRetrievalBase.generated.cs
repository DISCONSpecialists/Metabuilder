/*
	...
	Important: Do not modify this file. Edit the file METAViewFlowDescriptionRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewFlowDescriptionRetrievalBase")]
	public abstract partial class METAViewFlowDescriptionRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewFlowDescriptionRetrievalBase"/> instance.
		///</summary>
		public METAViewFlowDescriptionRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewFlowDescriptionRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_timeIndicator"></param>
		///<param name="_gapType"></param>
		public static METAViewFlowDescriptionRetrieval CreateMETAViewFlowDescriptionRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _sequence, System.String _condition, System.String _description, System.String _customField1, System.String _customField2, System.String _customField3, System.String _timeIndicator, System.String _gapType)
		{
			METAViewFlowDescriptionRetrieval newMETAViewFlowDescriptionRetrieval = new METAViewFlowDescriptionRetrieval();
			newMETAViewFlowDescriptionRetrieval.WorkspaceName = _workspaceName;
			newMETAViewFlowDescriptionRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewFlowDescriptionRetrieval.VCStatusID = _vCStatusID;
			newMETAViewFlowDescriptionRetrieval.Pkid = _pkid;
			newMETAViewFlowDescriptionRetrieval.Machine = _machine;
			newMETAViewFlowDescriptionRetrieval.VCMachineID = _vCMachineID;
			newMETAViewFlowDescriptionRetrieval.Sequence = _sequence;
			newMETAViewFlowDescriptionRetrieval.Condition = _condition;
			newMETAViewFlowDescriptionRetrieval.Description = _description;
			newMETAViewFlowDescriptionRetrieval.CustomField1 = _customField1;
			newMETAViewFlowDescriptionRetrieval.CustomField2 = _customField2;
			newMETAViewFlowDescriptionRetrieval.CustomField3 = _customField3;
			newMETAViewFlowDescriptionRetrieval.TimeIndicator = _timeIndicator;
			newMETAViewFlowDescriptionRetrieval.GapType = _gapType;
			return newMETAViewFlowDescriptionRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewFlowDescriptionRetrievalBase Entity 
		///</summary>
		public virtual METAViewFlowDescriptionRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewFlowDescriptionRetrieval copy = new METAViewFlowDescriptionRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewFlowDescriptionRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewFlowDescriptionRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewFlowDescriptionRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewFlowDescriptionRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewFlowDescriptionRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewFlowDescriptionRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewFlowDescriptionRetrievalBase Object1, METAViewFlowDescriptionRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewFlowDescriptionRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewFlowDescriptionRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewFlowDescriptionRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewFlowDescriptionRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
