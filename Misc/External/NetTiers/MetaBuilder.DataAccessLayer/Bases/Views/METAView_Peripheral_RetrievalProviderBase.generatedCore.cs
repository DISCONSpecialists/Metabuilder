		...
		protected VList<METAView_Peripheral_Retrieval> Fill(IDataReader reader, VList<METAView_Peripheral_Retrieval> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.Abbreviation = (reader.IsDBNull(((int)METAView_Peripheral_RetrievalColumn.Abbreviation)))?null:(System.String)reader[((int)METAView_Peripheral_RetrievalColumn.Abbreviation)];
					//entity.Abbreviation = (Convert.IsDBNull(reader["Abbreviation"]))?string.Empty:(System.String)reader["Abbreviation"];
					entity.IsBusinessExternal = (reader.IsDBNull(((int)METAView_Peripheral_RetrievalColumn.IsBusinessExternal)))?null:(System.String)reader[((int)METAView_Peripheral_RetrievalColumn.IsBusinessExternal)];
					...
					entity.StandardisationStatus = (reader.IsDBNull(((int)METAView_Peripheral_RetrievalColumn.StandardisationStatus)))?null:(System.String)reader[((int)METAView_Peripheral_RetrievalColumn.StandardisationStatus)];
					...
					entity.StandardisationStatusDate = (reader.IsDBNull(((int)METAView_Peripheral_RetrievalColumn.StandardisationStatusDate)))?null:(System.String)reader[((int)METAView_Peripheral_RetrievalColumn.StandardisationStatusDate)];
					...
					entity.DataSourceID = (reader.IsDBNull(((int)METAView_Peripheral_RetrievalColumn.DataSourceID)))?null:(System.String)reader[((int)METAView_Peripheral_RetrievalColumn.DataSourceID)];
					//entity.DataSourceID = (Convert.IsDBNull(reader["DataSourceID"]))?string.Empty:(System.String)reader["DataSourceID"];
					entity.DataSourceName = (reader.IsDBNull(((int)METAView_Peripheral_RetrievalColumn.DataSourceName)))?null:(System.String)reader[((int)METAView_Peripheral_RetrievalColumn.DataSourceName)];
					//entity.DataSourceName = (Convert.IsDBNull(reader["DataSourceName"]))?string.Empty:(System.String)reader["DataSourceName"];
					entity.GeneralRemarks = (reader.IsDBNull(((int)METAView_Peripheral_RetrievalColumn.GeneralRemarks)))?null:(System.String)reader[((int)METAView_Peripheral_RetrievalColumn.GeneralRemarks)];
