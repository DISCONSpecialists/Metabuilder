/*
	...
	Important: Do not modify this file. Edit the file METAView_PhysicalDataComponent_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_PhysicalDataComponent_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_PhysicalDataComponent_ListingBase")]
	public abstract partial class METAView_PhysicalDataComponent_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_PhysicalDataComponent_ListingBase"/> instance.
		///</summary>
		public METAView_PhysicalDataComponent_ListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_PhysicalDataComponent_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_architectureStatusDate"></param>
		///<param name="_designRationale"></param>
		public static METAView_PhysicalDataComponent_Listing CreateMETAView_PhysicalDataComponent_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _dataComponentType, System.String _databaseType, System.String _securityClassification, System.String _contentType, System.String _name, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _dataSourceID, System.String _dataSourceName, System.String _generalRemarks, System.String _gapType, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale)
		{
			METAView_PhysicalDataComponent_Listing newMETAView_PhysicalDataComponent_Listing = new METAView_PhysicalDataComponent_Listing();
			newMETAView_PhysicalDataComponent_Listing.WorkspaceName = _workspaceName;
			newMETAView_PhysicalDataComponent_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_PhysicalDataComponent_Listing.VCStatusID = _vCStatusID;
			newMETAView_PhysicalDataComponent_Listing.pkid = _pkid;
			newMETAView_PhysicalDataComponent_Listing.Machine = _machine;
			newMETAView_PhysicalDataComponent_Listing.VCMachineID = _vCMachineID;
			newMETAView_PhysicalDataComponent_Listing.DataComponentType = _dataComponentType;
			newMETAView_PhysicalDataComponent_Listing.DatabaseType = _databaseType;
			newMETAView_PhysicalDataComponent_Listing.SecurityClassification = _securityClassification;
			newMETAView_PhysicalDataComponent_Listing.ContentType = _contentType;
			newMETAView_PhysicalDataComponent_Listing.Name = _name;
			newMETAView_PhysicalDataComponent_Listing.Description = _description;
			newMETAView_PhysicalDataComponent_Listing.Abbreviation = _abbreviation;
			newMETAView_PhysicalDataComponent_Listing.IsBusinessExternal = _isBusinessExternal;
			newMETAView_PhysicalDataComponent_Listing.DataSourceID = _dataSourceID;
			newMETAView_PhysicalDataComponent_Listing.DataSourceName = _dataSourceName;
			newMETAView_PhysicalDataComponent_Listing.GeneralRemarks = _generalRemarks;
			newMETAView_PhysicalDataComponent_Listing.GapType = _gapType;
			newMETAView_PhysicalDataComponent_Listing.ArchitectureStatus = _architectureStatus;
			newMETAView_PhysicalDataComponent_Listing.ArchitectureStatusDate = _architectureStatusDate;
			newMETAView_PhysicalDataComponent_Listing.DesignRationale = _designRationale;
			return newMETAView_PhysicalDataComponent_Listing;
		}
		...
		{
			get { return "METAView_PhysicalDataComponent_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_PhysicalDataComponent_ListingBase Entity 
		///</summary>
		public virtual METAView_PhysicalDataComponent_ListingBase Copy()
		{
			//shallow copy entity
			METAView_PhysicalDataComponent_Listing copy = new METAView_PhysicalDataComponent_Listing();
			...
			copy.AcceptChanges();
			return (METAView_PhysicalDataComponent_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_PhysicalDataComponent_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_PhysicalDataComponent_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_PhysicalDataComponent_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_PhysicalDataComponent_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_PhysicalDataComponent_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_PhysicalDataComponent_ListingBase Object1, METAView_PhysicalDataComponent_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_PhysicalDataComponent_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_PhysicalDataComponent_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{22}{21}- WorkspaceName: {0}{21}- WorkspaceTypeId: {1}{21}- VCStatusID: {2}{21}- pkid: {3}{21}- Machine: {4}{21}- VCMachineID: {5}{21}- DataComponentType: {6}{21}- DatabaseType: {7}{21}- SecurityClassification: {8}{21}- ContentType: {9}{21}- Name: {10}{21}- Description: {11}{21}- Abbreviation: {12}{21}- IsBusinessExternal: {13}{21}- DataSourceID: {14}{21}- DataSourceName: {15}{21}- GeneralRemarks: {16}{21}- GapType: {17}{21}- ArchitectureStatus: {18}{21}- ArchitectureStatusDate: {19}{21}- DesignRationale: {20}{21}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_PhysicalDataComponent_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_PhysicalDataComponent_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
