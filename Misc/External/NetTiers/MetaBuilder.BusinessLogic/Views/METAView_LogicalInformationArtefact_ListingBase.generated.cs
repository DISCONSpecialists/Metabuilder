/*
	...
	Important: Do not modify this file. Edit the file METAView_LogicalInformationArtefact_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_LogicalInformationArtefact_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_LogicalInformationArtefact_ListingBase")]
	public abstract partial class METAView_LogicalInformationArtefact_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_LogicalInformationArtefact_ListingBase"/> instance.
		///</summary>
		public METAView_LogicalInformationArtefact_ListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_LogicalInformationArtefact_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_architectureStatus"></param>
		///<param name="_architectureStatusDate"></param>
		public static METAView_LogicalInformationArtefact_Listing CreateMETAView_LogicalInformationArtefact_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _architectureStatus, System.String _architectureStatusDate)
		{
			METAView_LogicalInformationArtefact_Listing newMETAView_LogicalInformationArtefact_Listing = new METAView_LogicalInformationArtefact_Listing();
			newMETAView_LogicalInformationArtefact_Listing.WorkspaceName = _workspaceName;
			newMETAView_LogicalInformationArtefact_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_LogicalInformationArtefact_Listing.VCStatusID = _vCStatusID;
			newMETAView_LogicalInformationArtefact_Listing.pkid = _pkid;
			newMETAView_LogicalInformationArtefact_Listing.Machine = _machine;
			newMETAView_LogicalInformationArtefact_Listing.VCMachineID = _vCMachineID;
			newMETAView_LogicalInformationArtefact_Listing.Name = _name;
			newMETAView_LogicalInformationArtefact_Listing.Description = _description;
			newMETAView_LogicalInformationArtefact_Listing.Abbreviation = _abbreviation;
			newMETAView_LogicalInformationArtefact_Listing.IsBusinessExternal = _isBusinessExternal;
			newMETAView_LogicalInformationArtefact_Listing.DesignRationale = _designRationale;
			newMETAView_LogicalInformationArtefact_Listing.GeneralRemarks = _generalRemarks;
			newMETAView_LogicalInformationArtefact_Listing.GapType = _gapType;
			newMETAView_LogicalInformationArtefact_Listing.DataSourceID = _dataSourceID;
			newMETAView_LogicalInformationArtefact_Listing.DataSourceName = _dataSourceName;
			newMETAView_LogicalInformationArtefact_Listing.ArchitectureStatus = _architectureStatus;
			newMETAView_LogicalInformationArtefact_Listing.ArchitectureStatusDate = _architectureStatusDate;
			return newMETAView_LogicalInformationArtefact_Listing;
		}
		...
		{
			get { return "METAView_LogicalInformationArtefact_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_LogicalInformationArtefact_ListingBase Entity 
		///</summary>
		public virtual METAView_LogicalInformationArtefact_ListingBase Copy()
		{
			//shallow copy entity
			METAView_LogicalInformationArtefact_Listing copy = new METAView_LogicalInformationArtefact_Listing();
			...
			copy.AcceptChanges();
			return (METAView_LogicalInformationArtefact_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_LogicalInformationArtefact_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_LogicalInformationArtefact_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_LogicalInformationArtefact_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_LogicalInformationArtefact_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_LogicalInformationArtefact_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_LogicalInformationArtefact_ListingBase Object1, METAView_LogicalInformationArtefact_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_LogicalInformationArtefact_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_LogicalInformationArtefact_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{18}{17}- WorkspaceName: {0}{17}- WorkspaceTypeId: {1}{17}- VCStatusID: {2}{17}- pkid: {3}{17}- Machine: {4}{17}- VCMachineID: {5}{17}- Name: {6}{17}- Description: {7}{17}- Abbreviation: {8}{17}- IsBusinessExternal: {9}{17}- DesignRationale: {10}{17}- GeneralRemarks: {11}{17}- GapType: {12}{17}- DataSourceID: {13}{17}- DataSourceName: {14}{17}- ArchitectureStatus: {15}{17}- ArchitectureStatusDate: {16}{17}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_LogicalInformationArtefact_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_LogicalInformationArtefact_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
