/*
	...
	Important: Do not modify this file. Edit the file METAView_Event_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_Event_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Event_ListingBase")]
	public abstract partial class METAView_Event_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Event_ListingBase"/> instance.
		///</summary>
		public METAView_Event_ListingBase()
		{
		}		
		...
		public METAView_Event_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _eventType)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Event_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_name"></param>
		///<param name="_eventType"></param>
		public static METAView_Event_Listing CreateMETAView_Event_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _eventType)
		{
			METAView_Event_Listing newMETAView_Event_Listing = new METAView_Event_Listing();
			newMETAView_Event_Listing.WorkspaceName = _workspaceName;
			newMETAView_Event_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_Event_Listing.VCStatusID = _vCStatusID;
			newMETAView_Event_Listing.pkid = _pkid;
			newMETAView_Event_Listing.Machine = _machine;
			newMETAView_Event_Listing.VCMachineID = _vCMachineID;
			newMETAView_Event_Listing.Name = _name;
			newMETAView_Event_Listing.EventType = _eventType;
			return newMETAView_Event_Listing;
		}
		...
		{
			get { return "METAView_Event_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_Event_ListingBase Entity 
		///</summary>
		public virtual METAView_Event_ListingBase Copy()
		{
			//shallow copy entity
			METAView_Event_Listing copy = new METAView_Event_Listing();
			...
			copy.AcceptChanges();
			return (METAView_Event_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Event_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Event_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Event_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Event_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Event_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Event_ListingBase Object1, METAView_Event_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Event_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_Event_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{9}{8}- WorkspaceName: {0}{8}- WorkspaceTypeId: {1}{8}- VCStatusID: {2}{8}- pkid: {3}{8}- Machine: {4}{8}- VCMachineID: {5}{8}- Name: {6}{8}- EventType: {7}{8}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_Event_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_Event_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
