...
namespace OpenLicense.LicenseFile.Constraints
{
	...
	public class RuntimeConstraint : AbstractConstraint
	{
		...
		/// belongs to.
		/// </param>
		public RuntimeConstraint( OpenLicenseFile license )
		{
		...
		public override bool Validate( )
		{
			...
			{
				if( base.License != null )
					base.License.FailureReason = "The license may only be used in a Runtime environment.  Design Time licensing is not supported.";
