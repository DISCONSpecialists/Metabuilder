		...
		protected VList<METAView_Implication_Listing> Fill(IDataReader reader, VList<METAView_Implication_Listing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.Ext_Inf_Indicator = (reader.IsDBNull(((int)METAView_Implication_ListingColumn.Ext_Inf_Indicator)))?null:(System.Int32?)reader[((int)METAView_Implication_ListingColumn.Ext_Inf_Indicator)];
					//entity.Ext_Inf_Indicator = (Convert.IsDBNull(reader["Ext_Inf_Indicator"]))?(int)0:(System.Int32?)reader["Ext_Inf_Indicator"];
					entity.Int_Capability_Indicator = (reader.IsDBNull(((int)METAView_Implication_ListingColumn.Int_Capability_Indicator)))?null:(System.Int32?)reader[((int)METAView_Implication_ListingColumn.Int_Capability_Indicator)];
					...
					entity.CustomField1 = (reader.IsDBNull(((int)METAView_Implication_ListingColumn.CustomField1)))?null:(System.String)reader[((int)METAView_Implication_ListingColumn.CustomField1)];
					//entity.CustomField1 = (Convert.IsDBNull(reader["CustomField1"]))?string.Empty:(System.String)reader["CustomField1"];
					entity.CustomField2 = (reader.IsDBNull(((int)METAView_Implication_ListingColumn.CustomField2)))?null:(System.String)reader[((int)METAView_Implication_ListingColumn.CustomField2)];
					//entity.CustomField2 = (Convert.IsDBNull(reader["CustomField2"]))?string.Empty:(System.String)reader["CustomField2"];
					entity.CustomField3 = (reader.IsDBNull(((int)METAView_Implication_ListingColumn.CustomField3)))?null:(System.String)reader[((int)METAView_Implication_ListingColumn.CustomField3)];
					//entity.CustomField3 = (Convert.IsDBNull(reader["CustomField3"]))?string.Empty:(System.String)reader["CustomField3"];
					entity.GapType = (reader.IsDBNull(((int)METAView_Implication_ListingColumn.GapType)))?null:(System.String)reader[((int)METAView_Implication_ListingColumn.GapType)];
