/*
	...
	Important: Do not modify this file. Edit the file METAViewCADRealListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewCADRealListingBase")]
	public abstract partial class METAViewCADRealListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewCADRealListingBase"/> instance.
		///</summary>
		public METAViewCADRealListingBase()
		{
		}		
		...
		public METAViewCADRealListingBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewCADRealListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAViewCADRealListing CreateMETAViewCADRealListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAViewCADRealListing newMETAViewCADRealListing = new METAViewCADRealListing();
			newMETAViewCADRealListing.WorkspaceName = _workspaceName;
			newMETAViewCADRealListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewCADRealListing.VCStatusID = _vCStatusID;
			newMETAViewCADRealListing.Pkid = _pkid;
			newMETAViewCADRealListing.Machine = _machine;
			newMETAViewCADRealListing.VCMachineID = _vCMachineID;
			return newMETAViewCADRealListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewCADRealListingBase Entity 
		///</summary>
		public virtual METAViewCADRealListingBase Copy()
		{
			//shallow copy entity
			METAViewCADRealListing copy = new METAViewCADRealListing();
			...
			copy.AcceptChanges();
			return (METAViewCADRealListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewCADRealListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewCADRealListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewCADRealListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewCADRealListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewCADRealListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewCADRealListingBase Object1, METAViewCADRealListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewCADRealListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewCADRealListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewCADRealListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewCADRealListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
