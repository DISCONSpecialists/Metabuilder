/*
	...
	Important: Do not modify this file. Edit the file METAView_DataValue_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_DataValue_ListingBase")]
	public abstract partial class METAView_DataValue_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_DataValue_ListingBase"/> instance.
		///</summary>
		public METAView_DataValue_ListingBase()
		{
		}		
		...
		public METAView_DataValue_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _isDefaultValue)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_DataValue_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_name"></param>
		///<param name="_isDefaultValue"></param>
		public static METAView_DataValue_Listing CreateMETAView_DataValue_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _isDefaultValue)
		{
			METAView_DataValue_Listing newMETAView_DataValue_Listing = new METAView_DataValue_Listing();
			newMETAView_DataValue_Listing.WorkspaceName = _workspaceName;
			newMETAView_DataValue_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_DataValue_Listing.VCStatusID = _vCStatusID;
			newMETAView_DataValue_Listing.pkid = _pkid;
			newMETAView_DataValue_Listing.Machine = _machine;
			newMETAView_DataValue_Listing.VCMachineID = _vCMachineID;
			newMETAView_DataValue_Listing.Name = _name;
			newMETAView_DataValue_Listing.IsDefaultValue = _isDefaultValue;
			return newMETAView_DataValue_Listing;
		}
		...
		{
			get { return "METAView_DataValue_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_DataValue_ListingBase Entity 
		///</summary>
		public virtual METAView_DataValue_ListingBase Copy()
		{
			//shallow copy entity
			METAView_DataValue_Listing copy = new METAView_DataValue_Listing();
			...
			copy.AcceptChanges();
			return (METAView_DataValue_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_DataValue_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_DataValue_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_DataValue_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_DataValue_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_DataValue_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_DataValue_ListingBase Object1, METAView_DataValue_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_DataValue_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_DataValue_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{9}{8}- WorkspaceName: {0}{8}- WorkspaceTypeId: {1}{8}- VCStatusID: {2}{8}- pkid: {3}{8}- Machine: {4}{8}- VCMachineID: {5}{8}- Name: {6}{8}- IsDefaultValue: {7}{8}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_DataValue_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_DataValue_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
