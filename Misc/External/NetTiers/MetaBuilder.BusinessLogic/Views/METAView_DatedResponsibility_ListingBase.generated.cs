/*
	...
	Important: Do not modify this file. Edit the file METAView_DatedResponsibility_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_DatedResponsibility_ListingBase")]
	public abstract partial class METAView_DatedResponsibility_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_DatedResponsibility_ListingBase"/> instance.
		///</summary>
		public METAView_DatedResponsibility_ListingBase()
		{
		}		
		...
		public METAView_DatedResponsibility_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_DatedResponsibility_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_DatedResponsibility_Listing CreateMETAView_DatedResponsibility_Listing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_DatedResponsibility_Listing newMETAView_DatedResponsibility_Listing = new METAView_DatedResponsibility_Listing();
			newMETAView_DatedResponsibility_Listing.WorkspaceName = _workspaceName;
			newMETAView_DatedResponsibility_Listing.WorkspaceTypeID = _workspaceTypeID;
			newMETAView_DatedResponsibility_Listing.VCStatusID = _vCStatusID;
			newMETAView_DatedResponsibility_Listing.pkid = _pkid;
			newMETAView_DatedResponsibility_Listing.Machine = _machine;
			newMETAView_DatedResponsibility_Listing.VCMachineID = _vCMachineID;
			return newMETAView_DatedResponsibility_Listing;
		}
		...
		{
			get { return "METAView_DatedResponsibility_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_DatedResponsibility_ListingBase Entity 
		///</summary>
		public virtual METAView_DatedResponsibility_ListingBase Copy()
		{
			//shallow copy entity
			METAView_DatedResponsibility_Listing copy = new METAView_DatedResponsibility_Listing();
			...
			copy.AcceptChanges();
			return (METAView_DatedResponsibility_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_DatedResponsibility_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_DatedResponsibility_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_DatedResponsibility_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_DatedResponsibility_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_DatedResponsibility_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_DatedResponsibility_ListingBase Object1, METAView_DatedResponsibility_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_DatedResponsibility_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_DatedResponsibility_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_DatedResponsibility_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_DatedResponsibility_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
