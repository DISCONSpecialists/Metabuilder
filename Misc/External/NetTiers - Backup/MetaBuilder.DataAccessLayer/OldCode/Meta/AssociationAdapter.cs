...
namespace MetaBuilder.DataAccessLayer.OldCode.Meta
{
	...
	public class AssociationAdapter
	{
        ...
        {
            SqlCommand cmd = new SqlCommand("META_DeleteGraphFileAssociationsForFile", new SqlConnection(Variables.Instance.ConnectionString));
        ...
        {
            SqlCommand cmd = new SqlCommand("META_GetAssociationForParentClassAndChildClass", new SqlConnection(Variables.Instance.ConnectionString));
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmd = new SqlCommand("GetAssociationsForParent", new SqlConnection(Variables.Instance.ConnectionString));
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            cmd = new SqlCommand("GetAssociationsForChild", new SqlConnection(Variables.Instance.ConnectionString));
            cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			SqlCommand cmd = new SqlCommand("META_GetAllowedClassAssociationCaptions", new SqlConnection(Variables.Instance.ConnectionString));
			cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			SqlCommand cmd = new SqlCommand("META_GetAssociatedObjects", new SqlConnection(Variables.Instance.ConnectionString));
			cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			SqlCommand cmd = new SqlCommand("META_GetArtifactData", new SqlConnection(Variables.Instance.ConnectionString));
			cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			SqlCommand cmd = new SqlCommand("META_AddArtifact", new SqlConnection(Variables.Instance.ConnectionString));
			cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void UpdateAddArtefactStoredProc()
        {
            ...
            SqlCommand cmdText = new SqlCommand(sb.ToString(), new SqlConnection(Variables.Instance.ConnectionString));
        ...
        {
            SqlCommand cmd = new SqlCommand("META_CalculateCriticalities", new SqlConnection(Variables.Instance.ConnectionString));
            cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			SqlCommand cmd = new SqlCommand("META_AddAssociationObject", new SqlConnection(Variables.Instance.ConnectionString));
			cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			SqlCommand cmd = new SqlCommand("META_RemoveArtifact", new SqlConnection(Variables.Instance.ConnectionString));
			cmd.CommandType = CommandType.StoredProcedure;
		...
		public void ClearArtifacts(int CAid, int ObjectId, int ChildObjectID,string ObjectMachine,string ChildMachine)
		{
            if (CAid > 0)
            {
                SqlCommand cmd = new SqlCommand("META_ClearArtifacts", new SqlConnection(Variables.Instance.ConnectionString));
                cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			SqlCommand cmd = new SqlCommand("META_AddQuickAssociation", new SqlConnection(Variables.Instance.ConnectionString));
			cmd.CommandType = CommandType.StoredProcedure;
