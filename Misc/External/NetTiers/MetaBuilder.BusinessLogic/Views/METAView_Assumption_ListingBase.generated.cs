/*
	...
	Important: Do not modify this file. Edit the file METAView_Assumption_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_Assumption_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Assumption_ListingBase")]
	public abstract partial class METAView_Assumption_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Assumption_ListingBase"/> instance.
		///</summary>
		public METAView_Assumption_ListingBase()
		{
		}		
		...
		public METAView_Assumption_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Assumption_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_vCMachineID"></param>
		///<param name="_name"></param>
		public static METAView_Assumption_Listing CreateMETAView_Assumption_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
			METAView_Assumption_Listing newMETAView_Assumption_Listing = new METAView_Assumption_Listing();
			newMETAView_Assumption_Listing.WorkspaceName = _workspaceName;
			newMETAView_Assumption_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_Assumption_Listing.VCStatusID = _vCStatusID;
			newMETAView_Assumption_Listing.pkid = _pkid;
			newMETAView_Assumption_Listing.Machine = _machine;
			newMETAView_Assumption_Listing.VCMachineID = _vCMachineID;
			newMETAView_Assumption_Listing.Name = _name;
			return newMETAView_Assumption_Listing;
		}
		...
		{
			get { return "METAView_Assumption_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_Assumption_ListingBase Entity 
		///</summary>
		public virtual METAView_Assumption_ListingBase Copy()
		{
			//shallow copy entity
			METAView_Assumption_Listing copy = new METAView_Assumption_Listing();
				...
				copy.Name = this.Name;
			copy.AcceptChanges();
			return (METAView_Assumption_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Assumption_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Assumption_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Assumption_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Assumption_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Assumption_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Assumption_ListingBase Object1, METAView_Assumption_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Assumption_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_Assumption_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_Assumption_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_Assumption_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
