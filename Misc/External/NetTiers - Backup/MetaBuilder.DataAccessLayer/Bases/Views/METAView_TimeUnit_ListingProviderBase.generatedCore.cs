		...
		protected VList<METAView_TimeUnit_Listing> Fill(IDataReader reader, VList<METAView_TimeUnit_Listing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.Value = (reader.IsDBNull(((int)METAView_TimeUnit_ListingColumn.Value)))?null:(System.String)reader[((int)METAView_TimeUnit_ListingColumn.Value)];
					//entity.Value = (Convert.IsDBNull(reader["Value"]))?string.Empty:(System.String)reader["Value"];
					entity.GapType = (reader.IsDBNull(((int)METAView_TimeUnit_ListingColumn.GapType)))?null:(System.String)reader[((int)METAView_TimeUnit_ListingColumn.GapType)];
					//entity.GapType = (Convert.IsDBNull(reader["GapType"]))?string.Empty:(System.String)reader["GapType"];
					entity.CustomField1 = (reader.IsDBNull(((int)METAView_TimeUnit_ListingColumn.CustomField1)))?null:(System.String)reader[((int)METAView_TimeUnit_ListingColumn.CustomField1)];
					//entity.CustomField1 = (Convert.IsDBNull(reader["CustomField1"]))?string.Empty:(System.String)reader["CustomField1"];
					entity.CustomField2 = (reader.IsDBNull(((int)METAView_TimeUnit_ListingColumn.CustomField2)))?null:(System.String)reader[((int)METAView_TimeUnit_ListingColumn.CustomField2)];
					//entity.CustomField2 = (Convert.IsDBNull(reader["CustomField2"]))?string.Empty:(System.String)reader["CustomField2"];
					entity.CustomField3 = (reader.IsDBNull(((int)METAView_TimeUnit_ListingColumn.CustomField3)))?null:(System.String)reader[((int)METAView_TimeUnit_ListingColumn.CustomField3)];
