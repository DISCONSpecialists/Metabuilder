/*
	...
	Important: Do not modify this file. Edit the file METAView_ConnectionType_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_ConnectionType_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ConnectionType_ListingBase")]
	public abstract partial class METAView_ConnectionType_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ConnectionType_ListingBase"/> instance.
		///</summary>
		public METAView_ConnectionType_ListingBase()
		{
		}		
		...
		public METAView_ConnectionType_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ConnectionType_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_vCMachineID"></param>
		///<param name="_value"></param>
		public static METAView_ConnectionType_Listing CreateMETAView_ConnectionType_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value)
		{
			METAView_ConnectionType_Listing newMETAView_ConnectionType_Listing = new METAView_ConnectionType_Listing();
			newMETAView_ConnectionType_Listing.WorkspaceName = _workspaceName;
			newMETAView_ConnectionType_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_ConnectionType_Listing.VCStatusID = _vCStatusID;
			newMETAView_ConnectionType_Listing.pkid = _pkid;
			newMETAView_ConnectionType_Listing.Machine = _machine;
			newMETAView_ConnectionType_Listing.VCMachineID = _vCMachineID;
			newMETAView_ConnectionType_Listing.Value = _value;
			return newMETAView_ConnectionType_Listing;
		}
		...
		{
			get { return "METAView_ConnectionType_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_ConnectionType_ListingBase Entity 
		///</summary>
		public virtual METAView_ConnectionType_ListingBase Copy()
		{
			//shallow copy entity
			METAView_ConnectionType_Listing copy = new METAView_ConnectionType_Listing();
			...
			copy.AcceptChanges();
			return (METAView_ConnectionType_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ConnectionType_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ConnectionType_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ConnectionType_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ConnectionType_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ConnectionType_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ConnectionType_ListingBase Object1, METAView_ConnectionType_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ConnectionType_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ConnectionType_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_ConnectionType_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_ConnectionType_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
