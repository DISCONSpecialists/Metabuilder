...
{	
	...
	public abstract class ActiveDiagramObjectsProviderBaseCore : EntityViewProviderBase<ActiveDiagramObjects>
	{
		...
		protected static VList&lt;ActiveDiagramObjects&gt; Fill(DataTable dataTable, VList<ActiveDiagramObjects> rows, int start, int pagelen)
		{
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					c.File Name = (Convert.IsDBNull(row["File Name"]))?string.Empty:(System.String)row["File Name"];
		...
		*/	
		...
		protected VList<ActiveDiagramObjects> Fill(IDataReader reader, VList<ActiveDiagramObjects> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.pkid = (System.Int32)reader[((int)ActiveDiagramObjectsColumn.pkid)];
					//entity.pkid = (Convert.IsDBNull(reader["pkid"]))?(int)0:(System.Int32)reader["pkid"];
					entity.File Name = (reader.IsDBNull(((int)ActiveDiagramObjectsColumn.File Name)))?null:(System.String)reader[((int)ActiveDiagramObjectsColumn.File Name)];
					//entity.File Name = (Convert.IsDBNull(reader["File Name"]))?string.Empty:(System.String)reader["File Name"];
					entity.MetaObjectID = (System.Int32)reader[((int)ActiveDiagramObjectsColumn.MetaObjectID)];
					//entity.MetaObjectID = (Convert.IsDBNull(reader["MetaObjectID"]))?(int)0:(System.Int32)reader["MetaObjectID"];
					entity.Machine = (System.String)reader[((int)ActiveDiagramObjectsColumn.Machine)];
		...
		protected static void RefreshEntity(DataSet dataSet, ActiveDiagramObjects entity)
		{
			...
			entity.File Name = (Convert.IsDBNull(dataRow["File Name"]))?string.Empty:(System.String)dataRow["File Name"];
	...
	#region ActiveDiagramObjectsSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class ActiveDiagramObjectsSortBuilder : SqlSortBuilder<ActiveDiagramObjectsColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ActiveDiagramObjectsSqlSortBuilder class.
		/// </summary>
		public ActiveDiagramObjectsSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion ActiveDiagramObjectsSortBuilder
