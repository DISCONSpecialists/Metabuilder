/*
	...
	Important: Do not modify this file. Edit the file METAViewCSFRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewCSFRetrievalBase")]
	public abstract partial class METAViewCSFRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewCSFRetrievalBase"/> instance.
		///</summary>
		public METAViewCSFRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewCSFRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewCSFRetrieval CreateMETAViewCSFRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _number, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewCSFRetrieval newMETAViewCSFRetrieval = new METAViewCSFRetrieval();
			newMETAViewCSFRetrieval.WorkspaceName = _workspaceName;
			newMETAViewCSFRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewCSFRetrieval.VCStatusID = _vCStatusID;
			newMETAViewCSFRetrieval.Pkid = _pkid;
			newMETAViewCSFRetrieval.Machine = _machine;
			newMETAViewCSFRetrieval.VCMachineID = _vCMachineID;
			newMETAViewCSFRetrieval.Name = _name;
			newMETAViewCSFRetrieval.Number = _number;
			newMETAViewCSFRetrieval.CustomField1 = _customField1;
			newMETAViewCSFRetrieval.CustomField2 = _customField2;
			newMETAViewCSFRetrieval.CustomField3 = _customField3;
			newMETAViewCSFRetrieval.GapType = _gapType;
			return newMETAViewCSFRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewCSFRetrievalBase Entity 
		///</summary>
		public virtual METAViewCSFRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewCSFRetrieval copy = new METAViewCSFRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewCSFRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewCSFRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewCSFRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewCSFRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewCSFRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewCSFRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewCSFRetrievalBase Object1, METAViewCSFRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewCSFRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewCSFRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewCSFRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewCSFRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
