/*
	...
	Important: Do not modify this file. Edit the file METAView_LogicalITInfrastructureComponent_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_LogicalITInfrastructureComponent_ListingBase")]
	public abstract partial class METAView_LogicalITInfrastructureComponent_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_LogicalITInfrastructureComponent_ListingBase"/> instance.
		///</summary>
		public METAView_LogicalITInfrastructureComponent_ListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_LogicalITInfrastructureComponent_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_architectureStatusDate"></param>
		///<param name="_designRationale"></param>
		public static METAView_LogicalITInfrastructureComponent_Listing CreateMETAView_LogicalITInfrastructureComponent_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _dataSourceID, System.String _dataSourceName, System.String _generalRemarks, System.String _gapType, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale)
		{
			METAView_LogicalITInfrastructureComponent_Listing newMETAView_LogicalITInfrastructureComponent_Listing = new METAView_LogicalITInfrastructureComponent_Listing();
			newMETAView_LogicalITInfrastructureComponent_Listing.WorkspaceName = _workspaceName;
			newMETAView_LogicalITInfrastructureComponent_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_LogicalITInfrastructureComponent_Listing.VCStatusID = _vCStatusID;
			newMETAView_LogicalITInfrastructureComponent_Listing.pkid = _pkid;
			newMETAView_LogicalITInfrastructureComponent_Listing.Machine = _machine;
			newMETAView_LogicalITInfrastructureComponent_Listing.VCMachineID = _vCMachineID;
			newMETAView_LogicalITInfrastructureComponent_Listing.Name = _name;
			newMETAView_LogicalITInfrastructureComponent_Listing.Description = _description;
			newMETAView_LogicalITInfrastructureComponent_Listing.Abbreviation = _abbreviation;
			newMETAView_LogicalITInfrastructureComponent_Listing.IsBusinessExternal = _isBusinessExternal;
			newMETAView_LogicalITInfrastructureComponent_Listing.DataSourceID = _dataSourceID;
			newMETAView_LogicalITInfrastructureComponent_Listing.DataSourceName = _dataSourceName;
			newMETAView_LogicalITInfrastructureComponent_Listing.GeneralRemarks = _generalRemarks;
			newMETAView_LogicalITInfrastructureComponent_Listing.GapType = _gapType;
			newMETAView_LogicalITInfrastructureComponent_Listing.ArchitectureStatus = _architectureStatus;
			newMETAView_LogicalITInfrastructureComponent_Listing.ArchitectureStatusDate = _architectureStatusDate;
			newMETAView_LogicalITInfrastructureComponent_Listing.DesignRationale = _designRationale;
			return newMETAView_LogicalITInfrastructureComponent_Listing;
		}
		...
		{
			get { return "METAView_LogicalITInfrastructureComponent_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_LogicalITInfrastructureComponent_ListingBase Entity 
		///</summary>
		public virtual METAView_LogicalITInfrastructureComponent_ListingBase Copy()
		{
			//shallow copy entity
			METAView_LogicalITInfrastructureComponent_Listing copy = new METAView_LogicalITInfrastructureComponent_Listing();
			...
			copy.AcceptChanges();
			return (METAView_LogicalITInfrastructureComponent_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_LogicalITInfrastructureComponent_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_LogicalITInfrastructureComponent_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_LogicalITInfrastructureComponent_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_LogicalITInfrastructureComponent_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_LogicalITInfrastructureComponent_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_LogicalITInfrastructureComponent_ListingBase Object1, METAView_LogicalITInfrastructureComponent_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_LogicalITInfrastructureComponent_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_LogicalITInfrastructureComponent_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{18}{17}- WorkspaceName: {0}{17}- WorkspaceTypeId: {1}{17}- VCStatusID: {2}{17}- pkid: {3}{17}- Machine: {4}{17}- VCMachineID: {5}{17}- Name: {6}{17}- Description: {7}{17}- Abbreviation: {8}{17}- IsBusinessExternal: {9}{17}- DataSourceID: {10}{17}- DataSourceName: {11}{17}- GeneralRemarks: {12}{17}- GapType: {13}{17}- ArchitectureStatus: {14}{17}- ArchitectureStatusDate: {15}{17}- DesignRationale: {16}{17}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_LogicalITInfrastructureComponent_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_LogicalITInfrastructureComponent_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
