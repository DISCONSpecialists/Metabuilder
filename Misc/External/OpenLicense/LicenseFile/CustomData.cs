...
Editor("System.Diagnostics.Design.StringDictionaryEditor, System.Design, Version=2.0.50727.42,Culture=neutral,PublicKeyToken=b03f5f7f11d50a3a",
typeof(UITypeEditor))] // added this line, full assembly info is necessary for propertygrid to work
	public class CustomData : AbstractLicenseData
	{
		...
		/// </param>
		public CustomData( StringDictionary col )
		{
			if( col == null )
		...
		public void AddCustomData( string key, string val )
		{
			...
			if( key == String.Empty )
				throw new ArgumentException( "Empty String is not a valid key value." );
		...
		/// </param>
		public void AddCustomData( StringDictionary data )
		{
			if( this.Items == null )
				this.data = data;
			else
		...
		/// </returns>
		public static CustomData FromXml( string xmlData )
		{
		...
		/// </exception>
		public static CustomData FromXml( XmlNode itemsNode )
		{
			if( itemsNode == null )
