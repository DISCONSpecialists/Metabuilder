/*
	...
	Important: Do not modify this file. Edit the file METAViewModelRealListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewModelRealListingBase")]
	public abstract partial class METAViewModelRealListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewModelRealListingBase"/> instance.
		///</summary>
		public METAViewModelRealListingBase()
		{
		}		
		...
		public METAViewModelRealListingBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewModelRealListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAViewModelRealListing CreateMETAViewModelRealListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAViewModelRealListing newMETAViewModelRealListing = new METAViewModelRealListing();
			newMETAViewModelRealListing.WorkspaceName = _workspaceName;
			newMETAViewModelRealListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewModelRealListing.VCStatusID = _vCStatusID;
			newMETAViewModelRealListing.Pkid = _pkid;
			newMETAViewModelRealListing.Machine = _machine;
			newMETAViewModelRealListing.VCMachineID = _vCMachineID;
			return newMETAViewModelRealListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewModelRealListingBase Entity 
		///</summary>
		public virtual METAViewModelRealListingBase Copy()
		{
			//shallow copy entity
			METAViewModelRealListing copy = new METAViewModelRealListing();
			...
			copy.AcceptChanges();
			return (METAViewModelRealListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewModelRealListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewModelRealListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewModelRealListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewModelRealListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewModelRealListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewModelRealListingBase Object1, METAViewModelRealListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewModelRealListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewModelRealListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewModelRealListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewModelRealListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
