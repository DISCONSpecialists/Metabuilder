/*
	...
	Important: Do not modify this file. Edit the file METAView_JobPosition_Retrieval.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_JobPosition_Retrieval' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_JobPosition_RetrievalBase")]
	public abstract partial class METAView_JobPosition_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_JobPosition_RetrievalBase"/> instance.
		///</summary>
		public METAView_JobPosition_RetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_JobPosition_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_dataSourceName"></param>
		///<param name="_generalRemarks"></param>
		public static METAView_JobPosition_Retrieval CreateMETAView_JobPosition_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.Int32? _totalRequired, System.Int32? _totalOccupied, System.Int32? _totalAvailable, System.DateTime? _timeStamp, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _standardisationStatus, System.String _standardisationStatusDate, System.String _dataSourceID, System.String _dataSourceName, System.String _generalRemarks)
		{
			METAView_JobPosition_Retrieval newMETAView_JobPosition_Retrieval = new METAView_JobPosition_Retrieval();
			newMETAView_JobPosition_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_JobPosition_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_JobPosition_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_JobPosition_Retrieval.pkid = _pkid;
			newMETAView_JobPosition_Retrieval.Machine = _machine;
			newMETAView_JobPosition_Retrieval.VCMachineID = _vCMachineID;
			newMETAView_JobPosition_Retrieval.Name = _name;
			newMETAView_JobPosition_Retrieval.TotalRequired = _totalRequired;
			newMETAView_JobPosition_Retrieval.TotalOccupied = _totalOccupied;
			newMETAView_JobPosition_Retrieval.TotalAvailable = _totalAvailable;
			newMETAView_JobPosition_Retrieval.TimeStamp = _timeStamp;
			newMETAView_JobPosition_Retrieval.CustomField1 = _customField1;
			newMETAView_JobPosition_Retrieval.CustomField2 = _customField2;
			newMETAView_JobPosition_Retrieval.CustomField3 = _customField3;
			newMETAView_JobPosition_Retrieval.GapType = _gapType;
			newMETAView_JobPosition_Retrieval.Description = _description;
			newMETAView_JobPosition_Retrieval.Abbreviation = _abbreviation;
			newMETAView_JobPosition_Retrieval.IsBusinessExternal = _isBusinessExternal;
			newMETAView_JobPosition_Retrieval.StandardisationStatus = _standardisationStatus;
			newMETAView_JobPosition_Retrieval.StandardisationStatusDate = _standardisationStatusDate;
			newMETAView_JobPosition_Retrieval.DataSourceID = _dataSourceID;
			newMETAView_JobPosition_Retrieval.DataSourceName = _dataSourceName;
			newMETAView_JobPosition_Retrieval.GeneralRemarks = _generalRemarks;
			return newMETAView_JobPosition_Retrieval;
		}
		...
		{
			get { return "METAView_JobPosition_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_JobPosition_RetrievalBase Entity 
		///</summary>
		public virtual METAView_JobPosition_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_JobPosition_Retrieval copy = new METAView_JobPosition_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_JobPosition_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_JobPosition_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_JobPosition_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_JobPosition_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_JobPosition_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_JobPosition_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_JobPosition_RetrievalBase Object1, METAView_JobPosition_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_JobPosition_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_JobPosition_Retrieval, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{24}{23}- WorkspaceName: {0}{23}- WorkspaceTypeId: {1}{23}- VCStatusID: {2}{23}- pkid: {3}{23}- Machine: {4}{23}- VCMachineID: {5}{23}- Name: {6}{23}- TotalRequired: {7}{23}- TotalOccupied: {8}{23}- TotalAvailable: {9}{23}- TimeStamp: {10}{23}- CustomField1: {11}{23}- CustomField2: {12}{23}- CustomField3: {13}{23}- GapType: {14}{23}- Description: {15}{23}- Abbreviation: {16}{23}- IsBusinessExternal: {17}{23}- StandardisationStatus: {18}{23}- StandardisationStatusDate: {19}{23}- DataSourceID: {20}{23}- DataSourceName: {21}{23}- GeneralRemarks: {22}{23}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_JobPosition_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_JobPosition_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
