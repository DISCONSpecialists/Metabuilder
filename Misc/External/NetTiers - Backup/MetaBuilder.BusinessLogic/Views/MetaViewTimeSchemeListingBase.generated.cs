/*
	...
	Important: Do not modify this file. Edit the file METAViewTimeSchemeListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewTimeSchemeListingBase")]
	public abstract partial class METAViewTimeSchemeListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewTimeSchemeListingBase"/> instance.
		///</summary>
		public METAViewTimeSchemeListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewTimeSchemeListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField2"></param>
		///<param name="_customField3"></param>
		public static METAViewTimeSchemeListing CreateMETAViewTimeSchemeListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _gapType, System.String _customField1, System.String _customField2, System.String _customField3)
		{
			METAViewTimeSchemeListing newMETAViewTimeSchemeListing = new METAViewTimeSchemeListing();
			newMETAViewTimeSchemeListing.WorkspaceName = _workspaceName;
			newMETAViewTimeSchemeListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewTimeSchemeListing.VCStatusID = _vCStatusID;
			newMETAViewTimeSchemeListing.Pkid = _pkid;
			newMETAViewTimeSchemeListing.Machine = _machine;
			newMETAViewTimeSchemeListing.VCMachineID = _vCMachineID;
			newMETAViewTimeSchemeListing.Name = _name;
			newMETAViewTimeSchemeListing.GapType = _gapType;
			newMETAViewTimeSchemeListing.CustomField1 = _customField1;
			newMETAViewTimeSchemeListing.CustomField2 = _customField2;
			newMETAViewTimeSchemeListing.CustomField3 = _customField3;
			return newMETAViewTimeSchemeListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewTimeSchemeListingBase Entity 
		///</summary>
		public virtual METAViewTimeSchemeListingBase Copy()
		{
			//shallow copy entity
			METAViewTimeSchemeListing copy = new METAViewTimeSchemeListing();
			...
			copy.AcceptChanges();
			return (METAViewTimeSchemeListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewTimeSchemeListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewTimeSchemeListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewTimeSchemeListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewTimeSchemeListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewTimeSchemeListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewTimeSchemeListingBase Object1, METAViewTimeSchemeListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewTimeSchemeListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewTimeSchemeListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewTimeSchemeListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewTimeSchemeListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
