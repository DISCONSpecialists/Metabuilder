/*
	...
	Important: Do not modify this file. Edit the file METAView_Model_Retrieval.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_Model_Retrieval' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Model_RetrievalBase")]
	public abstract partial class METAView_Model_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Model_RetrievalBase"/> instance.
		///</summary>
		public METAView_Model_RetrievalBase()
		{
		}		
		...
		public METAView_Model_RetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Model_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_Model_Retrieval CreateMETAView_Model_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_Model_Retrieval newMETAView_Model_Retrieval = new METAView_Model_Retrieval();
			newMETAView_Model_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_Model_Retrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAView_Model_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_Model_Retrieval.pkid = _pkid;
			newMETAView_Model_Retrieval.Machine = _machine;
			newMETAView_Model_Retrieval.VCMachineID = _vCMachineID;
			return newMETAView_Model_Retrieval;
		}
		...
		{
			get { return "METAView_Model_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_Model_RetrievalBase Entity 
		///</summary>
		public virtual METAView_Model_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_Model_Retrieval copy = new METAView_Model_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_Model_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Model_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Model_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Model_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Model_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Model_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Model_RetrievalBase Object1, METAView_Model_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Model_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_Model_Retrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_Model_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_Model_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
