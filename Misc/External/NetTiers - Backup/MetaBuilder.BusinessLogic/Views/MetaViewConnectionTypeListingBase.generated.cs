/*
	...
	Important: Do not modify this file. Edit the file METAViewConnectionTypeListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewConnectionTypeListingBase")]
	public abstract partial class METAViewConnectionTypeListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewConnectionTypeListingBase"/> instance.
		///</summary>
		public METAViewConnectionTypeListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewConnectionTypeListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewConnectionTypeListing CreateMETAViewConnectionTypeListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewConnectionTypeListing newMETAViewConnectionTypeListing = new METAViewConnectionTypeListing();
			newMETAViewConnectionTypeListing.WorkspaceName = _workspaceName;
			newMETAViewConnectionTypeListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewConnectionTypeListing.VCStatusID = _vCStatusID;
			newMETAViewConnectionTypeListing.Pkid = _pkid;
			newMETAViewConnectionTypeListing.Machine = _machine;
			newMETAViewConnectionTypeListing.VCMachineID = _vCMachineID;
			newMETAViewConnectionTypeListing.Value = _value;
			newMETAViewConnectionTypeListing.CustomField1 = _customField1;
			newMETAViewConnectionTypeListing.CustomField2 = _customField2;
			newMETAViewConnectionTypeListing.CustomField3 = _customField3;
			newMETAViewConnectionTypeListing.GapType = _gapType;
			return newMETAViewConnectionTypeListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewConnectionTypeListingBase Entity 
		///</summary>
		public virtual METAViewConnectionTypeListingBase Copy()
		{
			//shallow copy entity
			METAViewConnectionTypeListing copy = new METAViewConnectionTypeListing();
			...
			copy.AcceptChanges();
			return (METAViewConnectionTypeListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewConnectionTypeListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewConnectionTypeListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewConnectionTypeListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewConnectionTypeListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewConnectionTypeListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewConnectionTypeListingBase Object1, METAViewConnectionTypeListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewConnectionTypeListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewConnectionTypeListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewConnectionTypeListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewConnectionTypeListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
