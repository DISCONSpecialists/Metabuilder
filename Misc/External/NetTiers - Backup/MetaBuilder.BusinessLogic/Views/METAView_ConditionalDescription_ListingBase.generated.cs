/*
	...
	Important: Do not modify this file. Edit the file METAView_ConditionalDescription_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ConditionalDescription_ListingBase")]
	public abstract partial class METAView_ConditionalDescription_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ConditionalDescription_ListingBase"/> instance.
		///</summary>
		public METAView_ConditionalDescription_ListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ConditionalDescription_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_WorkspaceTypeId"></param>
		///<param name="_VCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAView_ConditionalDescription_Listing CreateMETAView_ConditionalDescription_Listing(System.String _workspaceName, System.Int32? _WorkspaceTypeId, System.Int32 _VCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value, System.Int32? _sequence, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAView_ConditionalDescription_Listing newMETAView_ConditionalDescription_Listing = new METAView_ConditionalDescription_Listing();
			newMETAView_ConditionalDescription_Listing.WorkspaceName = _workspaceName;
			newMETAView_ConditionalDescription_Listing.WorkspaceTypeId = _WorkspaceTypeId;
			newMETAView_ConditionalDescription_Listing.VCStatusID = _VCStatusID;
			newMETAView_ConditionalDescription_Listing.pkid = _pkid;
			newMETAView_ConditionalDescription_Listing.Machine = _machine;
			newMETAView_ConditionalDescription_Listing.VCMachineID = _vCMachineID;
			newMETAView_ConditionalDescription_Listing.Value = _value;
			newMETAView_ConditionalDescription_Listing.Sequence = _sequence;
			newMETAView_ConditionalDescription_Listing.CustomField1 = _customField1;
			newMETAView_ConditionalDescription_Listing.CustomField2 = _customField2;
			newMETAView_ConditionalDescription_Listing.CustomField3 = _customField3;
			newMETAView_ConditionalDescription_Listing.GapType = _gapType;
			return newMETAView_ConditionalDescription_Listing;
		}
		...
		{
			get { return "METAView_ConditionalDescription_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_ConditionalDescription_ListingBase Entity 
		///</summary>
		public virtual METAView_ConditionalDescription_ListingBase Copy()
		{
			//shallow copy entity
			METAView_ConditionalDescription_Listing copy = new METAView_ConditionalDescription_Listing();
			...
			copy.AcceptChanges();
			return (METAView_ConditionalDescription_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ConditionalDescription_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ConditionalDescription_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ConditionalDescription_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ConditionalDescription_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ConditionalDescription_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ConditionalDescription_ListingBase Object1, METAView_ConditionalDescription_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ConditionalDescription_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ConditionalDescription_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_ConditionalDescription_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_ConditionalDescription_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
