namespace MetaBuilder.Meta.Generated {
    ...
    [TypeConverter(typeof(MetaBuilder.Meta.Generated.InternalOperationSort))]
    [Serializable()]
    public class InternalOperation : MetaBuilder.Meta.MetaBase {
        
        public string sequence;
        
        public string descriptionofprocess;
        ...
        [CategoryAttribute("Process")]
        public virtual string DescriptionOfProcess {
            get {
                return this.descriptionofprocess;
            }
            set {
                this.descriptionofprocess = value;
                this.PropertyChanged();
            }
        }
...
return (!String.IsNullOrEmpty(Conditions))? "?" +Conditions + " " +  Sequence + ") " + DescriptionOfProcess:Sequence + ") " + DescriptionOfProcess;
        }
    }
}
