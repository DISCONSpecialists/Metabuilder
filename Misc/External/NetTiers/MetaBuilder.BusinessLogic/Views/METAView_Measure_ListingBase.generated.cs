/*
	...
	Important: Do not modify this file. Edit the file METAView_Measure_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_Measure_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Measure_ListingBase")]
	public abstract partial class METAView_Measure_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Measure_ListingBase"/> instance.
		///</summary>
		public METAView_Measure_ListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Measure_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_architectureStatus"></param>
		///<param name="_architectureStatusDate"></param>
		public static METAView_Measure_Listing CreateMETAView_Measure_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _measureType, System.String _measureCategory, System.String _unitOfMeasure, System.String _name, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _architectureStatus, System.String _architectureStatusDate)
		{
			METAView_Measure_Listing newMETAView_Measure_Listing = new METAView_Measure_Listing();
			newMETAView_Measure_Listing.WorkspaceName = _workspaceName;
			newMETAView_Measure_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_Measure_Listing.VCStatusID = _vCStatusID;
			newMETAView_Measure_Listing.pkid = _pkid;
			newMETAView_Measure_Listing.Machine = _machine;
			newMETAView_Measure_Listing.VCMachineID = _vCMachineID;
			newMETAView_Measure_Listing.MeasureType = _measureType;
			newMETAView_Measure_Listing.MeasureCategory = _measureCategory;
			newMETAView_Measure_Listing.UnitOfMeasure = _unitOfMeasure;
			newMETAView_Measure_Listing.Name = _name;
			newMETAView_Measure_Listing.Description = _description;
			newMETAView_Measure_Listing.Abbreviation = _abbreviation;
			newMETAView_Measure_Listing.IsBusinessExternal = _isBusinessExternal;
			newMETAView_Measure_Listing.DesignRationale = _designRationale;
			newMETAView_Measure_Listing.GeneralRemarks = _generalRemarks;
			newMETAView_Measure_Listing.GapType = _gapType;
			newMETAView_Measure_Listing.DataSourceID = _dataSourceID;
			newMETAView_Measure_Listing.DataSourceName = _dataSourceName;
			newMETAView_Measure_Listing.ArchitectureStatus = _architectureStatus;
			newMETAView_Measure_Listing.ArchitectureStatusDate = _architectureStatusDate;
			return newMETAView_Measure_Listing;
		}
		...
		{
			get { return "METAView_Measure_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_Measure_ListingBase Entity 
		///</summary>
		public virtual METAView_Measure_ListingBase Copy()
		{
			//shallow copy entity
			METAView_Measure_Listing copy = new METAView_Measure_Listing();
			...
			copy.AcceptChanges();
			return (METAView_Measure_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Measure_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Measure_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Measure_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Measure_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Measure_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Measure_ListingBase Object1, METAView_Measure_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Measure_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_Measure_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{21}{20}- WorkspaceName: {0}{20}- WorkspaceTypeId: {1}{20}- VCStatusID: {2}{20}- pkid: {3}{20}- Machine: {4}{20}- VCMachineID: {5}{20}- MeasureType: {6}{20}- MeasureCategory: {7}{20}- UnitOfMeasure: {8}{20}- Name: {9}{20}- Description: {10}{20}- Abbreviation: {11}{20}- IsBusinessExternal: {12}{20}- DesignRationale: {13}{20}- GeneralRemarks: {14}{20}- GapType: {15}{20}- DataSourceID: {16}{20}- DataSourceName: {17}{20}- ArchitectureStatus: {18}{20}- ArchitectureStatusDate: {19}{20}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_Measure_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_Measure_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
