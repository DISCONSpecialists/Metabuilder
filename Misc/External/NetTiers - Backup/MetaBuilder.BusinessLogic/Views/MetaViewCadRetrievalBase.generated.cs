/*
	...
	Important: Do not modify this file. Edit the file METAViewCADRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewCADRetrievalBase")]
	public abstract partial class METAViewCADRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewCADRetrievalBase"/> instance.
		///</summary>
		public METAViewCADRetrievalBase()
		{
		}		
		...
		public METAViewCADRetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewCADRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAViewCADRetrieval CreateMETAViewCADRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAViewCADRetrieval newMETAViewCADRetrieval = new METAViewCADRetrieval();
			newMETAViewCADRetrieval.WorkspaceName = _workspaceName;
			newMETAViewCADRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewCADRetrieval.VCStatusID = _vCStatusID;
			newMETAViewCADRetrieval.Pkid = _pkid;
			newMETAViewCADRetrieval.Machine = _machine;
			newMETAViewCADRetrieval.VCMachineID = _vCMachineID;
			return newMETAViewCADRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewCADRetrievalBase Entity 
		///</summary>
		public virtual METAViewCADRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewCADRetrieval copy = new METAViewCADRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewCADRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewCADRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewCADRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewCADRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewCADRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewCADRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewCADRetrievalBase Object1, METAViewCADRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewCADRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewCADRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewCADRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewCADRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
