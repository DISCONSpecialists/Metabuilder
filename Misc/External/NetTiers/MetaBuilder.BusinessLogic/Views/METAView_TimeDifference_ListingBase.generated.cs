/*
	...
	Important: Do not modify this file. Edit the file METAView_TimeDifference_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_TimeDifference_ListingBase")]
	public abstract partial class METAView_TimeDifference_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_TimeDifference_ListingBase"/> instance.
		///</summary>
		public METAView_TimeDifference_ListingBase()
		{
		}		
		...
		public METAView_TimeDifference_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_TimeDifference_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_vCMachineID"></param>
		///<param name="_name"></param>
		public static METAView_TimeDifference_Listing CreateMETAView_TimeDifference_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
			METAView_TimeDifference_Listing newMETAView_TimeDifference_Listing = new METAView_TimeDifference_Listing();
			newMETAView_TimeDifference_Listing.WorkspaceName = _workspaceName;
			newMETAView_TimeDifference_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_TimeDifference_Listing.VCStatusID = _vCStatusID;
			newMETAView_TimeDifference_Listing.pkid = _pkid;
			newMETAView_TimeDifference_Listing.Machine = _machine;
			newMETAView_TimeDifference_Listing.VCMachineID = _vCMachineID;
			newMETAView_TimeDifference_Listing.Name = _name;
			return newMETAView_TimeDifference_Listing;
		}
		...
		{
			get { return "METAView_TimeDifference_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_TimeDifference_ListingBase Entity 
		///</summary>
		public virtual METAView_TimeDifference_ListingBase Copy()
		{
			//shallow copy entity
			METAView_TimeDifference_Listing copy = new METAView_TimeDifference_Listing();
				...
				copy.Name = this.Name;
			copy.AcceptChanges();
			return (METAView_TimeDifference_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_TimeDifference_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_TimeDifference_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_TimeDifference_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_TimeDifference_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_TimeDifference_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_TimeDifference_ListingBase Object1, METAView_TimeDifference_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_TimeDifference_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_TimeDifference_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_TimeDifference_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_TimeDifference_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
