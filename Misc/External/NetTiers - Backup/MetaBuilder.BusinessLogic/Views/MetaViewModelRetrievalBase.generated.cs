/*
	...
	Important: Do not modify this file. Edit the file METAViewModelRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewModelRetrievalBase")]
	public abstract partial class METAViewModelRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewModelRetrievalBase"/> instance.
		///</summary>
		public METAViewModelRetrievalBase()
		{
		}		
		...
		public METAViewModelRetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewModelRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAViewModelRetrieval CreateMETAViewModelRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAViewModelRetrieval newMETAViewModelRetrieval = new METAViewModelRetrieval();
			newMETAViewModelRetrieval.WorkspaceName = _workspaceName;
			newMETAViewModelRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewModelRetrieval.VCStatusID = _vCStatusID;
			newMETAViewModelRetrieval.Pkid = _pkid;
			newMETAViewModelRetrieval.Machine = _machine;
			newMETAViewModelRetrieval.VCMachineID = _vCMachineID;
			return newMETAViewModelRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewModelRetrievalBase Entity 
		///</summary>
		public virtual METAViewModelRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewModelRetrieval copy = new METAViewModelRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewModelRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewModelRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewModelRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewModelRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewModelRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewModelRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewModelRetrievalBase Object1, METAViewModelRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewModelRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewModelRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewModelRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewModelRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
