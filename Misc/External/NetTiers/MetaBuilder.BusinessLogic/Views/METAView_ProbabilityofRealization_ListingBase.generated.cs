/*
	...
	Important: Do not modify this file. Edit the file METAView_ProbabilityofRealization_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_ProbabilityofRealization_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ProbabilityofRealization_ListingBase")]
	public abstract partial class METAView_ProbabilityofRealization_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ProbabilityofRealization_ListingBase"/> instance.
		///</summary>
		public METAView_ProbabilityofRealization_ListingBase()
		{
		}		
		...
		public METAView_ProbabilityofRealization_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ProbabilityofRealization_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_vCMachineID"></param>
		///<param name="_value"></param>
		public static METAView_ProbabilityofRealization_Listing CreateMETAView_ProbabilityofRealization_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value)
		{
			METAView_ProbabilityofRealization_Listing newMETAView_ProbabilityofRealization_Listing = new METAView_ProbabilityofRealization_Listing();
			newMETAView_ProbabilityofRealization_Listing.WorkspaceName = _workspaceName;
			newMETAView_ProbabilityofRealization_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_ProbabilityofRealization_Listing.VCStatusID = _vCStatusID;
			newMETAView_ProbabilityofRealization_Listing.pkid = _pkid;
			newMETAView_ProbabilityofRealization_Listing.Machine = _machine;
			newMETAView_ProbabilityofRealization_Listing.VCMachineID = _vCMachineID;
			newMETAView_ProbabilityofRealization_Listing.Value = _value;
			return newMETAView_ProbabilityofRealization_Listing;
		}
		...
		{
			get { return "METAView_ProbabilityofRealization_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_ProbabilityofRealization_ListingBase Entity 
		///</summary>
		public virtual METAView_ProbabilityofRealization_ListingBase Copy()
		{
			//shallow copy entity
			METAView_ProbabilityofRealization_Listing copy = new METAView_ProbabilityofRealization_Listing();
			...
			copy.AcceptChanges();
			return (METAView_ProbabilityofRealization_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ProbabilityofRealization_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ProbabilityofRealization_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ProbabilityofRealization_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ProbabilityofRealization_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ProbabilityofRealization_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ProbabilityofRealization_ListingBase Object1, METAView_ProbabilityofRealization_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ProbabilityofRealization_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ProbabilityofRealization_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{8}{7}- WorkspaceName: {0}{7}- WorkspaceTypeId: {1}{7}- VCStatusID: {2}{7}- pkid: {3}{7}- Machine: {4}{7}- VCMachineID: {5}{7}- Value: {6}{7}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_ProbabilityofRealization_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_ProbabilityofRealization_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
