		...
		protected VList<METAView_FlowDescription_Listing> Fill(IDataReader reader, VList<METAView_FlowDescription_Listing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.TimeReference = (reader.IsDBNull(((int)METAView_FlowDescription_ListingColumn.TimeReference)))?null:(System.String)reader[((int)METAView_FlowDescription_ListingColumn.TimeReference)];
