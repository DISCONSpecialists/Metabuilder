      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{15}{14}- WorkspaceName: {0}{14}- WorkspaceTypeId: {1}{14}- VCStatusID: {2}{14}- pkid: {3}{14}- Machine: {4}{14}- VCMachineID: {5}{14}- Sequence: {6}{14}- Condition: {7}{14}- Description: {8}{14}- CustomField1: {9}{14}- CustomField2: {10}{14}- CustomField3: {11}{14}- TimeIndicator: {12}{14}- GapType: {13}{14}", 
				this.WorkspaceName,
