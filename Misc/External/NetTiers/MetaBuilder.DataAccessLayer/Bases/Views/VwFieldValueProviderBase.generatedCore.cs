...
{	
		...
		protected VList<VwFieldValue> Fill(IDataReader reader, VList<VwFieldValue> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.Field = (System.String)reader[((int)VwFieldValueColumn.Field)];
					//entity.Field = (Convert.IsDBNull(reader["Field"]))?string.Empty:(System.String)reader["Field"];
					entity.ValueString = (reader.IsDBNull(((int)VwFieldValueColumn.ValueString)))?null:(System.String)reader[((int)VwFieldValueColumn.ValueString)];
					//entity.ValueString = (Convert.IsDBNull(reader["ValueString"]))?string.Empty:(System.String)reader["ValueString"];
					entity.ValueInt = (reader.IsDBNull(((int)VwFieldValueColumn.ValueInt)))?null:(System.Int32?)reader[((int)VwFieldValueColumn.ValueInt)];
					//entity.ValueInt = (Convert.IsDBNull(reader["ValueInt"]))?(int)0:(System.Int32?)reader["ValueInt"];
					entity.ValueDouble = (reader.IsDBNull(((int)VwFieldValueColumn.ValueDouble)))?null:(System.Decimal?)reader[((int)VwFieldValueColumn.ValueDouble)];
					//entity.ValueDouble = (Convert.IsDBNull(reader["ValueDouble"]))?0.0m:(System.Decimal?)reader["ValueDouble"];
					entity.ValueObjectID = (reader.IsDBNull(((int)VwFieldValueColumn.ValueObjectID)))?null:(System.Int32?)reader[((int)VwFieldValueColumn.ValueObjectID)];
					//entity.ValueObjectID = (Convert.IsDBNull(reader["ValueObjectID"]))?(int)0:(System.Int32?)reader["ValueObjectID"];
					entity.ValueDate = (reader.IsDBNull(((int)VwFieldValueColumn.ValueDate)))?null:(System.DateTime?)reader[((int)VwFieldValueColumn.ValueDate)];
					//entity.ValueDate = (Convert.IsDBNull(reader["ValueDate"]))?DateTime.MinValue:(System.DateTime?)reader["ValueDate"];
					entity.ValueBoolean = (reader.IsDBNull(((int)VwFieldValueColumn.ValueBoolean)))?null:(System.Boolean?)reader[((int)VwFieldValueColumn.ValueBoolean)];
	...
	#region VwFieldValueSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class VwFieldValueSortBuilder : SqlSortBuilder<VwFieldValueColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the VwFieldValueSqlSortBuilder class.
		/// </summary>
		public VwFieldValueSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion VwFieldValueSortBuilder
