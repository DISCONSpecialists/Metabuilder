...
{	
		...
		protected VList<METAViewIterationListing> Fill(IDataReader reader, VList<METAViewIterationListing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.WorkspaceName = (System.String)reader[((int)METAViewIterationListingColumn.WorkspaceName)];
					//entity.WorkspaceName = (Convert.IsDBNull(reader["WorkspaceName"]))?string.Empty:(System.String)reader["WorkspaceName"];
					entity.WorkspaceTypeID = (reader.IsDBNull(((int)METAViewIterationListingColumn.WorkspaceTypeID)))?null:(System.Int32?)reader[((int)METAViewIterationListingColumn.WorkspaceTypeID)];
					//entity.WorkspaceTypeID = (Convert.IsDBNull(reader["WorkspaceTypeID"]))?(int)0:(System.Int32?)reader["WorkspaceTypeID"];
					entity.VCStatusID = (System.Int32)reader[((int)METAViewIterationListingColumn.VCStatusID)];
					//entity.VCStatusID = (Convert.IsDBNull(reader["VCStatusID"]))?(int)0:(System.Int32)reader["VCStatusID"];
					entity.Pkid = (System.Int32)reader[((int)METAViewIterationListingColumn.Pkid)];
					//entity.Pkid = (Convert.IsDBNull(reader["pkid"]))?(int)0:(System.Int32)reader["pkid"];
					entity.Machine = (System.String)reader[((int)METAViewIterationListingColumn.Machine)];
					//entity.Machine = (Convert.IsDBNull(reader["Machine"]))?string.Empty:(System.String)reader["Machine"];
					entity.VCMachineID = (reader.IsDBNull(((int)METAViewIterationListingColumn.VCMachineID)))?null:(System.String)reader[((int)METAViewIterationListingColumn.VCMachineID)];
					//entity.VCMachineID = (Convert.IsDBNull(reader["VCMachineID"]))?string.Empty:(System.String)reader["VCMachineID"];
					entity.Name = (reader.IsDBNull(((int)METAViewIterationListingColumn.Name)))?null:(System.String)reader[((int)METAViewIterationListingColumn.Name)];
					//entity.Name = (Convert.IsDBNull(reader["Name"]))?string.Empty:(System.String)reader["Name"];
					entity.IterationType = (reader.IsDBNull(((int)METAViewIterationListingColumn.IterationType)))?null:(System.String)reader[((int)METAViewIterationListingColumn.IterationType)];
					//entity.IterationType = (Convert.IsDBNull(reader["IterationType"]))?string.Empty:(System.String)reader["IterationType"];
					entity.CustomField1 = (reader.IsDBNull(((int)METAViewIterationListingColumn.CustomField1)))?null:(System.String)reader[((int)METAViewIterationListingColumn.CustomField1)];
					//entity.CustomField1 = (Convert.IsDBNull(reader["CustomField1"]))?string.Empty:(System.String)reader["CustomField1"];
					entity.CustomField2 = (reader.IsDBNull(((int)METAViewIterationListingColumn.CustomField2)))?null:(System.String)reader[((int)METAViewIterationListingColumn.CustomField2)];
					//entity.CustomField2 = (Convert.IsDBNull(reader["CustomField2"]))?string.Empty:(System.String)reader["CustomField2"];
					entity.CustomField3 = (reader.IsDBNull(((int)METAViewIterationListingColumn.CustomField3)))?null:(System.String)reader[((int)METAViewIterationListingColumn.CustomField3)];
					//entity.CustomField3 = (Convert.IsDBNull(reader["CustomField3"]))?string.Empty:(System.String)reader["CustomField3"];
					entity.GapType = (reader.IsDBNull(((int)METAViewIterationListingColumn.GapType)))?null:(System.String)reader[((int)METAViewIterationListingColumn.GapType)];
	...
	#region METAViewIterationListingSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class METAViewIterationListingSortBuilder : SqlSortBuilder<METAViewIterationListingColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the METAViewIterationListingSqlSortBuilder class.
		/// </summary>
		public METAViewIterationListingSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion METAViewIterationListingSortBuilder
