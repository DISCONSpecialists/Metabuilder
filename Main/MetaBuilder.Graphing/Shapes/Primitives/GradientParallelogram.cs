...
{
    [Serializable]
    public class GradientParallelogram : GoParallelogram, ISnappableShape, IIdentifiable, IBehaviourShape
    {
        public GradientParallelogram()
        {
        ...
        public override void CopyObjectDelayed(GoCopyDictionary env, GoObject newobj)
        {
            ...
            GradientParallelogram parallelogram = newobj as GradientParallelogram;
            parallelogram.Name = Name.Substring(0, Name.Length);
            if (Manager != null)
                parallelogram.Manager = Manager.Copy(parallelogram);
        }
    }
}