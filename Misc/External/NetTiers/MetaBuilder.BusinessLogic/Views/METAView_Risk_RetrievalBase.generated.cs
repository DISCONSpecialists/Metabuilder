/*
	...
	Important: Do not modify this file. Edit the file METAView_Risk_Retrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Risk_RetrievalBase")]
	public abstract partial class METAView_Risk_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// RiskStatus : 
		/// </summary>
		private System.String		  _riskStatus = null;
		
		/// <summary>
		/// StatusDate : 
		/// </summary>
		private System.String		  _statusDate = null;
		
		/// <summary>
		/// RiskRating : 
		/// </summary>
		private System.String		  _riskRating = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Risk_RetrievalBase"/> instance.
		///</summary>
		public METAView_Risk_RetrievalBase()
		{
		}		
		...
		///<param name="_riskStatus"></param>
		///<param name="_statusDate"></param>
		///<param name="_riskRating"></param>
		public METAView_Risk_RetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _abbreviation, System.String _description, System.String _isBusinessExternal, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _riskStatus, System.String _statusDate, System.String _riskRating)
		{
			...
			this._riskRating = _riskRating;
		}
		
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Risk_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_statusDate"></param>
		///<param name="_riskRating"></param>
		public static METAView_Risk_Retrieval CreateMETAView_Risk_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _abbreviation, System.String _description, System.String _isBusinessExternal, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _riskStatus, System.String _statusDate, System.String _riskRating)
		{
			METAView_Risk_Retrieval newMETAView_Risk_Retrieval = new METAView_Risk_Retrieval();
			newMETAView_Risk_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_Risk_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_Risk_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_Risk_Retrieval.pkid = _pkid;
			newMETAView_Risk_Retrieval.Machine = _machine;
			newMETAView_Risk_Retrieval.VCMachineID = _vCMachineID;
			newMETAView_Risk_Retrieval.Name = _name;
			newMETAView_Risk_Retrieval.Abbreviation = _abbreviation;
			newMETAView_Risk_Retrieval.Description = _description;
			newMETAView_Risk_Retrieval.IsBusinessExternal = _isBusinessExternal;
			newMETAView_Risk_Retrieval.ArchitectureStatus = _architectureStatus;
			newMETAView_Risk_Retrieval.ArchitectureStatusDate = _architectureStatusDate;
			newMETAView_Risk_Retrieval.DesignRationale = _designRationale;
			newMETAView_Risk_Retrieval.GeneralRemarks = _generalRemarks;
			newMETAView_Risk_Retrieval.GapType = _gapType;
			newMETAView_Risk_Retrieval.DataSourceID = _dataSourceID;
			newMETAView_Risk_Retrieval.DataSourceName = _dataSourceName;
			newMETAView_Risk_Retrieval.RiskStatus = _riskStatus;
			newMETAView_Risk_Retrieval.StatusDate = _statusDate;
			newMETAView_Risk_Retrieval.RiskRating = _riskRating;
			return newMETAView_Risk_Retrieval;
		}
		...
		/// <summary>
		/// 	Gets or Sets the RiskStatus property. 
		///		
		/// </summary>
		/// <value>This type is varchar</value>
		/// <remarks>
		...
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.String RiskStatus
		{
			get
			{
				return this._riskStatus; 
			}
			set
			{
				if (_riskStatus == value)
					return;
					
				this._riskStatus = value;
				this._isDirty = true;
				
				OnPropertyChanged("RiskStatus");
			}
		}
		...
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.String StatusDate
		{
			get
			{
		...
		/// <summary>
		/// 	Gets or Sets the RiskRating property. 
		///		
		/// </summary>
		/// <value>This type is varchar</value>
		/// <remarks>
		...
		{
			get { return "METAView_Risk_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_Risk_RetrievalBase Entity 
		///</summary>
		public virtual METAView_Risk_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_Risk_Retrieval copy = new METAView_Risk_Retrieval();
				...
				copy.RiskStatus = this.RiskStatus;
				copy.StatusDate = this.StatusDate;
				copy.RiskRating = this.RiskRating;
			copy.AcceptChanges();
			return (METAView_Risk_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Risk_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Risk_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Risk_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Risk_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Risk_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Risk_RetrievalBase Object1, METAView_Risk_RetrievalBase Object2)
		{
			// both are null
			...
			if (Object1.RiskStatus != null && Object2.RiskStatus != null )
			{
				if (Object1.RiskStatus != Object2.RiskStatus)
					equal = false;
			}
			else if (Object1.RiskStatus == null ^ Object1.RiskStatus == null )
			{
				equal = false;
			}
			if (Object1.StatusDate != null && Object2.StatusDate != null )
			{
				if (Object1.StatusDate != Object2.StatusDate)
					equal = false;
			}
			else if (Object1.StatusDate == null ^ Object1.StatusDate == null )
			{
				equal = false;
			}
			if (Object1.RiskRating != null && Object2.RiskRating != null )
			{
				if (Object1.RiskRating != Object2.RiskRating)
					equal = false;
			}
			else if (Object1.RiskRating == null ^ Object1.RiskRating == null )
			{
				equal = false;
			}
			return equal;
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Risk_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
				...
				case "RiskStatus":
					return entity.RiskStatus;
				case "StatusDate":
					return entity.StatusDate;
				case "RiskRating":
					return entity.RiskRating;
			}
			return null;
		}
		...
		{			
			return GetPropertyValueByName(this as METAView_Risk_Retrieval, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				...
				(this.RiskStatus == null) ? string.Empty : this.RiskStatus.ToString(),
			     
				(this.StatusDate == null) ? string.Empty : this.StatusDate.ToString(),
			     
				(this.RiskRating == null) ? string.Empty : this.RiskRating.ToString(),
	...
	/// <summary>
	/// Enumerate the METAView_Risk_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_Risk_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
		...
		/// RiskStatus : 
		/// </summary>
		[EnumTextValue("RiskStatus")]
		[ColumnEnum("RiskStatus", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 255)]
		RiskStatus,
		/// <summary>
		/// StatusDate : 
		/// </summary>
		[EnumTextValue("StatusDate")]
		[ColumnEnum("StatusDate", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 255)]
		StatusDate,
		/// <summary>
		/// RiskRating : 
		/// </summary>
		[EnumTextValue("RiskRating")]
		[ColumnEnum("RiskRating", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 255)]
		RiskRating
	}//End enum
