/*
	...
	Important: Do not modify this file. Edit the file METAView_Peripheral_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Peripheral_ListingBase")]
	public abstract partial class METAView_Peripheral_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Peripheral_ListingBase"/> instance.
		///</summary>
		public METAView_Peripheral_ListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Peripheral_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_dataSourceName"></param>
		///<param name="_generalRemarks"></param>
		public static METAView_Peripheral_Listing CreateMETAView_Peripheral_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _type, System.String _name, System.String _description, System.String _severityRating, System.String _configuration, System.String _networkAddress1, System.String _networkAddress2, System.String _networkAddress3, System.String _networkAddress4, System.String _networkAddress5, System.String _make, System.String _model, System.String _serialNumber, System.String _assetNumber, System.String _copy_PPM, System.String _print_PPM, System.String _isColor, System.String _isManaged, System.String _isNetwork, System.String _datePurchased, System.String _underWarranty, System.String _contract, System.String _gapType, System.String _abbreviation, System.String _isBusinessExternal, System.String _dataSourceID, System.String _dataSourceName, System.String _generalRemarks)
		{
			METAView_Peripheral_Listing newMETAView_Peripheral_Listing = new METAView_Peripheral_Listing();
			newMETAView_Peripheral_Listing.WorkspaceName = _workspaceName;
			newMETAView_Peripheral_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_Peripheral_Listing.VCStatusID = _vCStatusID;
			newMETAView_Peripheral_Listing.pkid = _pkid;
			newMETAView_Peripheral_Listing.Machine = _machine;
			newMETAView_Peripheral_Listing.VCMachineID = _vCMachineID;
			newMETAView_Peripheral_Listing.Type = _type;
			newMETAView_Peripheral_Listing.Name = _name;
			newMETAView_Peripheral_Listing.Description = _description;
			newMETAView_Peripheral_Listing.SeverityRating = _severityRating;
			newMETAView_Peripheral_Listing.Configuration = _configuration;
			newMETAView_Peripheral_Listing.NetworkAddress1 = _networkAddress1;
			newMETAView_Peripheral_Listing.NetworkAddress2 = _networkAddress2;
			newMETAView_Peripheral_Listing.NetworkAddress3 = _networkAddress3;
			newMETAView_Peripheral_Listing.NetworkAddress4 = _networkAddress4;
			newMETAView_Peripheral_Listing.NetworkAddress5 = _networkAddress5;
			newMETAView_Peripheral_Listing.Make = _make;
			newMETAView_Peripheral_Listing.Model = _model;
			newMETAView_Peripheral_Listing.SerialNumber = _serialNumber;
			newMETAView_Peripheral_Listing.AssetNumber = _assetNumber;
			newMETAView_Peripheral_Listing.Copy_PPM = _copy_PPM;
			newMETAView_Peripheral_Listing.Print_PPM = _print_PPM;
			newMETAView_Peripheral_Listing.isColor = _isColor;
			newMETAView_Peripheral_Listing.isManaged = _isManaged;
			newMETAView_Peripheral_Listing.isNetwork = _isNetwork;
			newMETAView_Peripheral_Listing.DatePurchased = _datePurchased;
			newMETAView_Peripheral_Listing.UnderWarranty = _underWarranty;
			newMETAView_Peripheral_Listing.Contract = _contract;
			newMETAView_Peripheral_Listing.GapType = _gapType;
			newMETAView_Peripheral_Listing.Abbreviation = _abbreviation;
			newMETAView_Peripheral_Listing.IsBusinessExternal = _isBusinessExternal;
			newMETAView_Peripheral_Listing.DataSourceID = _dataSourceID;
			newMETAView_Peripheral_Listing.DataSourceName = _dataSourceName;
			newMETAView_Peripheral_Listing.GeneralRemarks = _generalRemarks;
			return newMETAView_Peripheral_Listing;
		}
		...
		///<summary>
		///  Returns a Typed METAView_Peripheral_ListingBase Entity 
		///</summary>
		public virtual METAView_Peripheral_ListingBase Copy()
		{
			//shallow copy entity
			METAView_Peripheral_Listing copy = new METAView_Peripheral_Listing();
			...
			copy.AcceptChanges();
			return (METAView_Peripheral_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Peripheral_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Peripheral_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Peripheral_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Peripheral_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Peripheral_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Peripheral_ListingBase Object1, METAView_Peripheral_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Peripheral_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_Peripheral_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{35}{34}- WorkspaceName: {0}{34}- WorkspaceTypeId: {1}{34}- VCStatusID: {2}{34}- pkid: {3}{34}- Machine: {4}{34}- VCMachineID: {5}{34}- Type: {6}{34}- Name: {7}{34}- Description: {8}{34}- SeverityRating: {9}{34}- Configuration: {10}{34}- NetworkAddress1: {11}{34}- NetworkAddress2: {12}{34}- NetworkAddress3: {13}{34}- NetworkAddress4: {14}{34}- NetworkAddress5: {15}{34}- Make: {16}{34}- Model: {17}{34}- SerialNumber: {18}{34}- AssetNumber: {19}{34}- Copy_PPM: {20}{34}- Print_PPM: {21}{34}- isColor: {22}{34}- isManaged: {23}{34}- isNetwork: {24}{34}- DatePurchased: {25}{34}- UnderWarranty: {26}{34}- Contract: {27}{34}- GapType: {28}{34}- Abbreviation: {29}{34}- IsBusinessExternal: {30}{34}- DataSourceID: {31}{34}- DataSourceName: {32}{34}- GeneralRemarks: {33}{34}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_Peripheral_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_Peripheral_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
