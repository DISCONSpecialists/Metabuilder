/*
	...
	Important: Do not modify this file. Edit the file METAViewCompetencyRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewCompetencyRetrievalBase")]
	public abstract partial class METAViewCompetencyRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewCompetencyRetrievalBase"/> instance.
		///</summary>
		public METAViewCompetencyRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewCompetencyRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField2"></param>
		///<param name="_customField3"></param>
		public static METAViewCompetencyRetrieval CreateMETAViewCompetencyRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _type, System.String _level, System.String _gapType, System.String _customField1, System.String _customField2, System.String _customField3)
		{
			METAViewCompetencyRetrieval newMETAViewCompetencyRetrieval = new METAViewCompetencyRetrieval();
			newMETAViewCompetencyRetrieval.WorkspaceName = _workspaceName;
			newMETAViewCompetencyRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewCompetencyRetrieval.VCStatusID = _vCStatusID;
			newMETAViewCompetencyRetrieval.Pkid = _pkid;
			newMETAViewCompetencyRetrieval.Machine = _machine;
			newMETAViewCompetencyRetrieval.VCMachineID = _vCMachineID;
			newMETAViewCompetencyRetrieval.Name = _name;
			newMETAViewCompetencyRetrieval.Type = _type;
			newMETAViewCompetencyRetrieval.Level = _level;
			newMETAViewCompetencyRetrieval.GapType = _gapType;
			newMETAViewCompetencyRetrieval.CustomField1 = _customField1;
			newMETAViewCompetencyRetrieval.CustomField2 = _customField2;
			newMETAViewCompetencyRetrieval.CustomField3 = _customField3;
			return newMETAViewCompetencyRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewCompetencyRetrievalBase Entity 
		///</summary>
		public virtual METAViewCompetencyRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewCompetencyRetrieval copy = new METAViewCompetencyRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewCompetencyRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewCompetencyRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewCompetencyRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewCompetencyRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewCompetencyRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewCompetencyRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewCompetencyRetrievalBase Object1, METAViewCompetencyRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewCompetencyRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewCompetencyRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewCompetencyRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewCompetencyRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
