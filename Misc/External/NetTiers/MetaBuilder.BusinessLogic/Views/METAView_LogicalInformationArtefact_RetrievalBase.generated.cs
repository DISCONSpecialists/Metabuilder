/*
	...
	Important: Do not modify this file. Edit the file METAView_LogicalInformationArtefact_Retrieval.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_LogicalInformationArtefact_Retrieval' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_LogicalInformationArtefact_RetrievalBase")]
	public abstract partial class METAView_LogicalInformationArtefact_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_LogicalInformationArtefact_RetrievalBase"/> instance.
		///</summary>
		public METAView_LogicalInformationArtefact_RetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_LogicalInformationArtefact_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_architectureStatus"></param>
		///<param name="_architectureStatusDate"></param>
		public static METAView_LogicalInformationArtefact_Retrieval CreateMETAView_LogicalInformationArtefact_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _standardisationStatus, System.String _standardisationStatusDate, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _architectureStatus, System.String _architectureStatusDate)
		{
			METAView_LogicalInformationArtefact_Retrieval newMETAView_LogicalInformationArtefact_Retrieval = new METAView_LogicalInformationArtefact_Retrieval();
			newMETAView_LogicalInformationArtefact_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_LogicalInformationArtefact_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_LogicalInformationArtefact_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_LogicalInformationArtefact_Retrieval.pkid = _pkid;
			newMETAView_LogicalInformationArtefact_Retrieval.Machine = _machine;
			newMETAView_LogicalInformationArtefact_Retrieval.VCMachineID = _vCMachineID;
			newMETAView_LogicalInformationArtefact_Retrieval.Name = _name;
			newMETAView_LogicalInformationArtefact_Retrieval.Description = _description;
			newMETAView_LogicalInformationArtefact_Retrieval.Abbreviation = _abbreviation;
			newMETAView_LogicalInformationArtefact_Retrieval.IsBusinessExternal = _isBusinessExternal;
			newMETAView_LogicalInformationArtefact_Retrieval.StandardisationStatus = _standardisationStatus;
			newMETAView_LogicalInformationArtefact_Retrieval.StandardisationStatusDate = _standardisationStatusDate;
			newMETAView_LogicalInformationArtefact_Retrieval.DesignRationale = _designRationale;
			newMETAView_LogicalInformationArtefact_Retrieval.GeneralRemarks = _generalRemarks;
			newMETAView_LogicalInformationArtefact_Retrieval.GapType = _gapType;
			newMETAView_LogicalInformationArtefact_Retrieval.DataSourceID = _dataSourceID;
			newMETAView_LogicalInformationArtefact_Retrieval.DataSourceName = _dataSourceName;
			newMETAView_LogicalInformationArtefact_Retrieval.ArchitectureStatus = _architectureStatus;
			newMETAView_LogicalInformationArtefact_Retrieval.ArchitectureStatusDate = _architectureStatusDate;
			return newMETAView_LogicalInformationArtefact_Retrieval;
		}
		...
		{
			get { return "METAView_LogicalInformationArtefact_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_LogicalInformationArtefact_RetrievalBase Entity 
		///</summary>
		public virtual METAView_LogicalInformationArtefact_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_LogicalInformationArtefact_Retrieval copy = new METAView_LogicalInformationArtefact_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_LogicalInformationArtefact_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_LogicalInformationArtefact_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_LogicalInformationArtefact_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_LogicalInformationArtefact_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_LogicalInformationArtefact_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_LogicalInformationArtefact_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_LogicalInformationArtefact_RetrievalBase Object1, METAView_LogicalInformationArtefact_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_LogicalInformationArtefact_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_LogicalInformationArtefact_Retrieval, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{20}{19}- WorkspaceName: {0}{19}- WorkspaceTypeId: {1}{19}- VCStatusID: {2}{19}- pkid: {3}{19}- Machine: {4}{19}- VCMachineID: {5}{19}- Name: {6}{19}- Description: {7}{19}- Abbreviation: {8}{19}- IsBusinessExternal: {9}{19}- StandardisationStatus: {10}{19}- StandardisationStatusDate: {11}{19}- DesignRationale: {12}{19}- GeneralRemarks: {13}{19}- GapType: {14}{19}- DataSourceID: {15}{19}- DataSourceName: {16}{19}- ArchitectureStatus: {17}{19}- ArchitectureStatusDate: {18}{19}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_LogicalInformationArtefact_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_LogicalInformationArtefact_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
