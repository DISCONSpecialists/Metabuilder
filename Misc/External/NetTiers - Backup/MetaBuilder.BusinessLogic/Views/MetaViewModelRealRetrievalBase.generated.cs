/*
	...
	Important: Do not modify this file. Edit the file METAViewModelRealRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewModelRealRetrievalBase")]
	public abstract partial class METAViewModelRealRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewModelRealRetrievalBase"/> instance.
		///</summary>
		public METAViewModelRealRetrievalBase()
		{
		}		
		...
		public METAViewModelRealRetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewModelRealRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAViewModelRealRetrieval CreateMETAViewModelRealRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAViewModelRealRetrieval newMETAViewModelRealRetrieval = new METAViewModelRealRetrieval();
			newMETAViewModelRealRetrieval.WorkspaceName = _workspaceName;
			newMETAViewModelRealRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewModelRealRetrieval.VCStatusID = _vCStatusID;
			newMETAViewModelRealRetrieval.Pkid = _pkid;
			newMETAViewModelRealRetrieval.Machine = _machine;
			newMETAViewModelRealRetrieval.VCMachineID = _vCMachineID;
			return newMETAViewModelRealRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewModelRealRetrievalBase Entity 
		///</summary>
		public virtual METAViewModelRealRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewModelRealRetrieval copy = new METAViewModelRealRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewModelRealRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewModelRealRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewModelRealRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewModelRealRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewModelRealRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewModelRealRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewModelRealRetrievalBase Object1, METAViewModelRealRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewModelRealRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewModelRealRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewModelRealRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewModelRealRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
