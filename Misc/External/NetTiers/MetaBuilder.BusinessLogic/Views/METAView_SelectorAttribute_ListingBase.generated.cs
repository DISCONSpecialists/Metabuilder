/*
	...
	Important: Do not modify this file. Edit the file METAView_SelectorAttribute_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_SelectorAttribute_ListingBase")]
	public abstract partial class METAView_SelectorAttribute_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_SelectorAttribute_ListingBase"/> instance.
		///</summary>
		public METAView_SelectorAttribute_ListingBase()
		{
		}		
		...
		public METAView_SelectorAttribute_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_SelectorAttribute_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_vCMachineID"></param>
		///<param name="_name"></param>
		public static METAView_SelectorAttribute_Listing CreateMETAView_SelectorAttribute_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
			METAView_SelectorAttribute_Listing newMETAView_SelectorAttribute_Listing = new METAView_SelectorAttribute_Listing();
			newMETAView_SelectorAttribute_Listing.WorkspaceName = _workspaceName;
			newMETAView_SelectorAttribute_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_SelectorAttribute_Listing.VCStatusID = _vCStatusID;
			newMETAView_SelectorAttribute_Listing.pkid = _pkid;
			newMETAView_SelectorAttribute_Listing.Machine = _machine;
			newMETAView_SelectorAttribute_Listing.VCMachineID = _vCMachineID;
			newMETAView_SelectorAttribute_Listing.Name = _name;
			return newMETAView_SelectorAttribute_Listing;
		}
		...
		///<summary>
		///  Returns a Typed METAView_SelectorAttribute_ListingBase Entity 
		///</summary>
		public virtual METAView_SelectorAttribute_ListingBase Copy()
		{
			//shallow copy entity
			METAView_SelectorAttribute_Listing copy = new METAView_SelectorAttribute_Listing();
				...
				copy.Name = this.Name;
			copy.AcceptChanges();
			return (METAView_SelectorAttribute_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_SelectorAttribute_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_SelectorAttribute_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_SelectorAttribute_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_SelectorAttribute_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_SelectorAttribute_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_SelectorAttribute_ListingBase Object1, METAView_SelectorAttribute_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_SelectorAttribute_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_SelectorAttribute_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_SelectorAttribute_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_SelectorAttribute_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
