/*
	...
	Important: Do not modify this file. Edit the file METAView_StatusIndicator_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_StatusIndicator_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_StatusIndicator_ListingBase")]
	public abstract partial class METAView_StatusIndicator_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_StatusIndicator_ListingBase"/> instance.
		///</summary>
		public METAView_StatusIndicator_ListingBase()
		{
		}		
		...
		public METAView_StatusIndicator_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_StatusIndicator_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_StatusIndicator_Listing CreateMETAView_StatusIndicator_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_StatusIndicator_Listing newMETAView_StatusIndicator_Listing = new METAView_StatusIndicator_Listing();
			newMETAView_StatusIndicator_Listing.WorkspaceName = _workspaceName;
			newMETAView_StatusIndicator_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_StatusIndicator_Listing.VCStatusID = _vCStatusID;
			newMETAView_StatusIndicator_Listing.pkid = _pkid;
			newMETAView_StatusIndicator_Listing.Machine = _machine;
			newMETAView_StatusIndicator_Listing.VCMachineID = _vCMachineID;
			return newMETAView_StatusIndicator_Listing;
		}
		...
		{
			get { return "METAView_StatusIndicator_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_StatusIndicator_ListingBase Entity 
		///</summary>
		public virtual METAView_StatusIndicator_ListingBase Copy()
		{
			//shallow copy entity
			METAView_StatusIndicator_Listing copy = new METAView_StatusIndicator_Listing();
			...
			copy.AcceptChanges();
			return (METAView_StatusIndicator_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_StatusIndicator_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_StatusIndicator_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_StatusIndicator_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_StatusIndicator_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_StatusIndicator_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_StatusIndicator_ListingBase Object1, METAView_StatusIndicator_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_StatusIndicator_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_StatusIndicator_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_StatusIndicator_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_StatusIndicator_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
