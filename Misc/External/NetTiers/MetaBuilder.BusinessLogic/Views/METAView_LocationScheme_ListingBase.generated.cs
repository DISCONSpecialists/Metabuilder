/*
	...
	Important: Do not modify this file. Edit the file METAView_LocationScheme_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_LocationScheme_ListingBase")]
	public abstract partial class METAView_LocationScheme_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_LocationScheme_ListingBase"/> instance.
		///</summary>
		public METAView_LocationScheme_ListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_LocationScheme_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_architectureStatusDate"></param>
		///<param name="_designRationale"></param>
		public static METAView_LocationScheme_Listing CreateMETAView_LocationScheme_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _gapType, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _dataSourceID, System.String _dataSourceName, System.String _generalRemarks, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale)
		{
			METAView_LocationScheme_Listing newMETAView_LocationScheme_Listing = new METAView_LocationScheme_Listing();
			newMETAView_LocationScheme_Listing.WorkspaceName = _workspaceName;
			newMETAView_LocationScheme_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_LocationScheme_Listing.VCStatusID = _vCStatusID;
			newMETAView_LocationScheme_Listing.pkid = _pkid;
			newMETAView_LocationScheme_Listing.Machine = _machine;
			newMETAView_LocationScheme_Listing.VCMachineID = _vCMachineID;
			newMETAView_LocationScheme_Listing.Name = _name;
			newMETAView_LocationScheme_Listing.GapType = _gapType;
			newMETAView_LocationScheme_Listing.Description = _description;
			newMETAView_LocationScheme_Listing.Abbreviation = _abbreviation;
			newMETAView_LocationScheme_Listing.IsBusinessExternal = _isBusinessExternal;
			newMETAView_LocationScheme_Listing.DataSourceID = _dataSourceID;
			newMETAView_LocationScheme_Listing.DataSourceName = _dataSourceName;
			newMETAView_LocationScheme_Listing.GeneralRemarks = _generalRemarks;
			newMETAView_LocationScheme_Listing.ArchitectureStatus = _architectureStatus;
			newMETAView_LocationScheme_Listing.ArchitectureStatusDate = _architectureStatusDate;
			newMETAView_LocationScheme_Listing.DesignRationale = _designRationale;
			return newMETAView_LocationScheme_Listing;
		}
		...
		{
			get { return "METAView_LocationScheme_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_LocationScheme_ListingBase Entity 
		///</summary>
		public virtual METAView_LocationScheme_ListingBase Copy()
		{
			//shallow copy entity
			METAView_LocationScheme_Listing copy = new METAView_LocationScheme_Listing();
			...
			copy.AcceptChanges();
			return (METAView_LocationScheme_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_LocationScheme_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_LocationScheme_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_LocationScheme_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_LocationScheme_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_LocationScheme_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_LocationScheme_ListingBase Object1, METAView_LocationScheme_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_LocationScheme_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_LocationScheme_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{18}{17}- WorkspaceName: {0}{17}- WorkspaceTypeId: {1}{17}- VCStatusID: {2}{17}- pkid: {3}{17}- Machine: {4}{17}- VCMachineID: {5}{17}- Name: {6}{17}- GapType: {7}{17}- Description: {8}{17}- Abbreviation: {9}{17}- IsBusinessExternal: {10}{17}- DataSourceID: {11}{17}- DataSourceName: {12}{17}- GeneralRemarks: {13}{17}- ArchitectureStatus: {14}{17}- ArchitectureStatusDate: {15}{17}- DesignRationale: {16}{17}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_LocationScheme_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_LocationScheme_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
