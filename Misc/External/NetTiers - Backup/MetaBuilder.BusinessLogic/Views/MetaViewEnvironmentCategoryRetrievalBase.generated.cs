/*
	...
	Important: Do not modify this file. Edit the file METAViewEnvironmentCategoryRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewEnvironmentCategoryRetrievalBase")]
	public abstract partial class METAViewEnvironmentCategoryRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewEnvironmentCategoryRetrievalBase"/> instance.
		///</summary>
		public METAViewEnvironmentCategoryRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewEnvironmentCategoryRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewEnvironmentCategoryRetrieval CreateMETAViewEnvironmentCategoryRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewEnvironmentCategoryRetrieval newMETAViewEnvironmentCategoryRetrieval = new METAViewEnvironmentCategoryRetrieval();
			newMETAViewEnvironmentCategoryRetrieval.WorkspaceName = _workspaceName;
			newMETAViewEnvironmentCategoryRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewEnvironmentCategoryRetrieval.VCStatusID = _vCStatusID;
			newMETAViewEnvironmentCategoryRetrieval.Pkid = _pkid;
			newMETAViewEnvironmentCategoryRetrieval.Machine = _machine;
			newMETAViewEnvironmentCategoryRetrieval.VCMachineID = _vCMachineID;
			newMETAViewEnvironmentCategoryRetrieval.Name = _name;
			newMETAViewEnvironmentCategoryRetrieval.CustomField1 = _customField1;
			newMETAViewEnvironmentCategoryRetrieval.CustomField2 = _customField2;
			newMETAViewEnvironmentCategoryRetrieval.CustomField3 = _customField3;
			newMETAViewEnvironmentCategoryRetrieval.GapType = _gapType;
			return newMETAViewEnvironmentCategoryRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewEnvironmentCategoryRetrievalBase Entity 
		///</summary>
		public virtual METAViewEnvironmentCategoryRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewEnvironmentCategoryRetrieval copy = new METAViewEnvironmentCategoryRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewEnvironmentCategoryRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewEnvironmentCategoryRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewEnvironmentCategoryRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewEnvironmentCategoryRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewEnvironmentCategoryRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewEnvironmentCategoryRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewEnvironmentCategoryRetrievalBase Object1, METAViewEnvironmentCategoryRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewEnvironmentCategoryRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewEnvironmentCategoryRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewEnvironmentCategoryRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewEnvironmentCategoryRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
