/*
	...
	Important: Do not modify this file. Edit the file METAViewFunctionalDependencyRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewFunctionalDependencyRetrievalBase")]
	public abstract partial class METAViewFunctionalDependencyRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewFunctionalDependencyRetrievalBase"/> instance.
		///</summary>
		public METAViewFunctionalDependencyRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewFunctionalDependencyRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewFunctionalDependencyRetrieval CreateMETAViewFunctionalDependencyRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _inferenceRule, System.String _condition, System.String _description, System.String _cohesionWeight, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewFunctionalDependencyRetrieval newMETAViewFunctionalDependencyRetrieval = new METAViewFunctionalDependencyRetrieval();
			newMETAViewFunctionalDependencyRetrieval.WorkspaceName = _workspaceName;
			newMETAViewFunctionalDependencyRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewFunctionalDependencyRetrieval.VCStatusID = _vCStatusID;
			newMETAViewFunctionalDependencyRetrieval.Pkid = _pkid;
			newMETAViewFunctionalDependencyRetrieval.Machine = _machine;
			newMETAViewFunctionalDependencyRetrieval.VCMachineID = _vCMachineID;
			newMETAViewFunctionalDependencyRetrieval.InferenceRule = _inferenceRule;
			newMETAViewFunctionalDependencyRetrieval.Condition = _condition;
			newMETAViewFunctionalDependencyRetrieval.Description = _description;
			newMETAViewFunctionalDependencyRetrieval.CohesionWeight = _cohesionWeight;
			newMETAViewFunctionalDependencyRetrieval.CustomField1 = _customField1;
			newMETAViewFunctionalDependencyRetrieval.CustomField2 = _customField2;
			newMETAViewFunctionalDependencyRetrieval.CustomField3 = _customField3;
			newMETAViewFunctionalDependencyRetrieval.GapType = _gapType;
			return newMETAViewFunctionalDependencyRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewFunctionalDependencyRetrievalBase Entity 
		///</summary>
		public virtual METAViewFunctionalDependencyRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewFunctionalDependencyRetrieval copy = new METAViewFunctionalDependencyRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewFunctionalDependencyRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewFunctionalDependencyRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewFunctionalDependencyRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewFunctionalDependencyRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewFunctionalDependencyRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewFunctionalDependencyRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewFunctionalDependencyRetrievalBase Object1, METAViewFunctionalDependencyRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewFunctionalDependencyRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewFunctionalDependencyRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewFunctionalDependencyRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewFunctionalDependencyRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
