...
namespace MetaBuilder.DataAccessLayer
{
	...
	public sealed class DataRepository 
	{
		...
		#region ActiveDiagramObjectsProvider
		
		///<summary>
		/// Gets the current instance of the Data Access Logic Component for the <see cref="ActiveDiagramObjects"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		public static ActiveDiagramObjectsProviderBase ActiveDiagramObjectsProvider
		{
			get 
			{
				LoadProviders();
				return _provider.ActiveDiagramObjectsProvider;
			}
		}
		...
		#region ORGUNITFUNCTIONROLEProvider
		
		///<summary>
		/// Gets the current instance of the Data Access Logic Component for the <see cref="ORGUNITFUNCTIONROLE"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		public static ORGUNITFUNCTIONROLEProviderBase ORGUNITFUNCTIONROLEProvider
		{
			get 
			{
				LoadProviders();
				return _provider.ORGUNITFUNCTIONROLEProvider;
			}
		}
	...
	/// </summary>
	[CLSCompliant(true)]
	public class UURIFilters : UURIFilterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the UURIFilters class.
		/// </summary>
		public UURIFilters() : base() { }

		/// <summary>
		/// Initializes a new instance of the UURIFilters class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public UURIFilters(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public UURIFilters(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion UURIFilters
	
	#region UURIQuery
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="UURIParameterBuilder"/> class
	/// that is used exclusively with a <see cref="UURI"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class UURIQuery : UURIParameterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the UURIQuery class.
		/// </summary>
		public UURIQuery() : base() { }

		/// <summary>
		/// Initializes a new instance of the UURIQuery class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public UURIQuery(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public UURIQuery(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }
	...
	#region ActiveDiagramObjectsFilters
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ActiveDiagramObjectsFilters : ActiveDiagramObjectsFilterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ActiveDiagramObjectsFilters class.
		/// </summary>
		public ActiveDiagramObjectsFilters() : base() { }

		/// <summary>
		/// Initializes a new instance of the ActiveDiagramObjectsFilters class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ActiveDiagramObjectsFilters(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ActiveDiagramObjectsFilters(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ActiveDiagramObjectsFilters
	
	#region ActiveDiagramObjectsQuery
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ActiveDiagramObjectsParameterBuilder"/> class
	/// that is used exclusively with a <see cref="ActiveDiagramObjects"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class ActiveDiagramObjectsQuery : ActiveDiagramObjectsParameterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ActiveDiagramObjectsQuery class.
		/// </summary>
		public ActiveDiagramObjectsQuery() : base() { }

		/// <summary>
		/// Initializes a new instance of the ActiveDiagramObjectsQuery class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ActiveDiagramObjectsQuery(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ActiveDiagramObjectsQuery(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ActiveDiagramObjectsQuery
	...
	#region ORGUNITFUNCTIONROLEFilters
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;EntityColumn&gt;"/> class
	/// that is used exclusively with a <see cref="ORGUNITFUNCTIONROLE"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class ORGUNITFUNCTIONROLEFilters : ORGUNITFUNCTIONROLEFilterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ORGUNITFUNCTIONROLEFilters class.
		/// </summary>
		public ORGUNITFUNCTIONROLEFilters() : base() { }

		/// <summary>
		/// Initializes a new instance of the ORGUNITFUNCTIONROLEFilters class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ORGUNITFUNCTIONROLEFilters(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ORGUNITFUNCTIONROLEFilters(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ORGUNITFUNCTIONROLEFilters
	
	#region ORGUNITFUNCTIONROLEQuery
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ORGUNITFUNCTIONROLEParameterBuilder"/> class
	/// that is used exclusively with a <see cref="ORGUNITFUNCTIONROLE"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class ORGUNITFUNCTIONROLEQuery : ORGUNITFUNCTIONROLEParameterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ORGUNITFUNCTIONROLEQuery class.
		/// </summary>
		public ORGUNITFUNCTIONROLEQuery() : base() { }

		/// <summary>
		/// Initializes a new instance of the ORGUNITFUNCTIONROLEQuery class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ORGUNITFUNCTIONROLEQuery(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ORGUNITFUNCTIONROLEQuery(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ORGUNITFUNCTIONROLEQuery
