/*
	...
	Important: Do not modify this file. Edit the file METAView_PrimaryDataSourceIndicator_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_PrimaryDataSourceIndicator_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_PrimaryDataSourceIndicator_ListingBase")]
	public abstract partial class METAView_PrimaryDataSourceIndicator_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_PrimaryDataSourceIndicator_ListingBase"/> instance.
		///</summary>
		public METAView_PrimaryDataSourceIndicator_ListingBase()
		{
		}		
		...
		public METAView_PrimaryDataSourceIndicator_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_PrimaryDataSourceIndicator_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_PrimaryDataSourceIndicator_Listing CreateMETAView_PrimaryDataSourceIndicator_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_PrimaryDataSourceIndicator_Listing newMETAView_PrimaryDataSourceIndicator_Listing = new METAView_PrimaryDataSourceIndicator_Listing();
			newMETAView_PrimaryDataSourceIndicator_Listing.WorkspaceName = _workspaceName;
			newMETAView_PrimaryDataSourceIndicator_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_PrimaryDataSourceIndicator_Listing.VCStatusID = _vCStatusID;
			newMETAView_PrimaryDataSourceIndicator_Listing.pkid = _pkid;
			newMETAView_PrimaryDataSourceIndicator_Listing.Machine = _machine;
			newMETAView_PrimaryDataSourceIndicator_Listing.VCMachineID = _vCMachineID;
			return newMETAView_PrimaryDataSourceIndicator_Listing;
		}
		...
		{
			get { return "METAView_PrimaryDataSourceIndicator_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_PrimaryDataSourceIndicator_ListingBase Entity 
		///</summary>
		public virtual METAView_PrimaryDataSourceIndicator_ListingBase Copy()
		{
			//shallow copy entity
			METAView_PrimaryDataSourceIndicator_Listing copy = new METAView_PrimaryDataSourceIndicator_Listing();
			...
			copy.AcceptChanges();
			return (METAView_PrimaryDataSourceIndicator_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_PrimaryDataSourceIndicator_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_PrimaryDataSourceIndicator_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_PrimaryDataSourceIndicator_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_PrimaryDataSourceIndicator_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_PrimaryDataSourceIndicator_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_PrimaryDataSourceIndicator_ListingBase Object1, METAView_PrimaryDataSourceIndicator_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_PrimaryDataSourceIndicator_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_PrimaryDataSourceIndicator_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_PrimaryDataSourceIndicator_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_PrimaryDataSourceIndicator_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
