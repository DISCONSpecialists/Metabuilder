/*
	...
	Important: Do not modify this file. Edit the file METAView_ExtractionRule_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ExtractionRule_ListingBase")]
	public abstract partial class METAView_ExtractionRule_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ExtractionRule_ListingBase"/> instance.
		///</summary>
		public METAView_ExtractionRule_ListingBase()
		{
		}		
		...
		public METAView_ExtractionRule_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ExtractionRule_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_ExtractionRule_Listing CreateMETAView_ExtractionRule_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_ExtractionRule_Listing newMETAView_ExtractionRule_Listing = new METAView_ExtractionRule_Listing();
			newMETAView_ExtractionRule_Listing.WorkspaceName = _workspaceName;
			newMETAView_ExtractionRule_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_ExtractionRule_Listing.VCStatusID = _vCStatusID;
			newMETAView_ExtractionRule_Listing.pkid = _pkid;
			newMETAView_ExtractionRule_Listing.Machine = _machine;
			newMETAView_ExtractionRule_Listing.VCMachineID = _vCMachineID;
			return newMETAView_ExtractionRule_Listing;
		}
		...
		{
			get { return "METAView_ExtractionRule_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_ExtractionRule_ListingBase Entity 
		///</summary>
		public virtual METAView_ExtractionRule_ListingBase Copy()
		{
			//shallow copy entity
			METAView_ExtractionRule_Listing copy = new METAView_ExtractionRule_Listing();
			...
			copy.AcceptChanges();
			return (METAView_ExtractionRule_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ExtractionRule_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ExtractionRule_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ExtractionRule_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ExtractionRule_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ExtractionRule_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ExtractionRule_ListingBase Object1, METAView_ExtractionRule_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ExtractionRule_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ExtractionRule_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_ExtractionRule_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_ExtractionRule_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
