/*
	...
	Important: Do not modify this file. Edit the file METAView_SecurityClassification_Retrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_SecurityClassification_RetrievalBase")]
	public abstract partial class METAView_SecurityClassification_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_SecurityClassification_RetrievalBase"/> instance.
		///</summary>
		public METAView_SecurityClassification_RetrievalBase()
		{
		}		
		...
		public METAView_SecurityClassification_RetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_SecurityClassification_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_SecurityClassification_Retrieval CreateMETAView_SecurityClassification_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_SecurityClassification_Retrieval newMETAView_SecurityClassification_Retrieval = new METAView_SecurityClassification_Retrieval();
			newMETAView_SecurityClassification_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_SecurityClassification_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_SecurityClassification_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_SecurityClassification_Retrieval.pkid = _pkid;
			newMETAView_SecurityClassification_Retrieval.Machine = _machine;
			newMETAView_SecurityClassification_Retrieval.VCMachineID = _vCMachineID;
			return newMETAView_SecurityClassification_Retrieval;
		}
		...
		{
			get { return "METAView_SecurityClassification_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_SecurityClassification_RetrievalBase Entity 
		///</summary>
		public virtual METAView_SecurityClassification_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_SecurityClassification_Retrieval copy = new METAView_SecurityClassification_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_SecurityClassification_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_SecurityClassification_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_SecurityClassification_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_SecurityClassification_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_SecurityClassification_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_SecurityClassification_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_SecurityClassification_RetrievalBase Object1, METAView_SecurityClassification_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_SecurityClassification_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_SecurityClassification_Retrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_SecurityClassification_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_SecurityClassification_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
