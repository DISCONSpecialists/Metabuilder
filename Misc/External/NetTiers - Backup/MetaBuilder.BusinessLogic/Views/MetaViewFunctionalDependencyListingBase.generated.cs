/*
	...
	Important: Do not modify this file. Edit the file METAViewFunctionalDependencyListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewFunctionalDependencyListingBase")]
	public abstract partial class METAViewFunctionalDependencyListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewFunctionalDependencyListingBase"/> instance.
		///</summary>
		public METAViewFunctionalDependencyListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewFunctionalDependencyListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewFunctionalDependencyListing CreateMETAViewFunctionalDependencyListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _inferenceRule, System.String _condition, System.String _description, System.String _cohesionWeight, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewFunctionalDependencyListing newMETAViewFunctionalDependencyListing = new METAViewFunctionalDependencyListing();
			newMETAViewFunctionalDependencyListing.WorkspaceName = _workspaceName;
			newMETAViewFunctionalDependencyListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewFunctionalDependencyListing.VCStatusID = _vCStatusID;
			newMETAViewFunctionalDependencyListing.Pkid = _pkid;
			newMETAViewFunctionalDependencyListing.Machine = _machine;
			newMETAViewFunctionalDependencyListing.VCMachineID = _vCMachineID;
			newMETAViewFunctionalDependencyListing.InferenceRule = _inferenceRule;
			newMETAViewFunctionalDependencyListing.Condition = _condition;
			newMETAViewFunctionalDependencyListing.Description = _description;
			newMETAViewFunctionalDependencyListing.CohesionWeight = _cohesionWeight;
			newMETAViewFunctionalDependencyListing.CustomField1 = _customField1;
			newMETAViewFunctionalDependencyListing.CustomField2 = _customField2;
			newMETAViewFunctionalDependencyListing.CustomField3 = _customField3;
			newMETAViewFunctionalDependencyListing.GapType = _gapType;
			return newMETAViewFunctionalDependencyListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewFunctionalDependencyListingBase Entity 
		///</summary>
		public virtual METAViewFunctionalDependencyListingBase Copy()
		{
			//shallow copy entity
			METAViewFunctionalDependencyListing copy = new METAViewFunctionalDependencyListing();
			...
			copy.AcceptChanges();
			return (METAViewFunctionalDependencyListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewFunctionalDependencyListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewFunctionalDependencyListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewFunctionalDependencyListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewFunctionalDependencyListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewFunctionalDependencyListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewFunctionalDependencyListingBase Object1, METAViewFunctionalDependencyListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewFunctionalDependencyListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewFunctionalDependencyListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewFunctionalDependencyListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewFunctionalDependencyListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
