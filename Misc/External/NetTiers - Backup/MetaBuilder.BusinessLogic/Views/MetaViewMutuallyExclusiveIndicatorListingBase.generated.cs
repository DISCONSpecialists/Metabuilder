/*
	...
	Important: Do not modify this file. Edit the file METAViewMutuallyExclusiveIndicatorListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewMutuallyExclusiveIndicatorListingBase")]
	public abstract partial class METAViewMutuallyExclusiveIndicatorListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewMutuallyExclusiveIndicatorListingBase"/> instance.
		///</summary>
		public METAViewMutuallyExclusiveIndicatorListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewMutuallyExclusiveIndicatorListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_selectorType"></param>
		///<param name="_gapType"></param>
		public static METAViewMutuallyExclusiveIndicatorListing CreateMETAViewMutuallyExclusiveIndicatorListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _customField1, System.String _customField2, System.String _customField3, System.String _selectorType, System.String _gapType)
		{
			METAViewMutuallyExclusiveIndicatorListing newMETAViewMutuallyExclusiveIndicatorListing = new METAViewMutuallyExclusiveIndicatorListing();
			newMETAViewMutuallyExclusiveIndicatorListing.WorkspaceName = _workspaceName;
			newMETAViewMutuallyExclusiveIndicatorListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewMutuallyExclusiveIndicatorListing.VCStatusID = _vCStatusID;
			newMETAViewMutuallyExclusiveIndicatorListing.Pkid = _pkid;
			newMETAViewMutuallyExclusiveIndicatorListing.Machine = _machine;
			newMETAViewMutuallyExclusiveIndicatorListing.VCMachineID = _vCMachineID;
			newMETAViewMutuallyExclusiveIndicatorListing.Name = _name;
			newMETAViewMutuallyExclusiveIndicatorListing.CustomField1 = _customField1;
			newMETAViewMutuallyExclusiveIndicatorListing.CustomField2 = _customField2;
			newMETAViewMutuallyExclusiveIndicatorListing.CustomField3 = _customField3;
			newMETAViewMutuallyExclusiveIndicatorListing.SelectorType = _selectorType;
			newMETAViewMutuallyExclusiveIndicatorListing.GapType = _gapType;
			return newMETAViewMutuallyExclusiveIndicatorListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewMutuallyExclusiveIndicatorListingBase Entity 
		///</summary>
		public virtual METAViewMutuallyExclusiveIndicatorListingBase Copy()
		{
			//shallow copy entity
			METAViewMutuallyExclusiveIndicatorListing copy = new METAViewMutuallyExclusiveIndicatorListing();
			...
			copy.AcceptChanges();
			return (METAViewMutuallyExclusiveIndicatorListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewMutuallyExclusiveIndicatorListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewMutuallyExclusiveIndicatorListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewMutuallyExclusiveIndicatorListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewMutuallyExclusiveIndicatorListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewMutuallyExclusiveIndicatorListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewMutuallyExclusiveIndicatorListingBase Object1, METAViewMutuallyExclusiveIndicatorListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewMutuallyExclusiveIndicatorListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewMutuallyExclusiveIndicatorListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewMutuallyExclusiveIndicatorListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewMutuallyExclusiveIndicatorListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
