/*
	...
	Important: Do not modify this file. Edit the file METAViewTimeIndicatorRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewTimeIndicatorRetrievalBase")]
	public abstract partial class METAViewTimeIndicatorRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewTimeIndicatorRetrievalBase"/> instance.
		///</summary>
		public METAViewTimeIndicatorRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewTimeIndicatorRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewTimeIndicatorRetrieval CreateMETAViewTimeIndicatorRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewTimeIndicatorRetrieval newMETAViewTimeIndicatorRetrieval = new METAViewTimeIndicatorRetrieval();
			newMETAViewTimeIndicatorRetrieval.WorkspaceName = _workspaceName;
			newMETAViewTimeIndicatorRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewTimeIndicatorRetrieval.VCStatusID = _vCStatusID;
			newMETAViewTimeIndicatorRetrieval.Pkid = _pkid;
			newMETAViewTimeIndicatorRetrieval.Machine = _machine;
			newMETAViewTimeIndicatorRetrieval.VCMachineID = _vCMachineID;
			newMETAViewTimeIndicatorRetrieval.Value = _value;
			newMETAViewTimeIndicatorRetrieval.CustomField1 = _customField1;
			newMETAViewTimeIndicatorRetrieval.CustomField2 = _customField2;
			newMETAViewTimeIndicatorRetrieval.CustomField3 = _customField3;
			newMETAViewTimeIndicatorRetrieval.GapType = _gapType;
			return newMETAViewTimeIndicatorRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewTimeIndicatorRetrievalBase Entity 
		///</summary>
		public virtual METAViewTimeIndicatorRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewTimeIndicatorRetrieval copy = new METAViewTimeIndicatorRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewTimeIndicatorRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewTimeIndicatorRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewTimeIndicatorRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewTimeIndicatorRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewTimeIndicatorRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewTimeIndicatorRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewTimeIndicatorRetrievalBase Object1, METAViewTimeIndicatorRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewTimeIndicatorRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewTimeIndicatorRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewTimeIndicatorRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewTimeIndicatorRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
