/*
	...
	Important: Do not modify this file. Edit the file METAViewRoleListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewRoleListingBase")]
	public abstract partial class METAViewRoleListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewRoleListingBase"/> instance.
		///</summary>
		public METAViewRoleListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewRoleListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField2"></param>
		///<param name="_customField3"></param>
		public static METAViewRoleListing CreateMETAViewRoleListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _gapType, System.String _customField1, System.String _customField2, System.String _customField3)
		{
			METAViewRoleListing newMETAViewRoleListing = new METAViewRoleListing();
			newMETAViewRoleListing.WorkspaceName = _workspaceName;
			newMETAViewRoleListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewRoleListing.VCStatusID = _vCStatusID;
			newMETAViewRoleListing.Pkid = _pkid;
			newMETAViewRoleListing.Machine = _machine;
			newMETAViewRoleListing.VCMachineID = _vCMachineID;
			newMETAViewRoleListing.Name = _name;
			newMETAViewRoleListing.GapType = _gapType;
			newMETAViewRoleListing.CustomField1 = _customField1;
			newMETAViewRoleListing.CustomField2 = _customField2;
			newMETAViewRoleListing.CustomField3 = _customField3;
			return newMETAViewRoleListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewRoleListingBase Entity 
		///</summary>
		public virtual METAViewRoleListingBase Copy()
		{
			//shallow copy entity
			METAViewRoleListing copy = new METAViewRoleListing();
			...
			copy.AcceptChanges();
			return (METAViewRoleListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewRoleListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewRoleListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewRoleListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewRoleListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewRoleListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewRoleListingBase Object1, METAViewRoleListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewRoleListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewRoleListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewRoleListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewRoleListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
