/*
	...
	Important: Do not modify this file. Edit the file METAView_ConnectionSpeed_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ConnectionSpeed_ListingBase")]
	public abstract partial class METAView_ConnectionSpeed_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ConnectionSpeed_ListingBase"/> instance.
		///</summary>
		public METAView_ConnectionSpeed_ListingBase()
		{
		}		
		...
		public METAView_ConnectionSpeed_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ConnectionSpeed_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_vCMachineID"></param>
		///<param name="_value"></param>
		public static METAView_ConnectionSpeed_Listing CreateMETAView_ConnectionSpeed_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value)
		{
			METAView_ConnectionSpeed_Listing newMETAView_ConnectionSpeed_Listing = new METAView_ConnectionSpeed_Listing();
			newMETAView_ConnectionSpeed_Listing.WorkspaceName = _workspaceName;
			newMETAView_ConnectionSpeed_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_ConnectionSpeed_Listing.VCStatusID = _vCStatusID;
			newMETAView_ConnectionSpeed_Listing.pkid = _pkid;
			newMETAView_ConnectionSpeed_Listing.Machine = _machine;
			newMETAView_ConnectionSpeed_Listing.VCMachineID = _vCMachineID;
			newMETAView_ConnectionSpeed_Listing.Value = _value;
			return newMETAView_ConnectionSpeed_Listing;
		}
		...
		{
			get { return "METAView_ConnectionSpeed_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_ConnectionSpeed_ListingBase Entity 
		///</summary>
		public virtual METAView_ConnectionSpeed_ListingBase Copy()
		{
			//shallow copy entity
			METAView_ConnectionSpeed_Listing copy = new METAView_ConnectionSpeed_Listing();
			...
			copy.AcceptChanges();
			return (METAView_ConnectionSpeed_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ConnectionSpeed_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ConnectionSpeed_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ConnectionSpeed_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ConnectionSpeed_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ConnectionSpeed_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ConnectionSpeed_ListingBase Object1, METAView_ConnectionSpeed_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ConnectionSpeed_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ConnectionSpeed_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_ConnectionSpeed_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_ConnectionSpeed_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
