/*
	...
	Important: Do not modify this file. Edit the file METAViewConnectionTypeRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewConnectionTypeRetrievalBase")]
	public abstract partial class METAViewConnectionTypeRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewConnectionTypeRetrievalBase"/> instance.
		///</summary>
		public METAViewConnectionTypeRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewConnectionTypeRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewConnectionTypeRetrieval CreateMETAViewConnectionTypeRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewConnectionTypeRetrieval newMETAViewConnectionTypeRetrieval = new METAViewConnectionTypeRetrieval();
			newMETAViewConnectionTypeRetrieval.WorkspaceName = _workspaceName;
			newMETAViewConnectionTypeRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewConnectionTypeRetrieval.VCStatusID = _vCStatusID;
			newMETAViewConnectionTypeRetrieval.Pkid = _pkid;
			newMETAViewConnectionTypeRetrieval.Machine = _machine;
			newMETAViewConnectionTypeRetrieval.VCMachineID = _vCMachineID;
			newMETAViewConnectionTypeRetrieval.Value = _value;
			newMETAViewConnectionTypeRetrieval.CustomField1 = _customField1;
			newMETAViewConnectionTypeRetrieval.CustomField2 = _customField2;
			newMETAViewConnectionTypeRetrieval.CustomField3 = _customField3;
			newMETAViewConnectionTypeRetrieval.GapType = _gapType;
			return newMETAViewConnectionTypeRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewConnectionTypeRetrievalBase Entity 
		///</summary>
		public virtual METAViewConnectionTypeRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewConnectionTypeRetrieval copy = new METAViewConnectionTypeRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewConnectionTypeRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewConnectionTypeRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewConnectionTypeRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewConnectionTypeRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewConnectionTypeRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewConnectionTypeRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewConnectionTypeRetrievalBase Object1, METAViewConnectionTypeRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewConnectionTypeRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewConnectionTypeRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewConnectionTypeRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewConnectionTypeRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
