/*
	...
	Important: Do not modify this file. Edit the file METAView_Activity_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Activity_ListingBase")]
	public abstract partial class METAView_Activity_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Activity_ListingBase"/> instance.
		///</summary>
		public METAView_Activity_ListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Activity_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_architectureStatusDate"></param>
		///<param name="_designRationale"></param>
		public static METAView_Activity_Listing CreateMETAView_Activity_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _executionIndicator, System.String _gapType, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _dataSourceID, System.String _dataSourceName, System.String _generalRemarks, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale)
		{
			METAView_Activity_Listing newMETAView_Activity_Listing = new METAView_Activity_Listing();
			newMETAView_Activity_Listing.WorkspaceName = _workspaceName;
			newMETAView_Activity_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_Activity_Listing.VCStatusID = _vCStatusID;
			newMETAView_Activity_Listing.pkid = _pkid;
			newMETAView_Activity_Listing.Machine = _machine;
			newMETAView_Activity_Listing.VCMachineID = _vCMachineID;
			newMETAView_Activity_Listing.Name = _name;
			newMETAView_Activity_Listing.ExecutionIndicator = _executionIndicator;
			newMETAView_Activity_Listing.GapType = _gapType;
			newMETAView_Activity_Listing.Description = _description;
			newMETAView_Activity_Listing.Abbreviation = _abbreviation;
			newMETAView_Activity_Listing.IsBusinessExternal = _isBusinessExternal;
			newMETAView_Activity_Listing.DataSourceID = _dataSourceID;
			newMETAView_Activity_Listing.DataSourceName = _dataSourceName;
			newMETAView_Activity_Listing.GeneralRemarks = _generalRemarks;
			newMETAView_Activity_Listing.ArchitectureStatus = _architectureStatus;
			newMETAView_Activity_Listing.ArchitectureStatusDate = _architectureStatusDate;
			newMETAView_Activity_Listing.DesignRationale = _designRationale;
			return newMETAView_Activity_Listing;
		}
		...
		{
			get { return "METAView_Activity_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_Activity_ListingBase Entity 
		///</summary>
		public virtual METAView_Activity_ListingBase Copy()
		{
			//shallow copy entity
			METAView_Activity_Listing copy = new METAView_Activity_Listing();
			...
			copy.AcceptChanges();
			return (METAView_Activity_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Activity_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Activity_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Activity_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Activity_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Activity_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Activity_ListingBase Object1, METAView_Activity_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Activity_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_Activity_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{19}{18}- WorkspaceName: {0}{18}- WorkspaceTypeId: {1}{18}- VCStatusID: {2}{18}- pkid: {3}{18}- Machine: {4}{18}- VCMachineID: {5}{18}- Name: {6}{18}- ExecutionIndicator: {7}{18}- GapType: {8}{18}- Description: {9}{18}- Abbreviation: {10}{18}- IsBusinessExternal: {11}{18}- DataSourceID: {12}{18}- DataSourceName: {13}{18}- GeneralRemarks: {14}{18}- ArchitectureStatus: {15}{18}- ArchitectureStatusDate: {16}{18}- DesignRationale: {17}{18}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_Activity_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_Activity_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
