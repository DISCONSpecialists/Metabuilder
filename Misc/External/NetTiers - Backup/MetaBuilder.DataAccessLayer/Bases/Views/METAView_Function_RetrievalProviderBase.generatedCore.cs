		...
		protected VList<METAView_Function_Retrieval> Fill(IDataReader reader, VList<METAView_Function_Retrieval> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.FunctionCriticality = (reader.IsDBNull(((int)METAView_Function_RetrievalColumn.FunctionCriticality)))?null:(System.Int32?)reader[((int)METAView_Function_RetrievalColumn.FunctionCriticality)];
					...
					entity.Effeciency = (reader.IsDBNull(((int)METAView_Function_RetrievalColumn.Effeciency)))?null:(System.String)reader[((int)METAView_Function_RetrievalColumn.Effeciency)];
					//entity.Effeciency = (Convert.IsDBNull(reader["Effeciency"]))?string.Empty:(System.String)reader["Effeciency"];
					entity.Effectiviness = (reader.IsDBNull(((int)METAView_Function_RetrievalColumn.Effectiviness)))?null:(System.String)reader[((int)METAView_Function_RetrievalColumn.Effectiviness)];
