		...
		protected VList<METAView_Entity_Listing> Fill(IDataReader reader, VList<METAView_Entity_Listing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.CustomField1 = (reader.IsDBNull(((int)METAView_Entity_ListingColumn.CustomField1)))?null:(System.String)reader[((int)METAView_Entity_ListingColumn.CustomField1)];
					//entity.CustomField1 = (Convert.IsDBNull(reader["CustomField1"]))?string.Empty:(System.String)reader["CustomField1"];
					entity.CustomField2 = (reader.IsDBNull(((int)METAView_Entity_ListingColumn.CustomField2)))?null:(System.String)reader[((int)METAView_Entity_ListingColumn.CustomField2)];
					//entity.CustomField2 = (Convert.IsDBNull(reader["CustomField2"]))?string.Empty:(System.String)reader["CustomField2"];
					entity.CustomField3 = (reader.IsDBNull(((int)METAView_Entity_ListingColumn.CustomField3)))?null:(System.String)reader[((int)METAView_Entity_ListingColumn.CustomField3)];
