...
{
    [Serializable]
    public class GradientEllipse : GoEllipse, ISnappableShape, IIdentifiable, IBehaviourShape
    {
        ...
        public override void CopyObjectDelayed(GoCopyDictionary env, GoObject newobj)
        {
            ...
            GradientEllipse ellipse = newobj as GradientEllipse;
            ellipse.Name = Name.Substring(0, Name.Length);
            if (Manager != null)
                ellipse.Manager = Manager.Copy(ellipse);
        }
    }
}