/*
	...
	Important: Do not modify this file. Edit the file METAViewIterationListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewIterationListingBase")]
	public abstract partial class METAViewIterationListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewIterationListingBase"/> instance.
		///</summary>
		public METAViewIterationListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewIterationListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewIterationListing CreateMETAViewIterationListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _iterationType, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewIterationListing newMETAViewIterationListing = new METAViewIterationListing();
			newMETAViewIterationListing.WorkspaceName = _workspaceName;
			newMETAViewIterationListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewIterationListing.VCStatusID = _vCStatusID;
			newMETAViewIterationListing.Pkid = _pkid;
			newMETAViewIterationListing.Machine = _machine;
			newMETAViewIterationListing.VCMachineID = _vCMachineID;
			newMETAViewIterationListing.Name = _name;
			newMETAViewIterationListing.IterationType = _iterationType;
			newMETAViewIterationListing.CustomField1 = _customField1;
			newMETAViewIterationListing.CustomField2 = _customField2;
			newMETAViewIterationListing.CustomField3 = _customField3;
			newMETAViewIterationListing.GapType = _gapType;
			return newMETAViewIterationListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewIterationListingBase Entity 
		///</summary>
		public virtual METAViewIterationListingBase Copy()
		{
			//shallow copy entity
			METAViewIterationListing copy = new METAViewIterationListing();
			...
			copy.AcceptChanges();
			return (METAViewIterationListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewIterationListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewIterationListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewIterationListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewIterationListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewIterationListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewIterationListingBase Object1, METAViewIterationListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewIterationListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewIterationListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewIterationListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewIterationListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
