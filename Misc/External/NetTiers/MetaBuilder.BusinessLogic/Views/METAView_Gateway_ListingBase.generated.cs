/*
	...
	Important: Do not modify this file. Edit the file METAView_Gateway_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_Gateway_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Gateway_ListingBase")]
	public abstract partial class METAView_Gateway_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Gateway_ListingBase"/> instance.
		///</summary>
		public METAView_Gateway_ListingBase()
		{
		}		
		...
		public METAView_Gateway_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _gatewayType)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Gateway_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_name"></param>
		///<param name="_gatewayType"></param>
		public static METAView_Gateway_Listing CreateMETAView_Gateway_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _gatewayType)
		{
			METAView_Gateway_Listing newMETAView_Gateway_Listing = new METAView_Gateway_Listing();
			newMETAView_Gateway_Listing.WorkspaceName = _workspaceName;
			newMETAView_Gateway_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_Gateway_Listing.VCStatusID = _vCStatusID;
			newMETAView_Gateway_Listing.pkid = _pkid;
			newMETAView_Gateway_Listing.Machine = _machine;
			newMETAView_Gateway_Listing.VCMachineID = _vCMachineID;
			newMETAView_Gateway_Listing.Name = _name;
			newMETAView_Gateway_Listing.GatewayType = _gatewayType;
			return newMETAView_Gateway_Listing;
		}
		...
		{
			get { return "METAView_Gateway_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_Gateway_ListingBase Entity 
		///</summary>
		public virtual METAView_Gateway_ListingBase Copy()
		{
			//shallow copy entity
			METAView_Gateway_Listing copy = new METAView_Gateway_Listing();
			...
			copy.AcceptChanges();
			return (METAView_Gateway_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Gateway_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Gateway_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Gateway_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Gateway_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Gateway_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Gateway_ListingBase Object1, METAView_Gateway_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Gateway_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_Gateway_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{9}{8}- WorkspaceName: {0}{8}- WorkspaceTypeId: {1}{8}- VCStatusID: {2}{8}- pkid: {3}{8}- Machine: {4}{8}- VCMachineID: {5}{8}- Name: {6}{8}- GatewayType: {7}{8}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_Gateway_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_Gateway_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
