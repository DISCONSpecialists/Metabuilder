/*
	...
	Important: Do not modify this file. Edit the file METAView_ModelReal_Retrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ModelReal_RetrievalBase")]
	public abstract partial class METAView_ModelReal_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ModelReal_RetrievalBase"/> instance.
		///</summary>
		public METAView_ModelReal_RetrievalBase()
		{
		}		
		...
		public METAView_ModelReal_RetrievalBase(System.String _workspaceName, System.Int32? _WorkspaceTypeId, System.Int32 _VCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ModelReal_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_WorkspaceTypeId"></param>
		///<param name="_VCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_ModelReal_Retrieval CreateMETAView_ModelReal_Retrieval(System.String _workspaceName, System.Int32? _WorkspaceTypeId, System.Int32 _VCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_ModelReal_Retrieval newMETAView_ModelReal_Retrieval = new METAView_ModelReal_Retrieval();
			newMETAView_ModelReal_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_ModelReal_Retrieval.WorkspaceTypeId = _WorkspaceTypeId;
			newMETAView_ModelReal_Retrieval.VCStatusID = _VCStatusID;
			newMETAView_ModelReal_Retrieval.pkid = _pkid;
			newMETAView_ModelReal_Retrieval.Machine = _machine;
			newMETAView_ModelReal_Retrieval.VCMachineID = _vCMachineID;
			return newMETAView_ModelReal_Retrieval;
		}
		...
		{
			get { return "METAView_ModelReal_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_ModelReal_RetrievalBase Entity 
		///</summary>
		public virtual METAView_ModelReal_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_ModelReal_Retrieval copy = new METAView_ModelReal_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_ModelReal_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ModelReal_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ModelReal_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ModelReal_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ModelReal_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ModelReal_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ModelReal_RetrievalBase Object1, METAView_ModelReal_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ModelReal_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ModelReal_Retrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_ModelReal_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_ModelReal_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
