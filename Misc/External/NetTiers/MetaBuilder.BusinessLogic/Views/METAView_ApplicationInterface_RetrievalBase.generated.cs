/*
	...
	Important: Do not modify this file. Edit the file METAView_ApplicationInterface_Retrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ApplicationInterface_RetrievalBase")]
	public abstract partial class METAView_ApplicationInterface_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ApplicationInterface_RetrievalBase"/> instance.
		///</summary>
		public METAView_ApplicationInterface_RetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ApplicationInterface_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_architectureStatus"></param>
		///<param name="_architectureStatusDate"></param>
		public static METAView_ApplicationInterface_Retrieval CreateMETAView_ApplicationInterface_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _executionIndicator, System.String _interfaceFrequency, System.String _isPlannedOrAdHoc, System.String _runsDuringWorkingHours, System.String _isSynchronised, System.String _interfaceVolume, System.String _name, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _standardisationStatus, System.String _standardisationStatusDate, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _criticality, System.String _interfaceProtocol, System.String _interfacePattern, System.String _architectureStatus, System.String _architectureStatusDate)
		{
			METAView_ApplicationInterface_Retrieval newMETAView_ApplicationInterface_Retrieval = new METAView_ApplicationInterface_Retrieval();
			newMETAView_ApplicationInterface_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_ApplicationInterface_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_ApplicationInterface_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_ApplicationInterface_Retrieval.pkid = _pkid;
			newMETAView_ApplicationInterface_Retrieval.Machine = _machine;
			newMETAView_ApplicationInterface_Retrieval.VCMachineID = _vCMachineID;
			newMETAView_ApplicationInterface_Retrieval.ExecutionIndicator = _executionIndicator;
			newMETAView_ApplicationInterface_Retrieval.InterfaceFrequency = _interfaceFrequency;
			newMETAView_ApplicationInterface_Retrieval.IsPlannedOrAdHoc = _isPlannedOrAdHoc;
			newMETAView_ApplicationInterface_Retrieval.RunsDuringWorkingHours = _runsDuringWorkingHours;
			newMETAView_ApplicationInterface_Retrieval.IsSynchronised = _isSynchronised;
			newMETAView_ApplicationInterface_Retrieval.InterfaceVolume = _interfaceVolume;
			newMETAView_ApplicationInterface_Retrieval.Name = _name;
			newMETAView_ApplicationInterface_Retrieval.Description = _description;
			newMETAView_ApplicationInterface_Retrieval.Abbreviation = _abbreviation;
			newMETAView_ApplicationInterface_Retrieval.IsBusinessExternal = _isBusinessExternal;
			newMETAView_ApplicationInterface_Retrieval.StandardisationStatus = _standardisationStatus;
			newMETAView_ApplicationInterface_Retrieval.StandardisationStatusDate = _standardisationStatusDate;
			newMETAView_ApplicationInterface_Retrieval.DesignRationale = _designRationale;
			newMETAView_ApplicationInterface_Retrieval.GeneralRemarks = _generalRemarks;
			newMETAView_ApplicationInterface_Retrieval.GapType = _gapType;
			newMETAView_ApplicationInterface_Retrieval.DataSourceID = _dataSourceID;
			newMETAView_ApplicationInterface_Retrieval.DataSourceName = _dataSourceName;
			newMETAView_ApplicationInterface_Retrieval.Criticality = _criticality;
			newMETAView_ApplicationInterface_Retrieval.InterfaceProtocol = _interfaceProtocol;
			newMETAView_ApplicationInterface_Retrieval.InterfacePattern = _interfacePattern;
			newMETAView_ApplicationInterface_Retrieval.ArchitectureStatus = _architectureStatus;
			newMETAView_ApplicationInterface_Retrieval.ArchitectureStatusDate = _architectureStatusDate;
			return newMETAView_ApplicationInterface_Retrieval;
		}
		...
		{
			get { return "METAView_ApplicationInterface_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_ApplicationInterface_RetrievalBase Entity 
		///</summary>
		public virtual METAView_ApplicationInterface_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_ApplicationInterface_Retrieval copy = new METAView_ApplicationInterface_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_ApplicationInterface_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ApplicationInterface_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ApplicationInterface_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ApplicationInterface_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ApplicationInterface_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ApplicationInterface_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ApplicationInterface_RetrievalBase Object1, METAView_ApplicationInterface_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ApplicationInterface_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ApplicationInterface_Retrieval, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{29}{28}- WorkspaceName: {0}{28}- WorkspaceTypeId: {1}{28}- VCStatusID: {2}{28}- pkid: {3}{28}- Machine: {4}{28}- VCMachineID: {5}{28}- ExecutionIndicator: {6}{28}- InterfaceFrequency: {7}{28}- IsPlannedOrAdHoc: {8}{28}- RunsDuringWorkingHours: {9}{28}- IsSynchronised: {10}{28}- InterfaceVolume: {11}{28}- Name: {12}{28}- Description: {13}{28}- Abbreviation: {14}{28}- IsBusinessExternal: {15}{28}- StandardisationStatus: {16}{28}- StandardisationStatusDate: {17}{28}- DesignRationale: {18}{28}- GeneralRemarks: {19}{28}- GapType: {20}{28}- DataSourceID: {21}{28}- DataSourceName: {22}{28}- Criticality: {23}{28}- InterfaceProtocol: {24}{28}- InterfacePattern: {25}{28}- ArchitectureStatus: {26}{28}- ArchitectureStatusDate: {27}{28}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_ApplicationInterface_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_ApplicationInterface_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
