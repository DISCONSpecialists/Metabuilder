...
namespace MetaBuilder.UIControls.GraphingUI.ActionMenu.Utils
{
    /// <summary>
...
/// <summary>
        ...
        public static String GetVolumeName(String driveLetter)
        {
            ...
            Win32GetVolumeInformation(driveLetter, namebuf, namelen, out serial, out maxCompLen, out flags, sysname,
                                      namelen);
        ...
        private static extern bool Win32GetVolumeInformation(String root, byte[] name, int nameLen, out int serial,
                                                             out int maxCompLen, out int flags, byte[] fileSysName,
                                                             int fileSysNameLen);
        #endregion
    }
}