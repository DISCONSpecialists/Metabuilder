...
namespace MetaBuilder.UIControls.GraphingUI.ActionMenu
{
    ...
    public class MenuExtender : Component, IExtenderProvider
    {
        ...
        #region Constructors
        public MenuExtender(IContainer container) : this()
        {
            container.Add(this);
        }
        ...
        [TypeConverter(typeof (IndexConverter)), Editor(typeof (ImageIndexEditor), typeof (UITypeEditor))]
        ...
        private class MenuHelper
        {
            ...
            public int CalcWidth()
            {
                ...
                int menuWidth = (int) Math.Ceiling(gfx.MeasureString(menuItem.Text, CurrentFont, 1000, sf).Width);
                int shortcutWidth = (int) Math.Ceiling(gfx.MeasureString(ShortcutText, CurrentFont, 1000, sf).Width);
            ...
            public Font CurrentFont
            {
                get
                {
                    if (menuItem.DefaultItem)
                    {
                        ...
                        try
                        {
                            font = new Font(menuFont, menuFont.Style | FontStyle.Bold);
                        }
                        catch
                        {
                            return menuFont;
            ...
            private void DrawMenuText(Rectangle bounds, bool selected)
            {
                ...
                sfMenu.HotkeyPrefix = HotkeyPrefix.Show;
                int yPos = bounds.Top + (bounds.Height - CurrentFont.Height)/2;
                gfx.DrawString(menuItem.Text, CurrentFont, menuBrush,
                ...
                if (! IsTopLevel() && HasShortcut())
                {
                    ...
                    gfx.DrawString(ShortcutText, CurrentFont, menuBrush,
    ...
    internal class ImageIndexEditor : UITypeEditor
    {
        ...
        public override void PaintValue(PaintValueEventArgs pe)
        {
            ...
            IExtenderListService extenderListService =
                (IExtenderListService) component.Site.GetService(typeof (IExtenderListService));
        ...
        internal class ImageSelector : ListView
        {
            ...
            public ImageSelector(ImageList images, int selectedIndex, IWindowsFormsEditorService wfes)
            {
                ...
                FullRowSelect = true;
                GridLines = false;
                Columns.Add("Index", -2, HorizontalAlignment.Left);
                HeaderStyle = ColumnHeaderStyle.None;
                MultiSelect = false;
                Click += new EventHandler(ImageSelector_Click);
                if (images != null)
                {
                ...
                Items[selectedIndex].EnsureVisible();
            }
