...
{	
		...
		protected VList<METAViewCADRealRetrieval> Fill(IDataReader reader, VList<METAViewCADRealRetrieval> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.WorkspaceName = (System.String)reader[((int)METAViewCADRealRetrievalColumn.WorkspaceName)];
					//entity.WorkspaceName = (Convert.IsDBNull(reader["WorkspaceName"]))?string.Empty:(System.String)reader["WorkspaceName"];
					entity.WorkspaceTypeID = (reader.IsDBNull(((int)METAViewCADRealRetrievalColumn.WorkspaceTypeID)))?null:(System.Int32?)reader[((int)METAViewCADRealRetrievalColumn.WorkspaceTypeID)];
					//entity.WorkspaceTypeID = (Convert.IsDBNull(reader["WorkspaceTypeID"]))?(int)0:(System.Int32?)reader["WorkspaceTypeID"];
					entity.VCStatusID = (System.Int32)reader[((int)METAViewCADRealRetrievalColumn.VCStatusID)];
					//entity.VCStatusID = (Convert.IsDBNull(reader["VCStatusID"]))?(int)0:(System.Int32)reader["VCStatusID"];
					entity.Pkid = (System.Int32)reader[((int)METAViewCADRealRetrievalColumn.Pkid)];
					//entity.Pkid = (Convert.IsDBNull(reader["pkid"]))?(int)0:(System.Int32)reader["pkid"];
					entity.Machine = (System.String)reader[((int)METAViewCADRealRetrievalColumn.Machine)];
					//entity.Machine = (Convert.IsDBNull(reader["Machine"]))?string.Empty:(System.String)reader["Machine"];
					entity.VCMachineID = (reader.IsDBNull(((int)METAViewCADRealRetrievalColumn.VCMachineID)))?null:(System.String)reader[((int)METAViewCADRealRetrievalColumn.VCMachineID)];
	...
	#region METAViewCADRealRetrievalSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class METAViewCADRealRetrievalSortBuilder : SqlSortBuilder<METAViewCADRealRetrievalColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the METAViewCADRealRetrievalSqlSortBuilder class.
		/// </summary>
		public METAViewCADRealRetrievalSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion METAViewCADRealRetrievalSortBuilder
