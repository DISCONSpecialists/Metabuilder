...
{	
		...
		protected VList<METAViewDatedResponsibilityRetrieval> Fill(IDataReader reader, VList<METAViewDatedResponsibilityRetrieval> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.WorkspaceName = (System.String)reader[((int)METAViewDatedResponsibilityRetrievalColumn.WorkspaceName)];
					//entity.WorkspaceName = (Convert.IsDBNull(reader["WorkspaceName"]))?string.Empty:(System.String)reader["WorkspaceName"];
					entity.WorkspaceTypeID = (reader.IsDBNull(((int)METAViewDatedResponsibilityRetrievalColumn.WorkspaceTypeID)))?null:(System.Int32?)reader[((int)METAViewDatedResponsibilityRetrievalColumn.WorkspaceTypeID)];
					//entity.WorkspaceTypeID = (Convert.IsDBNull(reader["WorkspaceTypeID"]))?(int)0:(System.Int32?)reader["WorkspaceTypeID"];
					entity.VCStatusID = (System.Int32)reader[((int)METAViewDatedResponsibilityRetrievalColumn.VCStatusID)];
					//entity.VCStatusID = (Convert.IsDBNull(reader["VCStatusID"]))?(int)0:(System.Int32)reader["VCStatusID"];
					entity.Pkid = (System.Int32)reader[((int)METAViewDatedResponsibilityRetrievalColumn.Pkid)];
					//entity.Pkid = (Convert.IsDBNull(reader["pkid"]))?(int)0:(System.Int32)reader["pkid"];
					entity.Machine = (System.String)reader[((int)METAViewDatedResponsibilityRetrievalColumn.Machine)];
					//entity.Machine = (Convert.IsDBNull(reader["Machine"]))?string.Empty:(System.String)reader["Machine"];
					entity.VCMachineID = (reader.IsDBNull(((int)METAViewDatedResponsibilityRetrievalColumn.VCMachineID)))?null:(System.String)reader[((int)METAViewDatedResponsibilityRetrievalColumn.VCMachineID)];
	...
	#region METAViewDatedResponsibilityRetrievalSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class METAViewDatedResponsibilityRetrievalSortBuilder : SqlSortBuilder<METAViewDatedResponsibilityRetrievalColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the METAViewDatedResponsibilityRetrievalSqlSortBuilder class.
		/// </summary>
		public METAViewDatedResponsibilityRetrievalSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion METAViewDatedResponsibilityRetrievalSortBuilder
