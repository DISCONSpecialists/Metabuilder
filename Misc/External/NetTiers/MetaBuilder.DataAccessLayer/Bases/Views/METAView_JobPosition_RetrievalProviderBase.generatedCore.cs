		...
		protected VList<METAView_JobPosition_Retrieval> Fill(IDataReader reader, VList<METAView_JobPosition_Retrieval> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.Description = (reader.IsDBNull(((int)METAView_JobPosition_RetrievalColumn.Description)))?null:(System.String)reader[((int)METAView_JobPosition_RetrievalColumn.Description)];
					//entity.Description = (Convert.IsDBNull(reader["Description"]))?string.Empty:(System.String)reader["Description"];
					entity.Abbreviation = (reader.IsDBNull(((int)METAView_JobPosition_RetrievalColumn.Abbreviation)))?null:(System.String)reader[((int)METAView_JobPosition_RetrievalColumn.Abbreviation)];
					//entity.Abbreviation = (Convert.IsDBNull(reader["Abbreviation"]))?string.Empty:(System.String)reader["Abbreviation"];
					entity.IsBusinessExternal = (reader.IsDBNull(((int)METAView_JobPosition_RetrievalColumn.IsBusinessExternal)))?null:(System.String)reader[((int)METAView_JobPosition_RetrievalColumn.IsBusinessExternal)];
					...
					entity.StandardisationStatus = (reader.IsDBNull(((int)METAView_JobPosition_RetrievalColumn.StandardisationStatus)))?null:(System.String)reader[((int)METAView_JobPosition_RetrievalColumn.StandardisationStatus)];
					...
					entity.StandardisationStatusDate = (reader.IsDBNull(((int)METAView_JobPosition_RetrievalColumn.StandardisationStatusDate)))?null:(System.String)reader[((int)METAView_JobPosition_RetrievalColumn.StandardisationStatusDate)];
					...
					entity.DataSourceID = (reader.IsDBNull(((int)METAView_JobPosition_RetrievalColumn.DataSourceID)))?null:(System.String)reader[((int)METAView_JobPosition_RetrievalColumn.DataSourceID)];
					//entity.DataSourceID = (Convert.IsDBNull(reader["DataSourceID"]))?string.Empty:(System.String)reader["DataSourceID"];
					entity.DataSourceName = (reader.IsDBNull(((int)METAView_JobPosition_RetrievalColumn.DataSourceName)))?null:(System.String)reader[((int)METAView_JobPosition_RetrievalColumn.DataSourceName)];
					//entity.DataSourceName = (Convert.IsDBNull(reader["DataSourceName"]))?string.Empty:(System.String)reader["DataSourceName"];
					entity.GeneralRemarks = (reader.IsDBNull(((int)METAView_JobPosition_RetrievalColumn.GeneralRemarks)))?null:(System.String)reader[((int)METAView_JobPosition_RetrievalColumn.GeneralRemarks)];
