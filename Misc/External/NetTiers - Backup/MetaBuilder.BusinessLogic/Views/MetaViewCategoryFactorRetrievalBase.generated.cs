/*
	...
	Important: Do not modify this file. Edit the file METAViewCategoryFactorRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewCategoryFactorRetrievalBase")]
	public abstract partial class METAViewCategoryFactorRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewCategoryFactorRetrievalBase"/> instance.
		///</summary>
		public METAViewCategoryFactorRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewCategoryFactorRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewCategoryFactorRetrieval CreateMETAViewCategoryFactorRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewCategoryFactorRetrieval newMETAViewCategoryFactorRetrieval = new METAViewCategoryFactorRetrieval();
			newMETAViewCategoryFactorRetrieval.WorkspaceName = _workspaceName;
			newMETAViewCategoryFactorRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewCategoryFactorRetrieval.VCStatusID = _vCStatusID;
			newMETAViewCategoryFactorRetrieval.Pkid = _pkid;
			newMETAViewCategoryFactorRetrieval.Machine = _machine;
			newMETAViewCategoryFactorRetrieval.VCMachineID = _vCMachineID;
			newMETAViewCategoryFactorRetrieval.Name = _name;
			newMETAViewCategoryFactorRetrieval.CustomField1 = _customField1;
			newMETAViewCategoryFactorRetrieval.CustomField2 = _customField2;
			newMETAViewCategoryFactorRetrieval.CustomField3 = _customField3;
			newMETAViewCategoryFactorRetrieval.GapType = _gapType;
			return newMETAViewCategoryFactorRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewCategoryFactorRetrievalBase Entity 
		///</summary>
		public virtual METAViewCategoryFactorRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewCategoryFactorRetrieval copy = new METAViewCategoryFactorRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewCategoryFactorRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewCategoryFactorRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewCategoryFactorRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewCategoryFactorRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewCategoryFactorRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewCategoryFactorRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewCategoryFactorRetrievalBase Object1, METAViewCategoryFactorRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewCategoryFactorRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewCategoryFactorRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewCategoryFactorRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewCategoryFactorRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
