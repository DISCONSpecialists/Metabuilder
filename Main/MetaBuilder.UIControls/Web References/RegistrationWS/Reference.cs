...
namespace MetaBuilder.UIControls.RegistrationWS {
    using System;
    ...
    public partial class Service : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Service() {
            this.Url = "http://www.metabuilder.co.za/RegistrationWS/Service.asmx";
        ...
        public string GetLicense(string type, string name, string email, string company, string regkey, string Username, string UserdomainName, OpenLicense.SerializableDictionary<string, string> customValues) {
        ...
        /// <remarks/>
        public void GetLicenseAsync(string type, string name, string email, string company, string regkey, string Username, string UserdomainName, OpenLicense.SerializableDictionary<string, string> customValues) {
            this.GetLicenseAsync(type, name, email, company, regkey, Username, UserdomainName, customValues, null);
        }
        
        /// <remarks/>
        public void GetLicenseAsync(string type, string name, string email, string company, string regkey, string Username, string UserdomainName, OpenLicense.SerializableDictionary<string, string> customValues, object userState) {
            ...
            this.InvokeAsync("GetLicense", new object[] {
                        ...
                        Username,
                        UserdomainName,
                        customValues}, this.GetLicenseOperationCompleted, userState);
        }
