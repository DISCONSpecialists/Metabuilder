...
{	
		...
		protected VList<METAViewCADRealListing> Fill(IDataReader reader, VList<METAViewCADRealListing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.WorkspaceName = (System.String)reader[((int)METAViewCADRealListingColumn.WorkspaceName)];
					//entity.WorkspaceName = (Convert.IsDBNull(reader["WorkspaceName"]))?string.Empty:(System.String)reader["WorkspaceName"];
					entity.WorkspaceTypeID = (reader.IsDBNull(((int)METAViewCADRealListingColumn.WorkspaceTypeID)))?null:(System.Int32?)reader[((int)METAViewCADRealListingColumn.WorkspaceTypeID)];
					//entity.WorkspaceTypeID = (Convert.IsDBNull(reader["WorkspaceTypeID"]))?(int)0:(System.Int32?)reader["WorkspaceTypeID"];
					entity.VCStatusID = (System.Int32)reader[((int)METAViewCADRealListingColumn.VCStatusID)];
					//entity.VCStatusID = (Convert.IsDBNull(reader["VCStatusID"]))?(int)0:(System.Int32)reader["VCStatusID"];
					entity.Pkid = (System.Int32)reader[((int)METAViewCADRealListingColumn.Pkid)];
					//entity.Pkid = (Convert.IsDBNull(reader["pkid"]))?(int)0:(System.Int32)reader["pkid"];
					entity.Machine = (System.String)reader[((int)METAViewCADRealListingColumn.Machine)];
					//entity.Machine = (Convert.IsDBNull(reader["Machine"]))?string.Empty:(System.String)reader["Machine"];
					entity.VCMachineID = (reader.IsDBNull(((int)METAViewCADRealListingColumn.VCMachineID)))?null:(System.String)reader[((int)METAViewCADRealListingColumn.VCMachineID)];
	...
	#region METAViewCADRealListingSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class METAViewCADRealListingSortBuilder : SqlSortBuilder<METAViewCADRealListingColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the METAViewCADRealListingSqlSortBuilder class.
		/// </summary>
		public METAViewCADRealListingSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion METAViewCADRealListingSortBuilder
