/*
	...
	Important: Do not modify this file. Edit the file METAViewResponsibilityRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewResponsibilityRetrievalBase")]
	public abstract partial class METAViewResponsibilityRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewResponsibilityRetrievalBase"/> instance.
		///</summary>
		public METAViewResponsibilityRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewResponsibilityRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewResponsibilityRetrieval CreateMETAViewResponsibilityRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewResponsibilityRetrieval newMETAViewResponsibilityRetrieval = new METAViewResponsibilityRetrieval();
			newMETAViewResponsibilityRetrieval.WorkspaceName = _workspaceName;
			newMETAViewResponsibilityRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewResponsibilityRetrieval.VCStatusID = _vCStatusID;
			newMETAViewResponsibilityRetrieval.Pkid = _pkid;
			newMETAViewResponsibilityRetrieval.Machine = _machine;
			newMETAViewResponsibilityRetrieval.VCMachineID = _vCMachineID;
			newMETAViewResponsibilityRetrieval.Name = _name;
			newMETAViewResponsibilityRetrieval.CustomField1 = _customField1;
			newMETAViewResponsibilityRetrieval.CustomField2 = _customField2;
			newMETAViewResponsibilityRetrieval.CustomField3 = _customField3;
			newMETAViewResponsibilityRetrieval.GapType = _gapType;
			return newMETAViewResponsibilityRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewResponsibilityRetrievalBase Entity 
		///</summary>
		public virtual METAViewResponsibilityRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewResponsibilityRetrieval copy = new METAViewResponsibilityRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewResponsibilityRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewResponsibilityRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewResponsibilityRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewResponsibilityRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewResponsibilityRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewResponsibilityRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewResponsibilityRetrievalBase Object1, METAViewResponsibilityRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewResponsibilityRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewResponsibilityRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewResponsibilityRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewResponsibilityRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
