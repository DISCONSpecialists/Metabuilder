...
namespace MetaBuilder.Graphing.Tools
{
        ...
        public sealed class MySoapFormatter : IRemotingFormatter, IFormatter
        {
    ...
    TypeFilterLevel _filterLevel = TypeFilterLevel.Low;
            ...
            public MySoapFormatter()
            {
                _selector = null;
                _context = new StreamingContext(StreamingContextStates.All);
            }

            public MySoapFormatter(ISurrogateSelector selector, StreamingContext context)
            {
                _selector = selector;
                _context = context;
            }
