...
{	
		...
		protected VList<METAViewSoftwareListing> Fill(IDataReader reader, VList<METAViewSoftwareListing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.WorkspaceName = (System.String)reader[((int)METAViewSoftwareListingColumn.WorkspaceName)];
					//entity.WorkspaceName = (Convert.IsDBNull(reader["WorkspaceName"]))?string.Empty:(System.String)reader["WorkspaceName"];
					entity.WorkspaceTypeID = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.WorkspaceTypeID)))?null:(System.Int32?)reader[((int)METAViewSoftwareListingColumn.WorkspaceTypeID)];
					//entity.WorkspaceTypeID = (Convert.IsDBNull(reader["WorkspaceTypeID"]))?(int)0:(System.Int32?)reader["WorkspaceTypeID"];
					entity.VCStatusID = (System.Int32)reader[((int)METAViewSoftwareListingColumn.VCStatusID)];
					//entity.VCStatusID = (Convert.IsDBNull(reader["VCStatusID"]))?(int)0:(System.Int32)reader["VCStatusID"];
					entity.Pkid = (System.Int32)reader[((int)METAViewSoftwareListingColumn.Pkid)];
					//entity.Pkid = (Convert.IsDBNull(reader["pkid"]))?(int)0:(System.Int32)reader["pkid"];
					entity.Machine = (System.String)reader[((int)METAViewSoftwareListingColumn.Machine)];
					//entity.Machine = (Convert.IsDBNull(reader["Machine"]))?string.Empty:(System.String)reader["Machine"];
					entity.VCMachineID = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.VCMachineID)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.VCMachineID)];
					//entity.VCMachineID = (Convert.IsDBNull(reader["VCMachineID"]))?string.Empty:(System.String)reader["VCMachineID"];
					entity.Type = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.Type)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.Type)];
					//entity.Type = (Convert.IsDBNull(reader["Type"]))?string.Empty:(System.String)reader["Type"];
					entity.Name = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.Name)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.Name)];
					//entity.Name = (Convert.IsDBNull(reader["Name"]))?string.Empty:(System.String)reader["Name"];
					entity.Description = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.Description)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.Description)];
					//entity.Description = (Convert.IsDBNull(reader["Description"]))?string.Empty:(System.String)reader["Description"];
					entity.SeverityRating = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.SeverityRating)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.SeverityRating)];
					//entity.SeverityRating = (Convert.IsDBNull(reader["SeverityRating"]))?string.Empty:(System.String)reader["SeverityRating"];
					entity.Configuration = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.Configuration)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.Configuration)];
					//entity.Configuration = (Convert.IsDBNull(reader["Configuration"]))?string.Empty:(System.String)reader["Configuration"];
					entity.Copyright = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.Copyright)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.Copyright)];
					//entity.Copyright = (Convert.IsDBNull(reader["Copyright"]))?string.Empty:(System.String)reader["Copyright"];
					entity.Publisher = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.Publisher)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.Publisher)];
					//entity.Publisher = (Convert.IsDBNull(reader["Publisher"]))?string.Empty:(System.String)reader["Publisher"];
					entity.InternalName = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.InternalName)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.InternalName)];
					//entity.InternalName = (Convert.IsDBNull(reader["InternalName"]))?string.Empty:(System.String)reader["InternalName"];
					entity.Language = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.Language)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.Language)];
					//entity.Language = (Convert.IsDBNull(reader["Language"]))?string.Empty:(System.String)reader["Language"];
					entity.DateCreated = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.DateCreated)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.DateCreated)];
					//entity.DateCreated = (Convert.IsDBNull(reader["DateCreated"]))?string.Empty:(System.String)reader["DateCreated"];
					entity.IsDNS = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.IsDNS)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.IsDNS)];
					//entity.IsDNS = (Convert.IsDBNull(reader["isDNS"]))?string.Empty:(System.String)reader["isDNS"];
					entity.IsDHCP = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.IsDHCP)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.IsDHCP)];
					//entity.IsDHCP = (Convert.IsDBNull(reader["isDHCP"]))?string.Empty:(System.String)reader["isDHCP"];
					entity.IsLicensed = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.IsLicensed)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.IsLicensed)];
					//entity.IsLicensed = (Convert.IsDBNull(reader["isLicensed"]))?string.Empty:(System.String)reader["isLicensed"];
					entity.LicenseNumber = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.LicenseNumber)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.LicenseNumber)];
					//entity.LicenseNumber = (Convert.IsDBNull(reader["LicenseNumber"]))?string.Empty:(System.String)reader["LicenseNumber"];
					entity.DatePurchased = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.DatePurchased)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.DatePurchased)];
					//entity.DatePurchased = (Convert.IsDBNull(reader["DatePurchased"]))?string.Empty:(System.String)reader["DatePurchased"];
					entity.Version = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.Version)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.Version)];
					//entity.Version = (Convert.IsDBNull(reader["Version"]))?string.Empty:(System.String)reader["Version"];
					entity.ID = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.ID)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.ID)];
					//entity.ID = (Convert.IsDBNull(reader["ID"]))?string.Empty:(System.String)reader["ID"];
					entity.CustomField1 = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.CustomField1)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.CustomField1)];
					//entity.CustomField1 = (Convert.IsDBNull(reader["CustomField1"]))?string.Empty:(System.String)reader["CustomField1"];
					entity.CustomField2 = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.CustomField2)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.CustomField2)];
					//entity.CustomField2 = (Convert.IsDBNull(reader["CustomField2"]))?string.Empty:(System.String)reader["CustomField2"];
					entity.CustomField3 = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.CustomField3)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.CustomField3)];
					//entity.CustomField3 = (Convert.IsDBNull(reader["CustomField3"]))?string.Empty:(System.String)reader["CustomField3"];
					entity.UserInterface = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.UserInterface)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.UserInterface)];
					//entity.UserInterface = (Convert.IsDBNull(reader["UserInterface"]))?string.Empty:(System.String)reader["UserInterface"];
					entity.GapType = (reader.IsDBNull(((int)METAViewSoftwareListingColumn.GapType)))?null:(System.String)reader[((int)METAViewSoftwareListingColumn.GapType)];
	...
	#region METAViewSoftwareListingSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class METAViewSoftwareListingSortBuilder : SqlSortBuilder<METAViewSoftwareListingColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the METAViewSoftwareListingSqlSortBuilder class.
		/// </summary>
		public METAViewSoftwareListingSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion METAViewSoftwareListingSortBuilder
