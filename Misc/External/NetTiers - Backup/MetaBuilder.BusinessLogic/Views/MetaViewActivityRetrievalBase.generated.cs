/*
	...
	Important: Do not modify this file. Edit the file METAViewActivityRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewActivityRetrievalBase")]
	public abstract partial class METAViewActivityRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewActivityRetrievalBase"/> instance.
		///</summary>
		public METAViewActivityRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewActivityRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewActivityRetrieval CreateMETAViewActivityRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _executionIndicator, System.String _contextualIndicator, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewActivityRetrieval newMETAViewActivityRetrieval = new METAViewActivityRetrieval();
			newMETAViewActivityRetrieval.WorkspaceName = _workspaceName;
			newMETAViewActivityRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewActivityRetrieval.VCStatusID = _vCStatusID;
			newMETAViewActivityRetrieval.Pkid = _pkid;
			newMETAViewActivityRetrieval.Machine = _machine;
			newMETAViewActivityRetrieval.VCMachineID = _vCMachineID;
			newMETAViewActivityRetrieval.Name = _name;
			newMETAViewActivityRetrieval.ExecutionIndicator = _executionIndicator;
			newMETAViewActivityRetrieval.ContextualIndicator = _contextualIndicator;
			newMETAViewActivityRetrieval.CustomField1 = _customField1;
			newMETAViewActivityRetrieval.CustomField2 = _customField2;
			newMETAViewActivityRetrieval.CustomField3 = _customField3;
			newMETAViewActivityRetrieval.GapType = _gapType;
			return newMETAViewActivityRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewActivityRetrievalBase Entity 
		///</summary>
		public virtual METAViewActivityRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewActivityRetrieval copy = new METAViewActivityRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewActivityRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewActivityRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewActivityRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewActivityRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewActivityRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewActivityRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewActivityRetrievalBase Object1, METAViewActivityRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewActivityRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewActivityRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewActivityRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewActivityRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
