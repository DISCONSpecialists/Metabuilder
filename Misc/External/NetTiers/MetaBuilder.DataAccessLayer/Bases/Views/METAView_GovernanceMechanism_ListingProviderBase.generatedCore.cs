		...
		protected VList<METAView_GovernanceMechanism_Listing> Fill(IDataReader reader, VList<METAView_GovernanceMechanism_Listing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.Name = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.Name)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.Name)];
					//entity.Name = (Convert.IsDBNull(reader["Name"]))?string.Empty:(System.String)reader["Name"];
					entity.Abbreviation = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.Abbreviation)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.Abbreviation)];
					//entity.Abbreviation = (Convert.IsDBNull(reader["Abbreviation"]))?string.Empty:(System.String)reader["Abbreviation"];
					entity.IsBusinessExternal = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.IsBusinessExternal)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.IsBusinessExternal)];
					...
					entity.DataSourceID = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.DataSourceID)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.DataSourceID)];
					//entity.DataSourceID = (Convert.IsDBNull(reader["DataSourceID"]))?string.Empty:(System.String)reader["DataSourceID"];
					entity.DataSourceName = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.DataSourceName)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.DataSourceName)];
					//entity.DataSourceName = (Convert.IsDBNull(reader["DataSourceName"]))?string.Empty:(System.String)reader["DataSourceName"];
					entity.GeneralRemarks = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.GeneralRemarks)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.GeneralRemarks)];
					//entity.GeneralRemarks = (Convert.IsDBNull(reader["GeneralRemarks"]))?string.Empty:(System.String)reader["GeneralRemarks"];
					entity.ArchitectureStatus = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.ArchitectureStatus)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.ArchitectureStatus)];
					...
					entity.ArchitectureStatusDate = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.ArchitectureStatusDate)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.ArchitectureStatusDate)];
					...
					entity.DesignRationale = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.DesignRationale)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.DesignRationale)];
					//entity.DesignRationale = (Convert.IsDBNull(reader["DesignRationale"]))?string.Empty:(System.String)reader["DesignRationale"];
					entity.GovernanceMechanismType = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.GovernanceMechanismType)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.GovernanceMechanismType)];
					...
					entity.EffectiveStartDate = (reader.IsDBNull(((int)METAView_GovernanceMechanism_ListingColumn.EffectiveStartDate)))?null:(System.String)reader[((int)METAView_GovernanceMechanism_ListingColumn.EffectiveStartDate)];
