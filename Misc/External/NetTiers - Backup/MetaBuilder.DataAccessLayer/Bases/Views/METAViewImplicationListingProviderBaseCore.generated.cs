		...
		protected VList<METAViewImplicationListing> Fill(IDataReader reader, VList<METAViewImplicationListing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.ExtInfIndicator = (reader.IsDBNull(reader.GetOrdinal("Ext_Inf_Indicator")))?null:(System.Int32?)reader["Ext_Inf_Indicator"];
					//entity.ExtInfIndicator = (Convert.IsDBNull(reader["Ext_Inf_Indicator"]))?(int)0:(System.Int32?)reader["Ext_Inf_Indicator"];
					entity.IntCapabilityIndicator = (reader.IsDBNull(reader.GetOrdinal("Int_Capability_Indicator")))?null:(System.Int32?)reader["Int_Capability_Indicator"];
