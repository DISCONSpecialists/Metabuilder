/*
	...
	Important: Do not modify this file. Edit the file METAViewAttributeListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewAttributeListingBase")]
	public abstract partial class METAViewAttributeListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewAttributeListingBase"/> instance.
		///</summary>
		public METAViewAttributeListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewAttributeListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_length"></param>
		///<param name="_gapType"></param>
		public static METAViewAttributeListing CreateMETAViewAttributeListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _customField1, System.String _customField2, System.String _customField3, System.String _domainType, System.String _domainDef, System.Int32? _length, System.String _gapType)
		{
			METAViewAttributeListing newMETAViewAttributeListing = new METAViewAttributeListing();
			newMETAViewAttributeListing.WorkspaceName = _workspaceName;
			newMETAViewAttributeListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewAttributeListing.VCStatusID = _vCStatusID;
			newMETAViewAttributeListing.Pkid = _pkid;
			newMETAViewAttributeListing.Machine = _machine;
			newMETAViewAttributeListing.VCMachineID = _vCMachineID;
			newMETAViewAttributeListing.Name = _name;
			newMETAViewAttributeListing.CustomField1 = _customField1;
			newMETAViewAttributeListing.CustomField2 = _customField2;
			newMETAViewAttributeListing.CustomField3 = _customField3;
			newMETAViewAttributeListing.DomainType = _domainType;
			newMETAViewAttributeListing.DomainDef = _domainDef;
			newMETAViewAttributeListing.Length = _length;
			newMETAViewAttributeListing.GapType = _gapType;
			return newMETAViewAttributeListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewAttributeListingBase Entity 
		///</summary>
		public virtual METAViewAttributeListingBase Copy()
		{
			//shallow copy entity
			METAViewAttributeListing copy = new METAViewAttributeListing();
			...
			copy.AcceptChanges();
			return (METAViewAttributeListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewAttributeListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewAttributeListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewAttributeListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewAttributeListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewAttributeListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewAttributeListingBase Object1, METAViewAttributeListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewAttributeListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewAttributeListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewAttributeListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewAttributeListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
