		...
		protected VList<METAView_CategoryFactor_Listing> Fill(IDataReader reader, VList<METAView_CategoryFactor_Listing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.Description = (reader.IsDBNull(((int)METAView_CategoryFactor_ListingColumn.Description)))?null:(System.String)reader[((int)METAView_CategoryFactor_ListingColumn.Description)];
					//entity.Description = (Convert.IsDBNull(reader["Description"]))?string.Empty:(System.String)reader["Description"];
					entity.Abbreviation = (reader.IsDBNull(((int)METAView_CategoryFactor_ListingColumn.Abbreviation)))?null:(System.String)reader[((int)METAView_CategoryFactor_ListingColumn.Abbreviation)];
					//entity.Abbreviation = (Convert.IsDBNull(reader["Abbreviation"]))?string.Empty:(System.String)reader["Abbreviation"];
					entity.IsBusinessExternal = (reader.IsDBNull(((int)METAView_CategoryFactor_ListingColumn.IsBusinessExternal)))?null:(System.String)reader[((int)METAView_CategoryFactor_ListingColumn.IsBusinessExternal)];
					...
					entity.DataSourceID = (reader.IsDBNull(((int)METAView_CategoryFactor_ListingColumn.DataSourceID)))?null:(System.String)reader[((int)METAView_CategoryFactor_ListingColumn.DataSourceID)];
					//entity.DataSourceID = (Convert.IsDBNull(reader["DataSourceID"]))?string.Empty:(System.String)reader["DataSourceID"];
					entity.DataSourceName = (reader.IsDBNull(((int)METAView_CategoryFactor_ListingColumn.DataSourceName)))?null:(System.String)reader[((int)METAView_CategoryFactor_ListingColumn.DataSourceName)];
					//entity.DataSourceName = (Convert.IsDBNull(reader["DataSourceName"]))?string.Empty:(System.String)reader["DataSourceName"];
					entity.GeneralRemarks = (reader.IsDBNull(((int)METAView_CategoryFactor_ListingColumn.GeneralRemarks)))?null:(System.String)reader[((int)METAView_CategoryFactor_ListingColumn.GeneralRemarks)];
