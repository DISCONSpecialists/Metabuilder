/*
	...
	Important: Do not modify this file. Edit the file METAViewDatedResponsibilityRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewDatedResponsibilityRetrievalBase")]
	public abstract partial class METAViewDatedResponsibilityRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewDatedResponsibilityRetrievalBase"/> instance.
		///</summary>
		public METAViewDatedResponsibilityRetrievalBase()
		{
		}		
		...
		public METAViewDatedResponsibilityRetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewDatedResponsibilityRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAViewDatedResponsibilityRetrieval CreateMETAViewDatedResponsibilityRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAViewDatedResponsibilityRetrieval newMETAViewDatedResponsibilityRetrieval = new METAViewDatedResponsibilityRetrieval();
			newMETAViewDatedResponsibilityRetrieval.WorkspaceName = _workspaceName;
			newMETAViewDatedResponsibilityRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewDatedResponsibilityRetrieval.VCStatusID = _vCStatusID;
			newMETAViewDatedResponsibilityRetrieval.Pkid = _pkid;
			newMETAViewDatedResponsibilityRetrieval.Machine = _machine;
			newMETAViewDatedResponsibilityRetrieval.VCMachineID = _vCMachineID;
			return newMETAViewDatedResponsibilityRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewDatedResponsibilityRetrievalBase Entity 
		///</summary>
		public virtual METAViewDatedResponsibilityRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewDatedResponsibilityRetrieval copy = new METAViewDatedResponsibilityRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewDatedResponsibilityRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewDatedResponsibilityRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewDatedResponsibilityRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewDatedResponsibilityRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewDatedResponsibilityRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewDatedResponsibilityRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewDatedResponsibilityRetrievalBase Object1, METAViewDatedResponsibilityRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewDatedResponsibilityRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewDatedResponsibilityRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewDatedResponsibilityRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewDatedResponsibilityRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
