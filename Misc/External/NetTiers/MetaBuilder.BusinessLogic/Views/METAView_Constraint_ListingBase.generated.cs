/*
	...
	Important: Do not modify this file. Edit the file METAView_Constraint_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_Constraint_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Constraint_ListingBase")]
	public abstract partial class METAView_Constraint_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Constraint_ListingBase"/> instance.
		///</summary>
		public METAView_Constraint_ListingBase()
		{
		}		
		...
		public METAView_Constraint_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Constraint_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_vCMachineID"></param>
		///<param name="_name"></param>
		public static METAView_Constraint_Listing CreateMETAView_Constraint_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
			METAView_Constraint_Listing newMETAView_Constraint_Listing = new METAView_Constraint_Listing();
			newMETAView_Constraint_Listing.WorkspaceName = _workspaceName;
			newMETAView_Constraint_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_Constraint_Listing.VCStatusID = _vCStatusID;
			newMETAView_Constraint_Listing.pkid = _pkid;
			newMETAView_Constraint_Listing.Machine = _machine;
			newMETAView_Constraint_Listing.VCMachineID = _vCMachineID;
			newMETAView_Constraint_Listing.Name = _name;
			return newMETAView_Constraint_Listing;
		}
		...
		{
			get { return "METAView_Constraint_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_Constraint_ListingBase Entity 
		///</summary>
		public virtual METAView_Constraint_ListingBase Copy()
		{
			//shallow copy entity
			METAView_Constraint_Listing copy = new METAView_Constraint_Listing();
				...
				copy.Name = this.Name;
			copy.AcceptChanges();
			return (METAView_Constraint_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Constraint_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Constraint_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Constraint_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Constraint_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Constraint_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Constraint_ListingBase Object1, METAView_Constraint_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Constraint_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_Constraint_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_Constraint_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_Constraint_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
