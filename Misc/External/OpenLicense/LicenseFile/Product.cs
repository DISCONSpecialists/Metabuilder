        ...
        public Assembly Assembly
        {
            ...
            set
            {
                ...
                if (this.FilePath == String.Empty)
                    //GAH - this line results in the derived FilePath being different from the FilePAth read from file
                    // which causes the ValidationKey to differ, so the licence is rejected
