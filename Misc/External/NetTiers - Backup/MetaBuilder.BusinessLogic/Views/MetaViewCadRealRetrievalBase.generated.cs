/*
	...
	Important: Do not modify this file. Edit the file METAViewCADRealRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewCADRealRetrievalBase")]
	public abstract partial class METAViewCADRealRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewCADRealRetrievalBase"/> instance.
		///</summary>
		public METAViewCADRealRetrievalBase()
		{
		}		
		...
		public METAViewCADRealRetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewCADRealRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAViewCADRealRetrieval CreateMETAViewCADRealRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAViewCADRealRetrieval newMETAViewCADRealRetrieval = new METAViewCADRealRetrieval();
			newMETAViewCADRealRetrieval.WorkspaceName = _workspaceName;
			newMETAViewCADRealRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewCADRealRetrieval.VCStatusID = _vCStatusID;
			newMETAViewCADRealRetrieval.Pkid = _pkid;
			newMETAViewCADRealRetrieval.Machine = _machine;
			newMETAViewCADRealRetrieval.VCMachineID = _vCMachineID;
			return newMETAViewCADRealRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewCADRealRetrievalBase Entity 
		///</summary>
		public virtual METAViewCADRealRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewCADRealRetrieval copy = new METAViewCADRealRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewCADRealRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewCADRealRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewCADRealRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewCADRealRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewCADRealRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewCADRealRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewCADRealRetrievalBase Object1, METAViewCADRealRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewCADRealRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewCADRealRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewCADRealRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewCADRealRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
