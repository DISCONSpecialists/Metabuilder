/*
	...
	Important: Do not modify this file. Edit the file METAView_ModelReal_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ModelReal_ListingBase")]
	public abstract partial class METAView_ModelReal_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ModelReal_ListingBase"/> instance.
		///</summary>
		public METAView_ModelReal_ListingBase()
		{
		}		
		...
		public METAView_ModelReal_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ModelReal_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_ModelReal_Listing CreateMETAView_ModelReal_Listing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_ModelReal_Listing newMETAView_ModelReal_Listing = new METAView_ModelReal_Listing();
			newMETAView_ModelReal_Listing.WorkspaceName = _workspaceName;
			newMETAView_ModelReal_Listing.WorkspaceTypeID = _workspaceTypeID;
			newMETAView_ModelReal_Listing.VCStatusID = _vCStatusID;
			newMETAView_ModelReal_Listing.pkid = _pkid;
			newMETAView_ModelReal_Listing.Machine = _machine;
			newMETAView_ModelReal_Listing.VCMachineID = _vCMachineID;
			return newMETAView_ModelReal_Listing;
		}
		...
		{
			get { return "METAView_ModelReal_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_ModelReal_ListingBase Entity 
		///</summary>
		public virtual METAView_ModelReal_ListingBase Copy()
		{
			//shallow copy entity
			METAView_ModelReal_Listing copy = new METAView_ModelReal_Listing();
			...
			copy.AcceptChanges();
			return (METAView_ModelReal_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ModelReal_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ModelReal_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ModelReal_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ModelReal_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ModelReal_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ModelReal_ListingBase Object1, METAView_ModelReal_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ModelReal_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ModelReal_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_ModelReal_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_ModelReal_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
