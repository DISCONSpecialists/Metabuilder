/*
	...
	Important: Do not modify this file. Edit the file METAViewTimeSchemeRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewTimeSchemeRetrievalBase")]
	public abstract partial class METAViewTimeSchemeRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewTimeSchemeRetrievalBase"/> instance.
		///</summary>
		public METAViewTimeSchemeRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewTimeSchemeRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField2"></param>
		///<param name="_customField3"></param>
		public static METAViewTimeSchemeRetrieval CreateMETAViewTimeSchemeRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _gapType, System.String _customField1, System.String _customField2, System.String _customField3)
		{
			METAViewTimeSchemeRetrieval newMETAViewTimeSchemeRetrieval = new METAViewTimeSchemeRetrieval();
			newMETAViewTimeSchemeRetrieval.WorkspaceName = _workspaceName;
			newMETAViewTimeSchemeRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewTimeSchemeRetrieval.VCStatusID = _vCStatusID;
			newMETAViewTimeSchemeRetrieval.Pkid = _pkid;
			newMETAViewTimeSchemeRetrieval.Machine = _machine;
			newMETAViewTimeSchemeRetrieval.VCMachineID = _vCMachineID;
			newMETAViewTimeSchemeRetrieval.Name = _name;
			newMETAViewTimeSchemeRetrieval.GapType = _gapType;
			newMETAViewTimeSchemeRetrieval.CustomField1 = _customField1;
			newMETAViewTimeSchemeRetrieval.CustomField2 = _customField2;
			newMETAViewTimeSchemeRetrieval.CustomField3 = _customField3;
			return newMETAViewTimeSchemeRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewTimeSchemeRetrievalBase Entity 
		///</summary>
		public virtual METAViewTimeSchemeRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewTimeSchemeRetrieval copy = new METAViewTimeSchemeRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewTimeSchemeRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewTimeSchemeRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewTimeSchemeRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewTimeSchemeRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewTimeSchemeRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewTimeSchemeRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewTimeSchemeRetrievalBase Object1, METAViewTimeSchemeRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewTimeSchemeRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewTimeSchemeRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewTimeSchemeRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewTimeSchemeRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
