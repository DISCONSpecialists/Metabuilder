/*
	...
	Important: Do not modify this file. Edit the file METAView_SubsetIndicator_Retrieval.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_SubsetIndicator_Retrieval' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_SubsetIndicator_RetrievalBase")]
	public abstract partial class METAView_SubsetIndicator_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// SubsetIndicatorType : 
		/// </summary>
		private System.String		  _subsetIndicatorType = null;
		
		/// <summary>
		/// IsCompleteSet : 
		/// </summary>
		private System.String		  _isCompleteSet = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_SubsetIndicator_RetrievalBase"/> instance.
		///</summary>
		public METAView_SubsetIndicator_RetrievalBase()
		{
		}		
		...
		///<param name="_subsetIndicatorType"></param>
		///<param name="_isCompleteSet"></param>
		public METAView_SubsetIndicator_RetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _abbreviation, System.String _description, System.String _isBusinessExternal, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _subsetIndicatorType, System.String _isCompleteSet)
		{
			...
			this._subsetIndicatorType = _subsetIndicatorType;
			this._isCompleteSet = _isCompleteSet;
		}
		
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_SubsetIndicator_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_subsetIndicatorType"></param>
		///<param name="_isCompleteSet"></param>
		public static METAView_SubsetIndicator_Retrieval CreateMETAView_SubsetIndicator_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _abbreviation, System.String _description, System.String _isBusinessExternal, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _subsetIndicatorType, System.String _isCompleteSet)
		{
			METAView_SubsetIndicator_Retrieval newMETAView_SubsetIndicator_Retrieval = new METAView_SubsetIndicator_Retrieval();
			newMETAView_SubsetIndicator_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_SubsetIndicator_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_SubsetIndicator_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_SubsetIndicator_Retrieval.pkid = _pkid;
			newMETAView_SubsetIndicator_Retrieval.Machine = _machine;
			newMETAView_SubsetIndicator_Retrieval.VCMachineID = _vCMachineID;
			newMETAView_SubsetIndicator_Retrieval.Name = _name;
			newMETAView_SubsetIndicator_Retrieval.Abbreviation = _abbreviation;
			newMETAView_SubsetIndicator_Retrieval.Description = _description;
			newMETAView_SubsetIndicator_Retrieval.IsBusinessExternal = _isBusinessExternal;
			newMETAView_SubsetIndicator_Retrieval.ArchitectureStatus = _architectureStatus;
			newMETAView_SubsetIndicator_Retrieval.ArchitectureStatusDate = _architectureStatusDate;
			newMETAView_SubsetIndicator_Retrieval.DesignRationale = _designRationale;
			newMETAView_SubsetIndicator_Retrieval.GeneralRemarks = _generalRemarks;
			newMETAView_SubsetIndicator_Retrieval.GapType = _gapType;
			newMETAView_SubsetIndicator_Retrieval.DataSourceID = _dataSourceID;
			newMETAView_SubsetIndicator_Retrieval.DataSourceName = _dataSourceName;
			newMETAView_SubsetIndicator_Retrieval.SubsetIndicatorType = _subsetIndicatorType;
			newMETAView_SubsetIndicator_Retrieval.IsCompleteSet = _isCompleteSet;
			return newMETAView_SubsetIndicator_Retrieval;
		}
		...
		/// <summary>
		/// 	Gets or Sets the SubsetIndicatorType property. 
		///		
		/// </summary>
		/// <value>This type is varchar</value>
		/// <remarks>
		...
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.String SubsetIndicatorType
		{
			get
			{
				return this._subsetIndicatorType; 
			}
			set
			{
				if (_subsetIndicatorType == value)
					return;
					
				this._subsetIndicatorType = value;
				this._isDirty = true;
				
				OnPropertyChanged("SubsetIndicatorType");
			}
		}
		
		/// <summary>
		/// 	Gets or Sets the IsCompleteSet property. 
		///		
		/// </summary>
		/// <value>This type is varchar</value>
		/// <remarks>
		...
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.String IsCompleteSet
		{
			get
			{
				return this._isCompleteSet; 
			}
			set
			{
				if (_isCompleteSet == value)
					return;
					
				this._isCompleteSet = value;
				this._isDirty = true;
				
				OnPropertyChanged("IsCompleteSet");
			}
		}
		...
		{
			get { return "METAView_SubsetIndicator_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_SubsetIndicator_RetrievalBase Entity 
		///</summary>
		public virtual METAView_SubsetIndicator_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_SubsetIndicator_Retrieval copy = new METAView_SubsetIndicator_Retrieval();
				...
				copy.SubsetIndicatorType = this.SubsetIndicatorType;
				copy.IsCompleteSet = this.IsCompleteSet;
			copy.AcceptChanges();
			return (METAView_SubsetIndicator_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_SubsetIndicator_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_SubsetIndicator_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_SubsetIndicator_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_SubsetIndicator_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_SubsetIndicator_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_SubsetIndicator_RetrievalBase Object1, METAView_SubsetIndicator_RetrievalBase Object2)
		{
			// both are null
			...
			if (Object1.SubsetIndicatorType != null && Object2.SubsetIndicatorType != null )
			{
				if (Object1.SubsetIndicatorType != Object2.SubsetIndicatorType)
					equal = false;
			}
			else if (Object1.SubsetIndicatorType == null ^ Object1.SubsetIndicatorType == null )
			{
				equal = false;
			}
			if (Object1.IsCompleteSet != null && Object2.IsCompleteSet != null )
			{
				if (Object1.IsCompleteSet != Object2.IsCompleteSet)
					equal = false;
			}
			else if (Object1.IsCompleteSet == null ^ Object1.IsCompleteSet == null )
			{
				equal = false;
			}
			return equal;
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_SubsetIndicator_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
				...
				case "SubsetIndicatorType":
					return entity.SubsetIndicatorType;
				case "IsCompleteSet":
					return entity.IsCompleteSet;
			}
			return null;
		}
		...
		{			
			return GetPropertyValueByName(this as METAView_SubsetIndicator_Retrieval, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				...
				(this.SubsetIndicatorType == null) ? string.Empty : this.SubsetIndicatorType.ToString(),
			     
				(this.IsCompleteSet == null) ? string.Empty : this.IsCompleteSet.ToString(),
	...
	/// <summary>
	/// Enumerate the METAView_SubsetIndicator_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_SubsetIndicator_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
		...
		/// SubsetIndicatorType : 
		/// </summary>
		[EnumTextValue("SubsetIndicatorType")]
		[ColumnEnum("SubsetIndicatorType", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 255)]
		SubsetIndicatorType,
		/// <summary>
		/// IsCompleteSet : 
		/// </summary>
		[EnumTextValue("IsCompleteSet")]
		[ColumnEnum("IsCompleteSet", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 255)]
		IsCompleteSet
	}//End enum
