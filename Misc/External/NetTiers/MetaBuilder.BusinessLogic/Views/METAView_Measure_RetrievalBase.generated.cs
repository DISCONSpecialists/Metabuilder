/*
	...
	Important: Do not modify this file. Edit the file METAView_Measure_Retrieval.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_Measure_Retrieval' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Measure_RetrievalBase")]
	public abstract partial class METAView_Measure_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// MeasureType : 
		/// </summary>
		private System.String		  _measureType = null;
		
		/// <summary>
		/// MeasureCategory : 
		/// </summary>
		private System.String		  _measureCategory = null;
		
		/// <summary>
		/// UnitOfMeasure : 
		/// </summary>
		private System.String		  _unitOfMeasure = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Measure_RetrievalBase"/> instance.
		///</summary>
		public METAView_Measure_RetrievalBase()
		{
		}		
		...
		///<param name="_measureCategory"></param>
		...
		public METAView_Measure_RetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _measureType, System.String _measureCategory, System.String _unitOfMeasure, System.String _name, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _standardisationStatus, System.String _standardisationStatusDate, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _architectureStatus, System.String _architectureStatusDate)
		{
			...
			this._measureCategory = _measureCategory;
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Measure_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_architectureStatus"></param>
		///<param name="_architectureStatusDate"></param>
		public static METAView_Measure_Retrieval CreateMETAView_Measure_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _measureType, System.String _measureCategory, System.String _unitOfMeasure, System.String _name, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _standardisationStatus, System.String _standardisationStatusDate, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _architectureStatus, System.String _architectureStatusDate)
		{
			METAView_Measure_Retrieval newMETAView_Measure_Retrieval = new METAView_Measure_Retrieval();
			newMETAView_Measure_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_Measure_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_Measure_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_Measure_Retrieval.pkid = _pkid;
			newMETAView_Measure_Retrieval.Machine = _machine;
			newMETAView_Measure_Retrieval.VCMachineID = _vCMachineID;
			newMETAView_Measure_Retrieval.MeasureType = _measureType;
			newMETAView_Measure_Retrieval.MeasureCategory = _measureCategory;
			newMETAView_Measure_Retrieval.UnitOfMeasure = _unitOfMeasure;
			newMETAView_Measure_Retrieval.Name = _name;
			newMETAView_Measure_Retrieval.Description = _description;
			newMETAView_Measure_Retrieval.Abbreviation = _abbreviation;
			newMETAView_Measure_Retrieval.IsBusinessExternal = _isBusinessExternal;
			newMETAView_Measure_Retrieval.StandardisationStatus = _standardisationStatus;
			newMETAView_Measure_Retrieval.StandardisationStatusDate = _standardisationStatusDate;
			newMETAView_Measure_Retrieval.DesignRationale = _designRationale;
			newMETAView_Measure_Retrieval.GeneralRemarks = _generalRemarks;
			newMETAView_Measure_Retrieval.GapType = _gapType;
			newMETAView_Measure_Retrieval.DataSourceID = _dataSourceID;
			newMETAView_Measure_Retrieval.DataSourceName = _dataSourceName;
			newMETAView_Measure_Retrieval.ArchitectureStatus = _architectureStatus;
			newMETAView_Measure_Retrieval.ArchitectureStatusDate = _architectureStatusDate;
			return newMETAView_Measure_Retrieval;
		}
		...
		/// <summary>
		/// 	Gets or Sets the MeasureType property. 
		///		
		/// </summary>
		/// <value>This type is varchar</value>
		/// <remarks>
		...
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.String MeasureType
		{
			get
			{
		...
		/// <summary>
		/// 	Gets or Sets the MeasureCategory property. 
		///		
		/// </summary>
		/// <value>This type is varchar</value>
		/// <remarks>
		...
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.String MeasureCategory
		{
			get
			{
				return this._measureCategory; 
			}
			set
			{
				if (_measureCategory == value)
					return;
					
				this._measureCategory = value;
				this._isDirty = true;
		...
		{
			get { return "METAView_Measure_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_Measure_RetrievalBase Entity 
		///</summary>
		public virtual METAView_Measure_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_Measure_Retrieval copy = new METAView_Measure_Retrieval();
				...
				copy.MeasureType = this.MeasureType;
				copy.MeasureCategory = this.MeasureCategory;
			...
			copy.AcceptChanges();
			return (METAView_Measure_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Measure_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Measure_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Measure_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Measure_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Measure_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Measure_RetrievalBase Object1, METAView_Measure_RetrievalBase Object2)
		{
			// both are null
			...
			if (Object1.MeasureType != null && Object2.MeasureType != null )
			{
				if (Object1.MeasureType != Object2.MeasureType)
					equal = false;
			}
			else if (Object1.MeasureType == null ^ Object1.MeasureType == null )
			{
				equal = false;
			}
			if (Object1.MeasureCategory != null && Object2.MeasureCategory != null )
			{
				if (Object1.MeasureCategory != Object2.MeasureCategory)
					equal = false;
			}
			else if (Object1.MeasureCategory == null ^ Object1.MeasureCategory == null )
			{
				equal = false;
			}
			if (Object1.UnitOfMeasure != null && Object2.UnitOfMeasure != null )
			{
				if (Object1.UnitOfMeasure != Object2.UnitOfMeasure)
					equal = false;
			}
			else if (Object1.UnitOfMeasure == null ^ Object1.UnitOfMeasure == null )
			{
				equal = false;
			}
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Measure_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
				...
				case "MeasureType":
					return entity.MeasureType;
				case "MeasureCategory":
					return entity.MeasureCategory;
				case "UnitOfMeasure":
		...
		{			
			return GetPropertyValueByName(this as METAView_Measure_Retrieval, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{23}{22}- WorkspaceName: {0}{22}- WorkspaceTypeId: {1}{22}- VCStatusID: {2}{22}- pkid: {3}{22}- Machine: {4}{22}- VCMachineID: {5}{22}- MeasureType: {6}{22}- MeasureCategory: {7}{22}- UnitOfMeasure: {8}{22}- Name: {9}{22}- Description: {10}{22}- Abbreviation: {11}{22}- IsBusinessExternal: {12}{22}- StandardisationStatus: {13}{22}- StandardisationStatusDate: {14}{22}- DesignRationale: {15}{22}- GeneralRemarks: {16}{22}- GapType: {17}{22}- DataSourceID: {18}{22}- DataSourceName: {19}{22}- ArchitectureStatus: {20}{22}- ArchitectureStatusDate: {21}{22}", 
				this.WorkspaceName,
				...
				(this.MeasureType == null) ? string.Empty : this.MeasureType.ToString(),
			     
				(this.MeasureCategory == null) ? string.Empty : this.MeasureCategory.ToString(),
			     
				(this.UnitOfMeasure == null) ? string.Empty : this.UnitOfMeasure.ToString(),
	...
	/// <summary>
	/// Enumerate the METAView_Measure_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_Measure_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
		...
		/// MeasureType : 
		/// </summary>
		[EnumTextValue("MeasureType")]
		[ColumnEnum("MeasureType", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 255)]
		MeasureType,
		/// <summary>
		/// MeasureCategory : 
		/// </summary>
		[EnumTextValue("MeasureCategory")]
		[ColumnEnum("MeasureCategory", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 255)]
		MeasureCategory,
		/// <summary>
		/// UnitOfMeasure : 
		/// </summary>
		[EnumTextValue("UnitOfMeasure")]
		[ColumnEnum("UnitOfMeasure", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 255)]
		UnitOfMeasure,
		/// <summary>
		/// Name : 
		/// </summary>
