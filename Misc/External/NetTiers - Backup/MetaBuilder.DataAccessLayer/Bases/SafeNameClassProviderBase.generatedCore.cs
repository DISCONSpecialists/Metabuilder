...
{	
	///<summary>
	/// This class is the base class for any <see cref="SafeNameClassProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class SafeNameClassProviderBaseCore : EntityProviderBase<MetaBuilder.BusinessLogic.SafeNameClass, MetaBuilder.BusinessLogic.SafeNameClassKey>
	{		
		...
		/// <returns>Returns a typed collection of SafeNameClass objects.</returns>
		public TList<SafeNameClass> GetByCAidFromAllowedArtifact(System.Int32 _cAid)
		{
			int count = -1;
		...
		/// <summary>
		///		Gets MetaBuilder.BusinessLogic.SafeNameClass objects from the datasource by CAid in the
		///		AllowedArtifact table. Table Class is related to table ClassAssociation
		///		through the (M:N) relationship defined in the AllowedArtifact table.
		/// </summary>
		...
		/// <param name="_cAid"></param>
		/// <remarks></remarks>
		/// <returns>Returns a TList of SafeNameClass objects.</returns>
		public TList<SafeNameClass> GetByCAidFromAllowedArtifact(System.Int32 _cAid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		///		Gets SafeNameClass objects from the datasource by CAid in the
		///		AllowedArtifact table. Table Class is related to table ClassAssociation
		///		through the (M:N) relationship defined in the AllowedArtifact table.
		/// </summary>
		...
		public TList<SafeNameClass> GetByCAidFromAllowedArtifact(TransactionManager transactionManager, System.Int32 _cAid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Class objects.</returns>
		public TList<SafeNameClass> GetByCAidFromAllowedArtifact(TransactionManager transactionManager, System.Int32 _cAid,int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Class objects.</returns>
		public TList<SafeNameClass> GetByCAidFromAllowedArtifact(System.Int32 _cAid,int start, int pageLength, out int count)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a TList of SafeNameClass objects.</returns>
		public abstract TList<SafeNameClass> GetByCAidFromAllowedArtifact(TransactionManager transactionManager,System.Int32 _cAid, int start, int pageLength, out int count);
		...
		public override bool Delete(TransactionManager transactionManager, MetaBuilder.BusinessLogic.SafeNameClassKey key)
		{
		...
		/// <returns>Returns a typed collection of MetaBuilder.BusinessLogic.SafeNameClass objects.</returns>
		public TList<SafeNameClass> GetByClassType(System.String _classType)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MetaBuilder.BusinessLogic.SafeNameClass objects.</returns>
		/// <remarks></remarks>
		public TList<SafeNameClass> GetByClassType(TransactionManager transactionManager, System.String _classType)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MetaBuilder.BusinessLogic.SafeNameClass objects.</returns>
		public TList<SafeNameClass> GetByClassType(TransactionManager transactionManager, System.String _classType, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MetaBuilder.BusinessLogic.SafeNameClass objects.</returns>
		public TList<SafeNameClass> GetByClassType(System.String _classType, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MetaBuilder.BusinessLogic.SafeNameClass objects.</returns>
		public TList<SafeNameClass> GetByClassType(System.String _classType, int start, int pageLength,out int count)
		{
			return GetByClassType(null, _classType, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MetaBuilder.BusinessLogic.SafeNameClass objects.</returns>
		public abstract TList<SafeNameClass> GetByClassType(TransactionManager transactionManager, System.String _classType, int start, int pageLength, out int count);
		...
		public override MetaBuilder.BusinessLogic.SafeNameClass Get(TransactionManager transactionManager, MetaBuilder.BusinessLogic.SafeNameClassKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> class.</returns>
		public MetaBuilder.BusinessLogic.SafeNameClass GetByName(System.String _name)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> class.</returns>
		public MetaBuilder.BusinessLogic.SafeNameClass GetByName(System.String _name, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> class.</returns>
		public MetaBuilder.BusinessLogic.SafeNameClass GetByName(TransactionManager transactionManager, System.String _name)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> class.</returns>
		public MetaBuilder.BusinessLogic.SafeNameClass GetByName(TransactionManager transactionManager, System.String _name, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> class.</returns>
		public MetaBuilder.BusinessLogic.SafeNameClass GetByName(System.String _name, int start, int pageLength, out int count)
		{
			return GetByName(null, _name, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> class.</returns>
		public abstract MetaBuilder.BusinessLogic.SafeNameClass GetByName(TransactionManager transactionManager, System.String _name, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;SafeNameClass&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;SafeNameClass&gt;"/></returns>
		public static TList<SafeNameClass> Fill(IDataReader reader, TList<SafeNameClass> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MetaBuilder.BusinessLogic.SafeNameClass c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("SafeNameClass")
					.Append("|").Append((System.String)reader[((int)SafeNameClassColumn.Name - 1)]).ToString();
					c = EntityManager.LocateOrCreate<SafeNameClass>(
					key.ToString(), // EntityTrackingKey
					"SafeNameClass",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MetaBuilder.BusinessLogic.SafeNameClass();
				}
					...
					))
				{
					...
					c.Name = (System.String)reader[((int)SafeNameClassColumn.Name - 1)];
					c.OriginalName = c.Name;
					c.DescriptionCode = (reader.IsDBNull(((int)SafeNameClassColumn.DescriptionCode - 1)))?null:(System.String)reader[((int)SafeNameClassColumn.DescriptionCode - 1)];
					c.Category = (reader.IsDBNull(((int)SafeNameClassColumn.Category - 1)))?null:(System.String)reader[((int)SafeNameClassColumn.Category - 1)];
					c.ClassType = (reader.IsDBNull(((int)SafeNameClassColumn.ClassType - 1)))?null:(System.String)reader[((int)SafeNameClassColumn.ClassType - 1)];
					c.IsActive = (reader.IsDBNull(((int)SafeNameClassColumn.IsActive - 1)))?null:(System.Boolean?)reader[((int)SafeNameClassColumn.IsActive - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MetaBuilder.BusinessLogic.SafeNameClass entity)
		{
			if (!reader.Read()) return;
			
			entity.Name = (System.String)reader[((int)SafeNameClassColumn.Name - 1)];
			entity.OriginalName = (System.String)reader["Name"];
			entity.DescriptionCode = (reader.IsDBNull(((int)SafeNameClassColumn.DescriptionCode - 1)))?null:(System.String)reader[((int)SafeNameClassColumn.DescriptionCode - 1)];
			entity.Category = (reader.IsDBNull(((int)SafeNameClassColumn.Category - 1)))?null:(System.String)reader[((int)SafeNameClassColumn.Category - 1)];
			entity.ClassType = (reader.IsDBNull(((int)SafeNameClassColumn.ClassType - 1)))?null:(System.String)reader[((int)SafeNameClassColumn.ClassType - 1)];
			entity.IsActive = (reader.IsDBNull(((int)SafeNameClassColumn.IsActive - 1)))?null:(System.Boolean?)reader[((int)SafeNameClassColumn.IsActive - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MetaBuilder.BusinessLogic.SafeNameClass entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MetaBuilder.BusinessLogic.SafeNameClass"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MetaBuilder.BusinessLogic.SafeNameClass Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MetaBuilder.BusinessLogic.SafeNameClass entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			if (CanDeepLoad(entity, "List<Field>|FieldCollection", deepLoadType, innerList)) 
			{
				...
				entity.FieldCollection = DataRepository.FieldProvider.GetBySafeNameClass(transactionManager, entity.Name);
			...
			if (CanDeepLoad(entity, "List<AllowedArtifact>|AllowedArtifactCollection", deepLoadType, innerList)) 
			{
				...
				entity.AllowedArtifactCollection = DataRepository.AllowedArtifactProvider.GetBySafeNameClass(transactionManager, entity.Name);
			...
			{
				entity.CAidClassAssociationCollection_From_AllowedArtifact = DataRepository.ClassAssociationProvider.GetBySafeNameClassFromAllowedArtifact(transactionManager, entity.Name);			 
			...
			if (CanDeepLoad(entity, "List<MetaObject>|MetaObjectCollection", deepLoadType, innerList)) 
			{
				...
				entity.MetaObjectCollection = DataRepository.MetaObjectProvider.GetBySafeNameClass(transactionManager, entity.Name);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MetaBuilder.BusinessLogic.SafeNameClass object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MetaBuilder.BusinessLogic.SafeNameClass instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MetaBuilder.BusinessLogic.SafeNameClass Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MetaBuilder.BusinessLogic.SafeNameClass entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<Field>
				...
				{	
					...
					{
						if(child.SafeNameClassSource != null)
						{
							child.SafeNameClass = child.SafeNameClassSource.Name;
						}
						else
						{
							child.SafeNameClass = entity.Name;
						}
	...
	#region SafeNameClassChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MetaBuilder.BusinessLogic.SafeNameClass</c>
	///</summary>
	public enum SafeNameClassChildEntityTypes
	{
		...
		///<summary>
		/// Collection of <c>SafeNameClass</c> as OneToMany for FieldCollection
		///</summary>
		[ChildEntityType(typeof(TList<Field>))]
		FieldCollection,

		///<summary>
		/// Collection of <c>SafeNameClass</c> as OneToMany for ClassAssociationCollection
		///</summary>
		[ChildEntityType(typeof(TList<ClassAssociation>))]
		ClassAssociationCollectionGetByParentClass,

		///<summary>
		/// Collection of <c>SafeNameClass</c> as OneToMany for AllowedArtifactCollection
		///</summary>
		[ChildEntityType(typeof(TList<AllowedArtifact>))]
		AllowedArtifactCollection,

		///<summary>
		/// Collection of <c>SafeNameClass</c> as ManyToMany for ClassAssociationCollection_From_AllowedArtifact
		///</summary>
		[ChildEntityType(typeof(TList<ClassAssociation>))]
		CAidClassAssociationCollection_From_AllowedArtifact,

		///<summary>
		/// Collection of <c>SafeNameClass</c> as OneToMany for MetaObjectCollection
		///</summary>
	...
	#endregion SafeNameClassChildEntityTypes
	
	#region SafeNameClassFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;SafeNameClassColumn&gt;"/> class
	/// that is used exclusively with a <see cref="SafeNameClass"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class SafeNameClassFilterBuilder : SqlFilterBuilder<SafeNameClassColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the SafeNameClassFilterBuilder class.
		/// </summary>
		public SafeNameClassFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the SafeNameClassFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public SafeNameClassFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public SafeNameClassFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion SafeNameClassFilterBuilder
	
	#region SafeNameClassParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;SafeNameClassColumn&gt;"/> class
	/// that is used exclusively with a <see cref="SafeNameClass"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class SafeNameClassParameterBuilder : ParameterizedSqlFilterBuilder<SafeNameClassColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the SafeNameClassParameterBuilder class.
		/// </summary>
		public SafeNameClassParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the SafeNameClassParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public SafeNameClassParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public SafeNameClassParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion SafeNameClassParameterBuilder
	
	#region SafeNameClassSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;SafeNameClassColumn&gt;"/> class
	/// that is used exclusively with a <see cref="SafeNameClass"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class SafeNameClassSortBuilder : SqlSortBuilder<SafeNameClassColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the SafeNameClassSqlSortBuilder class.
		/// </summary>
		public SafeNameClassSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion SafeNameClassSortBuilder
