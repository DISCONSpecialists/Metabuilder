...
namespace MetaBuilder.UIControls.Common.CheckBoxComboBox
{
    /// <summary>
    ...
    public partial class CheckBoxComboBox : PopupComboBox
    {
        ...
        internal string GetCSVText(bool skipFirstItem)
        {
            ...
            for (int Index = StartIndex; Index <= _CheckBoxComboBoxListControl.Items.Count - 1; Index++)
            {
                ...
                if (Item.Checked)
                    ListText += ListText.Length == 0 ? Item.Text : String.Format(", {0}", Item.Text);
            }
            return ListText;
        }
        ...
        {
            get { if (_DisplayMemberSingleItem.Length == 0) return DisplayMember; else return _DisplayMemberSingleItem; }
        ...
        public List<object> CheckedItems
        {
            get
            {
                ...
                foreach (CheckBoxComboBoxItem Item in CheckBoxItems)
                    if (Item.Checked)
                        checkedItems.Add(Item.ComboBoxItem);
    ...
    public class CheckBoxComboBoxItem : CheckBox
    {
        ...
        internal void ApplyProperties(CheckBoxProperties properties)
        {
            ...
            if (ComboBoxItem is CCBoxItem && (ComboBoxItem as CCBoxItem).Value is int)
            {
                this.Font = new Font(this.Font.FontFamily, 8f, FontStyle.Bold);
                this.FlatAppearance.MouseOverBackColor = properties.FlatAppearanceCheckedBackColor;
            }
        }
    ...
    public class CCBoxItem
    {
        ...
        {
            return Name;
            return string.Format("name: '{0}', value: {1}", name, val.ToString());
        }
    }
