/*
	...
	Important: Do not modify this file. Edit the file METAView_DataAttribute_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_DataAttribute_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_DataAttribute_ListingBase")]
	public abstract partial class METAView_DataAttribute_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_DataAttribute_ListingBase"/> instance.
		///</summary>
		public METAView_DataAttribute_ListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_DataAttribute_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_isFactOrMeasure"></param>
		///<param name="_isDerived"></param>
		public static METAView_DataAttribute_Listing CreateMETAView_DataAttribute_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _abbreviation, System.String _description, System.String _isBusinessExternal, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName, System.String _dataType, System.String _dataLength, System.String _contentType, System.String _isFactOrMeasure, System.String _isDerived)
		{
			METAView_DataAttribute_Listing newMETAView_DataAttribute_Listing = new METAView_DataAttribute_Listing();
			newMETAView_DataAttribute_Listing.WorkspaceName = _workspaceName;
			newMETAView_DataAttribute_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_DataAttribute_Listing.VCStatusID = _vCStatusID;
			newMETAView_DataAttribute_Listing.pkid = _pkid;
			newMETAView_DataAttribute_Listing.Machine = _machine;
			newMETAView_DataAttribute_Listing.VCMachineID = _vCMachineID;
			newMETAView_DataAttribute_Listing.Name = _name;
			newMETAView_DataAttribute_Listing.Abbreviation = _abbreviation;
			newMETAView_DataAttribute_Listing.Description = _description;
			newMETAView_DataAttribute_Listing.IsBusinessExternal = _isBusinessExternal;
			newMETAView_DataAttribute_Listing.ArchitectureStatus = _architectureStatus;
			newMETAView_DataAttribute_Listing.ArchitectureStatusDate = _architectureStatusDate;
			newMETAView_DataAttribute_Listing.DesignRationale = _designRationale;
			newMETAView_DataAttribute_Listing.GeneralRemarks = _generalRemarks;
			newMETAView_DataAttribute_Listing.GapType = _gapType;
			newMETAView_DataAttribute_Listing.DataSourceID = _dataSourceID;
			newMETAView_DataAttribute_Listing.DataSourceName = _dataSourceName;
			newMETAView_DataAttribute_Listing.DataType = _dataType;
			newMETAView_DataAttribute_Listing.DataLength = _dataLength;
			newMETAView_DataAttribute_Listing.ContentType = _contentType;
			newMETAView_DataAttribute_Listing.IsFactOrMeasure = _isFactOrMeasure;
			newMETAView_DataAttribute_Listing.IsDerived = _isDerived;
			return newMETAView_DataAttribute_Listing;
		}
		...
		{
			get { return "METAView_DataAttribute_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_DataAttribute_ListingBase Entity 
		///</summary>
		public virtual METAView_DataAttribute_ListingBase Copy()
		{
			//shallow copy entity
			METAView_DataAttribute_Listing copy = new METAView_DataAttribute_Listing();
			...
			copy.AcceptChanges();
			return (METAView_DataAttribute_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_DataAttribute_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_DataAttribute_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_DataAttribute_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_DataAttribute_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_DataAttribute_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_DataAttribute_ListingBase Object1, METAView_DataAttribute_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_DataAttribute_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_DataAttribute_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{23}{22}- WorkspaceName: {0}{22}- WorkspaceTypeId: {1}{22}- VCStatusID: {2}{22}- pkid: {3}{22}- Machine: {4}{22}- VCMachineID: {5}{22}- Name: {6}{22}- Abbreviation: {7}{22}- Description: {8}{22}- IsBusinessExternal: {9}{22}- ArchitectureStatus: {10}{22}- ArchitectureStatusDate: {11}{22}- DesignRationale: {12}{22}- GeneralRemarks: {13}{22}- GapType: {14}{22}- DataSourceID: {15}{22}- DataSourceName: {16}{22}- DataType: {17}{22}- DataLength: {18}{22}- ContentType: {19}{22}- IsFactOrMeasure: {20}{22}- IsDerived: {21}{22}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_DataAttribute_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_DataAttribute_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
