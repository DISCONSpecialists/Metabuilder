/*
	...
	Important: Do not modify this file. Edit the file METAView_ConnectionSize_Listing.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_ConnectionSize_Listing' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ConnectionSize_ListingBase")]
	public abstract partial class METAView_ConnectionSize_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ConnectionSize_ListingBase"/> instance.
		///</summary>
		public METAView_ConnectionSize_ListingBase()
		{
		}		
		...
		public METAView_ConnectionSize_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ConnectionSize_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_vCMachineID"></param>
		///<param name="_name"></param>
		public static METAView_ConnectionSize_Listing CreateMETAView_ConnectionSize_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
			METAView_ConnectionSize_Listing newMETAView_ConnectionSize_Listing = new METAView_ConnectionSize_Listing();
			newMETAView_ConnectionSize_Listing.WorkspaceName = _workspaceName;
			newMETAView_ConnectionSize_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_ConnectionSize_Listing.VCStatusID = _vCStatusID;
			newMETAView_ConnectionSize_Listing.pkid = _pkid;
			newMETAView_ConnectionSize_Listing.Machine = _machine;
			newMETAView_ConnectionSize_Listing.VCMachineID = _vCMachineID;
			newMETAView_ConnectionSize_Listing.Name = _name;
			return newMETAView_ConnectionSize_Listing;
		}
		...
		{
			get { return "METAView_ConnectionSize_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_ConnectionSize_ListingBase Entity 
		///</summary>
		public virtual METAView_ConnectionSize_ListingBase Copy()
		{
			//shallow copy entity
			METAView_ConnectionSize_Listing copy = new METAView_ConnectionSize_Listing();
				...
				copy.Name = this.Name;
			copy.AcceptChanges();
			return (METAView_ConnectionSize_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ConnectionSize_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ConnectionSize_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ConnectionSize_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ConnectionSize_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ConnectionSize_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ConnectionSize_ListingBase Object1, METAView_ConnectionSize_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ConnectionSize_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ConnectionSize_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_ConnectionSize_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_ConnectionSize_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
