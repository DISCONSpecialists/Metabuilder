/*
	...
	Important: Do not modify this file. Edit the file METAView_CAD_Retrieval.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_CAD_Retrieval' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_CAD_RetrievalBase")]
	public abstract partial class METAView_CAD_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_CAD_RetrievalBase"/> instance.
		///</summary>
		public METAView_CAD_RetrievalBase()
		{
		}		
		...
		public METAView_CAD_RetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_CAD_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_CAD_Retrieval CreateMETAView_CAD_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_CAD_Retrieval newMETAView_CAD_Retrieval = new METAView_CAD_Retrieval();
			newMETAView_CAD_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_CAD_Retrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAView_CAD_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_CAD_Retrieval.pkid = _pkid;
			newMETAView_CAD_Retrieval.Machine = _machine;
			newMETAView_CAD_Retrieval.VCMachineID = _vCMachineID;
			return newMETAView_CAD_Retrieval;
		}
		...
		{
			get { return "METAView_CAD_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_CAD_RetrievalBase Entity 
		///</summary>
		public virtual METAView_CAD_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_CAD_Retrieval copy = new METAView_CAD_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_CAD_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_CAD_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_CAD_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_CAD_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_CAD_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_CAD_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_CAD_RetrievalBase Object1, METAView_CAD_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_CAD_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_CAD_Retrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_CAD_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_CAD_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
