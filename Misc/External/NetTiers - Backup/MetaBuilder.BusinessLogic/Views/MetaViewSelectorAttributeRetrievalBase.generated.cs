/*
	...
	Important: Do not modify this file. Edit the file METAViewSelectorAttributeRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewSelectorAttributeRetrievalBase")]
	public abstract partial class METAViewSelectorAttributeRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewSelectorAttributeRetrievalBase"/> instance.
		///</summary>
		public METAViewSelectorAttributeRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewSelectorAttributeRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewSelectorAttributeRetrieval CreateMETAViewSelectorAttributeRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewSelectorAttributeRetrieval newMETAViewSelectorAttributeRetrieval = new METAViewSelectorAttributeRetrieval();
			newMETAViewSelectorAttributeRetrieval.WorkspaceName = _workspaceName;
			newMETAViewSelectorAttributeRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewSelectorAttributeRetrieval.VCStatusID = _vCStatusID;
			newMETAViewSelectorAttributeRetrieval.Pkid = _pkid;
			newMETAViewSelectorAttributeRetrieval.Machine = _machine;
			newMETAViewSelectorAttributeRetrieval.VCMachineID = _vCMachineID;
			newMETAViewSelectorAttributeRetrieval.Value = _value;
			newMETAViewSelectorAttributeRetrieval.CustomField1 = _customField1;
			newMETAViewSelectorAttributeRetrieval.CustomField2 = _customField2;
			newMETAViewSelectorAttributeRetrieval.CustomField3 = _customField3;
			newMETAViewSelectorAttributeRetrieval.GapType = _gapType;
			return newMETAViewSelectorAttributeRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewSelectorAttributeRetrievalBase Entity 
		///</summary>
		public virtual METAViewSelectorAttributeRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewSelectorAttributeRetrieval copy = new METAViewSelectorAttributeRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewSelectorAttributeRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewSelectorAttributeRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewSelectorAttributeRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewSelectorAttributeRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewSelectorAttributeRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewSelectorAttributeRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewSelectorAttributeRetrievalBase Object1, METAViewSelectorAttributeRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewSelectorAttributeRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewSelectorAttributeRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewSelectorAttributeRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewSelectorAttributeRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
