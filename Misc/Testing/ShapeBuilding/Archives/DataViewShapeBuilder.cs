...
{
    public class DataViewShapeBuilder
    {
        public GraphNode GetShape()
        {
            ...
            bottomPortLeft.IncomingLinksDirection = 180;
            bottomPortLeft.OutgoingLinksDirection = 180;
            ...
            bottomPortLeft2.IncomingLinksDirection = 180;
            bottomPortLeft2.OutgoingLinksDirection = 180;
            ...
            bottomPortRight.IncomingLinksDirection = 180;
            bottomPortRight.OutgoingLinksDirection = 180;
            ...
            bottomPortRight2.IncomingLinksDirection = 180;
            bottomPortRight2.OutgoingLinksDirection = 180;
            ...
            bottomPort.IncomingLinksDirection = 180;
            bottomPort.OutgoingLinksDirection = 180;
            ...
            crnode.BindingInfo.BindingClass = "DataView";
            crnode.BindingInfo.Bindings.Add("DataView", "Name");
            crnode.CreateMetaObject(null, EventArgs.Empty);
            BoundLabel txtTypes = new BoundLabel();
            txtTypes.Choices = new ArrayList();
            txtTypes.Choices.Add("EForm");
            txtTypes.Choices.Add("PForm");
            txtTypes.Choices.Add("Data Source");
            txtTypes.Width = blueRect.Width - 4;
            txtTypes.Wrapping = true;
            txtTypes.WrappingWidth = blueRect.Width - 4;
            txtTypes.EditorStyle = GoTextEditorStyle.ComboBox;
            txtTypes.Left = blueRect.Left + 20;
            txtTypes.Top = 40;
            txtTypes.DragsNode = true;
            ...
            CollapsingRecordNodeItem headeritem0 = crnode.MakeItem("", "DataView Attributes", true);
            ...
            rbinfo.Association.ID = 3471;
            rbinfo.Association.ParentClass = "DataView";
