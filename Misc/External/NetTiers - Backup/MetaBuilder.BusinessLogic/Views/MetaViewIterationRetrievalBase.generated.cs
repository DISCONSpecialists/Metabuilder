/*
	...
	Important: Do not modify this file. Edit the file METAViewIterationRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewIterationRetrievalBase")]
	public abstract partial class METAViewIterationRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewIterationRetrievalBase"/> instance.
		///</summary>
		public METAViewIterationRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewIterationRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewIterationRetrieval CreateMETAViewIterationRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _iterationType, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewIterationRetrieval newMETAViewIterationRetrieval = new METAViewIterationRetrieval();
			newMETAViewIterationRetrieval.WorkspaceName = _workspaceName;
			newMETAViewIterationRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewIterationRetrieval.VCStatusID = _vCStatusID;
			newMETAViewIterationRetrieval.Pkid = _pkid;
			newMETAViewIterationRetrieval.Machine = _machine;
			newMETAViewIterationRetrieval.VCMachineID = _vCMachineID;
			newMETAViewIterationRetrieval.Name = _name;
			newMETAViewIterationRetrieval.IterationType = _iterationType;
			newMETAViewIterationRetrieval.CustomField1 = _customField1;
			newMETAViewIterationRetrieval.CustomField2 = _customField2;
			newMETAViewIterationRetrieval.CustomField3 = _customField3;
			newMETAViewIterationRetrieval.GapType = _gapType;
			return newMETAViewIterationRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewIterationRetrievalBase Entity 
		///</summary>
		public virtual METAViewIterationRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewIterationRetrieval copy = new METAViewIterationRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewIterationRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewIterationRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewIterationRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewIterationRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewIterationRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewIterationRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewIterationRetrievalBase Object1, METAViewIterationRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewIterationRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewIterationRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewIterationRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewIterationRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
