/*
	...
	Important: Do not modify this file. Edit the file METAViewEmployeeRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewEmployeeRetrievalBase")]
	public abstract partial class METAViewEmployeeRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewEmployeeRetrievalBase"/> instance.
		///</summary>
		public METAViewEmployeeRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewEmployeeRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_fax"></param>
		///<param name="_gapType"></param>
		public static METAViewEmployeeRetrieval CreateMETAViewEmployeeRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _surname, System.String _title, System.String _employeeNumber, System.String _iDNumber, System.String _email, System.String _telephone, System.String _customField1, System.String _customField2, System.String _customField3, System.String _mobile, System.String _fax, System.String _gapType)
		{
			METAViewEmployeeRetrieval newMETAViewEmployeeRetrieval = new METAViewEmployeeRetrieval();
			newMETAViewEmployeeRetrieval.WorkspaceName = _workspaceName;
			newMETAViewEmployeeRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewEmployeeRetrieval.VCStatusID = _vCStatusID;
			newMETAViewEmployeeRetrieval.Pkid = _pkid;
			newMETAViewEmployeeRetrieval.Machine = _machine;
			newMETAViewEmployeeRetrieval.VCMachineID = _vCMachineID;
			newMETAViewEmployeeRetrieval.Name = _name;
			newMETAViewEmployeeRetrieval.Surname = _surname;
			newMETAViewEmployeeRetrieval.Title = _title;
			newMETAViewEmployeeRetrieval.EmployeeNumber = _employeeNumber;
			newMETAViewEmployeeRetrieval.IDNumber = _iDNumber;
			newMETAViewEmployeeRetrieval.Email = _email;
			newMETAViewEmployeeRetrieval.Telephone = _telephone;
			newMETAViewEmployeeRetrieval.CustomField1 = _customField1;
			newMETAViewEmployeeRetrieval.CustomField2 = _customField2;
			newMETAViewEmployeeRetrieval.CustomField3 = _customField3;
			newMETAViewEmployeeRetrieval.Mobile = _mobile;
			newMETAViewEmployeeRetrieval.Fax = _fax;
			newMETAViewEmployeeRetrieval.GapType = _gapType;
			return newMETAViewEmployeeRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewEmployeeRetrievalBase Entity 
		///</summary>
		public virtual METAViewEmployeeRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewEmployeeRetrieval copy = new METAViewEmployeeRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewEmployeeRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewEmployeeRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewEmployeeRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewEmployeeRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewEmployeeRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewEmployeeRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewEmployeeRetrievalBase Object1, METAViewEmployeeRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewEmployeeRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewEmployeeRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewEmployeeRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewEmployeeRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
