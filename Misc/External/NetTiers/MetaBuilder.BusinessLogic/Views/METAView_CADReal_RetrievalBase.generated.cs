/*
	...
	Important: Do not modify this file. Edit the file METAView_CADReal_Retrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_CADReal_RetrievalBase")]
	public abstract partial class METAView_CADReal_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_CADReal_RetrievalBase"/> instance.
		///</summary>
		public METAView_CADReal_RetrievalBase()
		{
		}		
		...
		public METAView_CADReal_RetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_CADReal_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_CADReal_Retrieval CreateMETAView_CADReal_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_CADReal_Retrieval newMETAView_CADReal_Retrieval = new METAView_CADReal_Retrieval();
			newMETAView_CADReal_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_CADReal_Retrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAView_CADReal_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_CADReal_Retrieval.pkid = _pkid;
			newMETAView_CADReal_Retrieval.Machine = _machine;
			newMETAView_CADReal_Retrieval.VCMachineID = _vCMachineID;
			return newMETAView_CADReal_Retrieval;
		}
		...
		{
			get { return "METAView_CADReal_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_CADReal_RetrievalBase Entity 
		///</summary>
		public virtual METAView_CADReal_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_CADReal_Retrieval copy = new METAView_CADReal_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_CADReal_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_CADReal_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_CADReal_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_CADReal_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_CADReal_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_CADReal_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_CADReal_RetrievalBase Object1, METAView_CADReal_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_CADReal_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_CADReal_Retrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_CADReal_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_CADReal_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
