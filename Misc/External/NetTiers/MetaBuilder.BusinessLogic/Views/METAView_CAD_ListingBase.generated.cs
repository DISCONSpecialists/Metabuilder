/*
	...
	Important: Do not modify this file. Edit the file METAView_CAD_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_CAD_ListingBase")]
	public abstract partial class METAView_CAD_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_CAD_ListingBase"/> instance.
		///</summary>
		public METAView_CAD_ListingBase()
		{
		}		
		...
		public METAView_CAD_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_CAD_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_CAD_Listing CreateMETAView_CAD_Listing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_CAD_Listing newMETAView_CAD_Listing = new METAView_CAD_Listing();
			newMETAView_CAD_Listing.WorkspaceName = _workspaceName;
			newMETAView_CAD_Listing.WorkspaceTypeID = _workspaceTypeID;
			newMETAView_CAD_Listing.VCStatusID = _vCStatusID;
			newMETAView_CAD_Listing.pkid = _pkid;
			newMETAView_CAD_Listing.Machine = _machine;
			newMETAView_CAD_Listing.VCMachineID = _vCMachineID;
			return newMETAView_CAD_Listing;
		}
		...
		{
			get { return "METAView_CAD_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_CAD_ListingBase Entity 
		///</summary>
		public virtual METAView_CAD_ListingBase Copy()
		{
			//shallow copy entity
			METAView_CAD_Listing copy = new METAView_CAD_Listing();
			...
			copy.AcceptChanges();
			return (METAView_CAD_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_CAD_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_CAD_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_CAD_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_CAD_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_CAD_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_CAD_ListingBase Object1, METAView_CAD_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_CAD_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_CAD_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_CAD_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_CAD_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
