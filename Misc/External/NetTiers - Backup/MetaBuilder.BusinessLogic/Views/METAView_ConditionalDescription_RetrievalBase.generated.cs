/*
	...
	Important: Do not modify this file. Edit the file METAView_ConditionalDescription_Retrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ConditionalDescription_RetrievalBase")]
	public abstract partial class METAView_ConditionalDescription_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// Sequence : 
		/// </summary>
		private System.Int32?		  _sequence = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ConditionalDescription_RetrievalBase"/> instance.
		///</summary>
		public METAView_ConditionalDescription_RetrievalBase()
		{
		}		
		...
		public METAView_ConditionalDescription_RetrievalBase(System.String _workspaceName, System.Int32? _WorkspaceTypeId, System.Int32 _VCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value, System.Int32? _sequence, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ConditionalDescription_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_WorkspaceTypeId"></param>
		///<param name="_VCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAView_ConditionalDescription_Retrieval CreateMETAView_ConditionalDescription_Retrieval(System.String _workspaceName, System.Int32? _WorkspaceTypeId, System.Int32 _VCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value, System.Int32? _sequence, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAView_ConditionalDescription_Retrieval newMETAView_ConditionalDescription_Retrieval = new METAView_ConditionalDescription_Retrieval();
			newMETAView_ConditionalDescription_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_ConditionalDescription_Retrieval.WorkspaceTypeId = _WorkspaceTypeId;
			newMETAView_ConditionalDescription_Retrieval.VCStatusID = _VCStatusID;
			newMETAView_ConditionalDescription_Retrieval.pkid = _pkid;
			newMETAView_ConditionalDescription_Retrieval.Machine = _machine;
			newMETAView_ConditionalDescription_Retrieval.VCMachineID = _vCMachineID;
			newMETAView_ConditionalDescription_Retrieval.Value = _value;
			newMETAView_ConditionalDescription_Retrieval.Sequence = _sequence;
			newMETAView_ConditionalDescription_Retrieval.CustomField1 = _customField1;
			newMETAView_ConditionalDescription_Retrieval.CustomField2 = _customField2;
			newMETAView_ConditionalDescription_Retrieval.CustomField3 = _customField3;
			newMETAView_ConditionalDescription_Retrieval.GapType = _gapType;
			return newMETAView_ConditionalDescription_Retrieval;
		}
		...
		public virtual System.Int32? Sequence
		{
			...
			set
			{
				if (_sequence == value && Sequence != null )
					return;
		...
		{
			get { return "METAView_ConditionalDescription_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_ConditionalDescription_RetrievalBase Entity 
		///</summary>
		public virtual METAView_ConditionalDescription_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_ConditionalDescription_Retrieval copy = new METAView_ConditionalDescription_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_ConditionalDescription_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ConditionalDescription_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ConditionalDescription_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ConditionalDescription_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ConditionalDescription_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ConditionalDescription_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ConditionalDescription_RetrievalBase Object1, METAView_ConditionalDescription_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ConditionalDescription_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ConditionalDescription_Retrieval, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{13}{12}- WorkspaceName: {0}{12}- WorkspaceTypeId: {1}{12}- VCStatusID: {2}{12}- pkid: {3}{12}- Machine: {4}{12}- VCMachineID: {5}{12}- Value: {6}{12}- Sequence: {7}{12}- CustomField1: {8}{12}- CustomField2: {9}{12}- CustomField3: {10}{12}- GapType: {11}{12}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_ConditionalDescription_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_ConditionalDescription_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
