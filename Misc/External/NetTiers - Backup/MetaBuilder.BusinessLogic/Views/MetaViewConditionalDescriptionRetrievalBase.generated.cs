/*
	...
	Important: Do not modify this file. Edit the file METAViewConditionalDescriptionRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewConditionalDescriptionRetrievalBase")]
	public abstract partial class METAViewConditionalDescriptionRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewConditionalDescriptionRetrievalBase"/> instance.
		///</summary>
		public METAViewConditionalDescriptionRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewConditionalDescriptionRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewConditionalDescriptionRetrieval CreateMETAViewConditionalDescriptionRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value, System.Int32? _sequence, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewConditionalDescriptionRetrieval newMETAViewConditionalDescriptionRetrieval = new METAViewConditionalDescriptionRetrieval();
			newMETAViewConditionalDescriptionRetrieval.WorkspaceName = _workspaceName;
			newMETAViewConditionalDescriptionRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewConditionalDescriptionRetrieval.VCStatusID = _vCStatusID;
			newMETAViewConditionalDescriptionRetrieval.Pkid = _pkid;
			newMETAViewConditionalDescriptionRetrieval.Machine = _machine;
			newMETAViewConditionalDescriptionRetrieval.VCMachineID = _vCMachineID;
			newMETAViewConditionalDescriptionRetrieval.Value = _value;
			newMETAViewConditionalDescriptionRetrieval.Sequence = _sequence;
			newMETAViewConditionalDescriptionRetrieval.CustomField1 = _customField1;
			newMETAViewConditionalDescriptionRetrieval.CustomField2 = _customField2;
			newMETAViewConditionalDescriptionRetrieval.CustomField3 = _customField3;
			newMETAViewConditionalDescriptionRetrieval.GapType = _gapType;
			return newMETAViewConditionalDescriptionRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewConditionalDescriptionRetrievalBase Entity 
		///</summary>
		public virtual METAViewConditionalDescriptionRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewConditionalDescriptionRetrieval copy = new METAViewConditionalDescriptionRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewConditionalDescriptionRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewConditionalDescriptionRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewConditionalDescriptionRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewConditionalDescriptionRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewConditionalDescriptionRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewConditionalDescriptionRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewConditionalDescriptionRetrievalBase Object1, METAViewConditionalDescriptionRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewConditionalDescriptionRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewConditionalDescriptionRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewConditionalDescriptionRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewConditionalDescriptionRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
