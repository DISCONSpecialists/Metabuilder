/*
	...
	Important: Do not modify this file. Edit the file METAViewDataTableRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewDataTableRetrievalBase")]
	public abstract partial class METAViewDataTableRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewDataTableRetrievalBase"/> instance.
		///</summary>
		public METAViewDataTableRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewDataTableRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewDataTableRetrieval CreateMETAViewDataTableRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.Int32? _initialPopulation, System.String _growthRateOverTime, System.String _recordSize, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewDataTableRetrieval newMETAViewDataTableRetrieval = new METAViewDataTableRetrieval();
			newMETAViewDataTableRetrieval.WorkspaceName = _workspaceName;
			newMETAViewDataTableRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewDataTableRetrieval.VCStatusID = _vCStatusID;
			newMETAViewDataTableRetrieval.Pkid = _pkid;
			newMETAViewDataTableRetrieval.Machine = _machine;
			newMETAViewDataTableRetrieval.VCMachineID = _vCMachineID;
			newMETAViewDataTableRetrieval.Name = _name;
			newMETAViewDataTableRetrieval.InitialPopulation = _initialPopulation;
			newMETAViewDataTableRetrieval.GrowthRateOverTime = _growthRateOverTime;
			newMETAViewDataTableRetrieval.RecordSize = _recordSize;
			newMETAViewDataTableRetrieval.CustomField1 = _customField1;
			newMETAViewDataTableRetrieval.CustomField2 = _customField2;
			newMETAViewDataTableRetrieval.CustomField3 = _customField3;
			newMETAViewDataTableRetrieval.GapType = _gapType;
			return newMETAViewDataTableRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewDataTableRetrievalBase Entity 
		///</summary>
		public virtual METAViewDataTableRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewDataTableRetrieval copy = new METAViewDataTableRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewDataTableRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewDataTableRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewDataTableRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewDataTableRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewDataTableRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewDataTableRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewDataTableRetrievalBase Object1, METAViewDataTableRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewDataTableRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewDataTableRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewDataTableRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewDataTableRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
