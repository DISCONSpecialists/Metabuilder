/*
	...
	Important: Do not modify this file. Edit the file METAView_Report_Retrieval.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'METAView_Report_Retrieval' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_Report_RetrievalBase")]
	public abstract partial class METAView_Report_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_Report_RetrievalBase"/> instance.
		///</summary>
		public METAView_Report_RetrievalBase()
		{
		}		
		...
		public METAView_Report_RetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_Report_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_Report_Retrieval CreateMETAView_Report_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_Report_Retrieval newMETAView_Report_Retrieval = new METAView_Report_Retrieval();
			newMETAView_Report_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_Report_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_Report_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_Report_Retrieval.pkid = _pkid;
			newMETAView_Report_Retrieval.Machine = _machine;
			newMETAView_Report_Retrieval.VCMachineID = _vCMachineID;
			return newMETAView_Report_Retrieval;
		}
		...
		{
			get { return "METAView_Report_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_Report_RetrievalBase Entity 
		///</summary>
		public virtual METAView_Report_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_Report_Retrieval copy = new METAView_Report_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_Report_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_Report_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_Report_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_Report_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_Report_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_Report_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_Report_RetrievalBase Object1, METAView_Report_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_Report_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_Report_Retrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_Report_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_Report_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
