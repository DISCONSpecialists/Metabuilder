...
{
    public class VerticalNodeTransformer : EmbeddedObjectsTransformer
    {
        ...
        public VerticalNodeTransformer()
            : base()
        {
            TransformerType = typeof(VerticalNode);
            ElementName = "verticalNode";
        ...
        public override void ConsumeAttributes(object obj)
        {
            if (!replaced)
            {
                ...
                VerticalNode node = obj as VerticalNode;
            ...
            else
            {
                ...
                (obj as VerticalNode).Position = new System.Drawing.PointF(bounds.X, bounds.Y);
            }
            if (StringAttr("shallowCN", null) != null)
                Reader.MakeShared(StringAttr("shallowCN", null), obj);

            (obj as VerticalNode).ImageFilename = StringAttr("imgPath", "");
        }
        public override void ConsumeChild(object parent, object child)
        {
            ...
            VerticalNode node = parent as VerticalNode;
            if (!replaced)
            {
        ...
        private void FixIfBroken(VerticalNode node)
        {
        ...
        public override void GenerateAttributes(Object obj)
        {
            ...
            if (node.GetType().Name.ToString() == typeof(VerticalNode).Name)
            {
        ...
        public override void GenerateDefinitions(Object obj)
        {
            ...
            VerticalNode n = (VerticalNode)obj;
