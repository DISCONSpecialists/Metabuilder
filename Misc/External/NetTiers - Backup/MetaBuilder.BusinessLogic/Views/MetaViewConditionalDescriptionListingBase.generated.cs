/*
	...
	Important: Do not modify this file. Edit the file METAViewConditionalDescriptionListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewConditionalDescriptionListingBase")]
	public abstract partial class METAViewConditionalDescriptionListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewConditionalDescriptionListingBase"/> instance.
		///</summary>
		public METAViewConditionalDescriptionListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewConditionalDescriptionListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewConditionalDescriptionListing CreateMETAViewConditionalDescriptionListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _value, System.Int32? _sequence, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewConditionalDescriptionListing newMETAViewConditionalDescriptionListing = new METAViewConditionalDescriptionListing();
			newMETAViewConditionalDescriptionListing.WorkspaceName = _workspaceName;
			newMETAViewConditionalDescriptionListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewConditionalDescriptionListing.VCStatusID = _vCStatusID;
			newMETAViewConditionalDescriptionListing.Pkid = _pkid;
			newMETAViewConditionalDescriptionListing.Machine = _machine;
			newMETAViewConditionalDescriptionListing.VCMachineID = _vCMachineID;
			newMETAViewConditionalDescriptionListing.Value = _value;
			newMETAViewConditionalDescriptionListing.Sequence = _sequence;
			newMETAViewConditionalDescriptionListing.CustomField1 = _customField1;
			newMETAViewConditionalDescriptionListing.CustomField2 = _customField2;
			newMETAViewConditionalDescriptionListing.CustomField3 = _customField3;
			newMETAViewConditionalDescriptionListing.GapType = _gapType;
			return newMETAViewConditionalDescriptionListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewConditionalDescriptionListingBase Entity 
		///</summary>
		public virtual METAViewConditionalDescriptionListingBase Copy()
		{
			//shallow copy entity
			METAViewConditionalDescriptionListing copy = new METAViewConditionalDescriptionListing();
			...
			copy.AcceptChanges();
			return (METAViewConditionalDescriptionListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewConditionalDescriptionListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewConditionalDescriptionListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewConditionalDescriptionListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewConditionalDescriptionListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewConditionalDescriptionListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewConditionalDescriptionListingBase Object1, METAViewConditionalDescriptionListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewConditionalDescriptionListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewConditionalDescriptionListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewConditionalDescriptionListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewConditionalDescriptionListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
