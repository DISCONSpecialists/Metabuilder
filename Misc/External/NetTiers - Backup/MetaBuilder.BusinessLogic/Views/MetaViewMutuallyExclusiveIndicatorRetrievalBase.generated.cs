/*
	...
	Important: Do not modify this file. Edit the file METAViewMutuallyExclusiveIndicatorRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewMutuallyExclusiveIndicatorRetrievalBase")]
	public abstract partial class METAViewMutuallyExclusiveIndicatorRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewMutuallyExclusiveIndicatorRetrievalBase"/> instance.
		///</summary>
		public METAViewMutuallyExclusiveIndicatorRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewMutuallyExclusiveIndicatorRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_selectorType"></param>
		///<param name="_gapType"></param>
		public static METAViewMutuallyExclusiveIndicatorRetrieval CreateMETAViewMutuallyExclusiveIndicatorRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _customField1, System.String _customField2, System.String _customField3, System.String _selectorType, System.String _gapType)
		{
			METAViewMutuallyExclusiveIndicatorRetrieval newMETAViewMutuallyExclusiveIndicatorRetrieval = new METAViewMutuallyExclusiveIndicatorRetrieval();
			newMETAViewMutuallyExclusiveIndicatorRetrieval.WorkspaceName = _workspaceName;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.VCStatusID = _vCStatusID;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.Pkid = _pkid;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.Machine = _machine;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.VCMachineID = _vCMachineID;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.Name = _name;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.CustomField1 = _customField1;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.CustomField2 = _customField2;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.CustomField3 = _customField3;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.SelectorType = _selectorType;
			newMETAViewMutuallyExclusiveIndicatorRetrieval.GapType = _gapType;
			return newMETAViewMutuallyExclusiveIndicatorRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewMutuallyExclusiveIndicatorRetrievalBase Entity 
		///</summary>
		public virtual METAViewMutuallyExclusiveIndicatorRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewMutuallyExclusiveIndicatorRetrieval copy = new METAViewMutuallyExclusiveIndicatorRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewMutuallyExclusiveIndicatorRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewMutuallyExclusiveIndicatorRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewMutuallyExclusiveIndicatorRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewMutuallyExclusiveIndicatorRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewMutuallyExclusiveIndicatorRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewMutuallyExclusiveIndicatorRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewMutuallyExclusiveIndicatorRetrievalBase Object1, METAViewMutuallyExclusiveIndicatorRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewMutuallyExclusiveIndicatorRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewMutuallyExclusiveIndicatorRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewMutuallyExclusiveIndicatorRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewMutuallyExclusiveIndicatorRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
