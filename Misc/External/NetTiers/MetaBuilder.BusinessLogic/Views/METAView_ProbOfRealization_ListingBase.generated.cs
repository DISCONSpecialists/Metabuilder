/*
	...
	Important: Do not modify this file. Edit the file METAView_ProbOfRealization_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_ProbOfRealization_ListingBase")]
	public abstract partial class METAView_ProbOfRealization_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_ProbOfRealization_ListingBase"/> instance.
		///</summary>
		public METAView_ProbOfRealization_ListingBase()
		{
		}		
		...
		public METAView_ProbOfRealization_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _gapType, System.String _value)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_ProbOfRealization_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_gapType"></param>
		///<param name="_value"></param>
		public static METAView_ProbOfRealization_Listing CreateMETAView_ProbOfRealization_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _gapType, System.String _value)
		{
			METAView_ProbOfRealization_Listing newMETAView_ProbOfRealization_Listing = new METAView_ProbOfRealization_Listing();
			newMETAView_ProbOfRealization_Listing.WorkspaceName = _workspaceName;
			newMETAView_ProbOfRealization_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_ProbOfRealization_Listing.VCStatusID = _vCStatusID;
			newMETAView_ProbOfRealization_Listing.pkid = _pkid;
			newMETAView_ProbOfRealization_Listing.Machine = _machine;
			newMETAView_ProbOfRealization_Listing.VCMachineID = _vCMachineID;
			newMETAView_ProbOfRealization_Listing.GapType = _gapType;
			newMETAView_ProbOfRealization_Listing.Value = _value;
			return newMETAView_ProbOfRealization_Listing;
		}
		...
		///<summary>
		///  Returns a Typed METAView_ProbOfRealization_ListingBase Entity 
		///</summary>
		public virtual METAView_ProbOfRealization_ListingBase Copy()
		{
			//shallow copy entity
			METAView_ProbOfRealization_Listing copy = new METAView_ProbOfRealization_Listing();
			...
			copy.AcceptChanges();
			return (METAView_ProbOfRealization_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_ProbOfRealization_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_ProbOfRealization_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_ProbOfRealization_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_ProbOfRealization_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_ProbOfRealization_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_ProbOfRealization_ListingBase Object1, METAView_ProbOfRealization_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_ProbOfRealization_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_ProbOfRealization_Listing, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{9}{8}- WorkspaceName: {0}{8}- WorkspaceTypeId: {1}{8}- VCStatusID: {2}{8}- pkid: {3}{8}- Machine: {4}{8}- VCMachineID: {5}{8}- GapType: {6}{8}- Value: {7}{8}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_ProbOfRealization_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_ProbOfRealization_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
