/*
	...
	Important: Do not modify this file. Edit the file METAView_GatewayDescription_Listing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_GatewayDescription_ListingBase")]
	public abstract partial class METAView_GatewayDescription_ListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_GatewayDescription_ListingBase"/> instance.
		///</summary>
		public METAView_GatewayDescription_ListingBase()
		{
		}		
		...
		public METAView_GatewayDescription_ListingBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_GatewayDescription_Listing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_vCMachineID"></param>
		///<param name="_name"></param>
		public static METAView_GatewayDescription_Listing CreateMETAView_GatewayDescription_Listing(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name)
		{
			METAView_GatewayDescription_Listing newMETAView_GatewayDescription_Listing = new METAView_GatewayDescription_Listing();
			newMETAView_GatewayDescription_Listing.WorkspaceName = _workspaceName;
			newMETAView_GatewayDescription_Listing.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_GatewayDescription_Listing.VCStatusID = _vCStatusID;
			newMETAView_GatewayDescription_Listing.pkid = _pkid;
			newMETAView_GatewayDescription_Listing.Machine = _machine;
			newMETAView_GatewayDescription_Listing.VCMachineID = _vCMachineID;
			newMETAView_GatewayDescription_Listing.Name = _name;
			return newMETAView_GatewayDescription_Listing;
		}
		...
		{
			get { return "METAView_GatewayDescription_Listing"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_GatewayDescription_ListingBase Entity 
		///</summary>
		public virtual METAView_GatewayDescription_ListingBase Copy()
		{
			//shallow copy entity
			METAView_GatewayDescription_Listing copy = new METAView_GatewayDescription_Listing();
				...
				copy.Name = this.Name;
			copy.AcceptChanges();
			return (METAView_GatewayDescription_Listing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_GatewayDescription_ListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_GatewayDescription_ListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_GatewayDescription_ListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_GatewayDescription_ListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_GatewayDescription_ListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_GatewayDescription_ListingBase Object1, METAView_GatewayDescription_ListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_GatewayDescription_Listing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_GatewayDescription_Listing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_GatewayDescription_Listing columns.
	/// </summary>
	[Serializable]
	public enum METAView_GatewayDescription_ListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
