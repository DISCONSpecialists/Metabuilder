/*
	...
	Important: Do not modify this file. Edit the file METAView_LogicalITInfrastructureComponent_Retrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_LogicalITInfrastructureComponent_RetrievalBase")]
	public abstract partial class METAView_LogicalITInfrastructureComponent_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_LogicalITInfrastructureComponent_RetrievalBase"/> instance.
		///</summary>
		public METAView_LogicalITInfrastructureComponent_RetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_LogicalITInfrastructureComponent_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_architectureStatusDate"></param>
		///<param name="_designRationale"></param>
		public static METAView_LogicalITInfrastructureComponent_Retrieval CreateMETAView_LogicalITInfrastructureComponent_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _description, System.String _abbreviation, System.String _isBusinessExternal, System.String _standardisationStatus, System.String _standardisationStatusDate, System.String _dataSourceID, System.String _dataSourceName, System.String _generalRemarks, System.String _gapType, System.String _customField1, System.String _customField2, System.String _customField3, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale)
		{
			METAView_LogicalITInfrastructureComponent_Retrieval newMETAView_LogicalITInfrastructureComponent_Retrieval = new METAView_LogicalITInfrastructureComponent_Retrieval();
			newMETAView_LogicalITInfrastructureComponent_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.pkid = _pkid;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.Machine = _machine;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.VCMachineID = _vCMachineID;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.Name = _name;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.Description = _description;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.Abbreviation = _abbreviation;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.IsBusinessExternal = _isBusinessExternal;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.StandardisationStatus = _standardisationStatus;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.StandardisationStatusDate = _standardisationStatusDate;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.DataSourceID = _dataSourceID;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.DataSourceName = _dataSourceName;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.GeneralRemarks = _generalRemarks;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.GapType = _gapType;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.CustomField1 = _customField1;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.CustomField2 = _customField2;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.CustomField3 = _customField3;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.ArchitectureStatus = _architectureStatus;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.ArchitectureStatusDate = _architectureStatusDate;
			newMETAView_LogicalITInfrastructureComponent_Retrieval.DesignRationale = _designRationale;
			return newMETAView_LogicalITInfrastructureComponent_Retrieval;
		}
		...
		{
			get { return "METAView_LogicalITInfrastructureComponent_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_LogicalITInfrastructureComponent_RetrievalBase Entity 
		///</summary>
		public virtual METAView_LogicalITInfrastructureComponent_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_LogicalITInfrastructureComponent_Retrieval copy = new METAView_LogicalITInfrastructureComponent_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_LogicalITInfrastructureComponent_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_LogicalITInfrastructureComponent_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_LogicalITInfrastructureComponent_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_LogicalITInfrastructureComponent_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_LogicalITInfrastructureComponent_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_LogicalITInfrastructureComponent_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_LogicalITInfrastructureComponent_RetrievalBase Object1, METAView_LogicalITInfrastructureComponent_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_LogicalITInfrastructureComponent_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_LogicalITInfrastructureComponent_Retrieval, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{23}{22}- WorkspaceName: {0}{22}- WorkspaceTypeId: {1}{22}- VCStatusID: {2}{22}- pkid: {3}{22}- Machine: {4}{22}- VCMachineID: {5}{22}- Name: {6}{22}- Description: {7}{22}- Abbreviation: {8}{22}- IsBusinessExternal: {9}{22}- StandardisationStatus: {10}{22}- StandardisationStatusDate: {11}{22}- DataSourceID: {12}{22}- DataSourceName: {13}{22}- GeneralRemarks: {14}{22}- GapType: {15}{22}- CustomField1: {16}{22}- CustomField2: {17}{22}- CustomField3: {18}{22}- ArchitectureStatus: {19}{22}- ArchitectureStatusDate: {20}{22}- DesignRationale: {21}{22}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_LogicalITInfrastructureComponent_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_LogicalITInfrastructureComponent_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
