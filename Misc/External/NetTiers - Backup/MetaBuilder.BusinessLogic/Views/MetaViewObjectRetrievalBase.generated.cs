/*
	...
	Important: Do not modify this file. Edit the file METAViewObjectRetrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewObjectRetrievalBase")]
	public abstract partial class METAViewObjectRetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewObjectRetrievalBase"/> instance.
		///</summary>
		public METAViewObjectRetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewObjectRetrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_type"></param>
		///<param name="_gapType"></param>
		public static METAViewObjectRetrieval CreateMETAViewObjectRetrieval(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _customField1, System.String _customField2, System.String _customField3, System.String _type, System.String _gapType)
		{
			METAViewObjectRetrieval newMETAViewObjectRetrieval = new METAViewObjectRetrieval();
			newMETAViewObjectRetrieval.WorkspaceName = _workspaceName;
			newMETAViewObjectRetrieval.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewObjectRetrieval.VCStatusID = _vCStatusID;
			newMETAViewObjectRetrieval.Pkid = _pkid;
			newMETAViewObjectRetrieval.Machine = _machine;
			newMETAViewObjectRetrieval.VCMachineID = _vCMachineID;
			newMETAViewObjectRetrieval.Name = _name;
			newMETAViewObjectRetrieval.CustomField1 = _customField1;
			newMETAViewObjectRetrieval.CustomField2 = _customField2;
			newMETAViewObjectRetrieval.CustomField3 = _customField3;
			newMETAViewObjectRetrieval.Type = _type;
			newMETAViewObjectRetrieval.GapType = _gapType;
			return newMETAViewObjectRetrieval;
		}
		...
		///<summary>
		///  Returns a Typed METAViewObjectRetrievalBase Entity 
		///</summary>
		public virtual METAViewObjectRetrievalBase Copy()
		{
			//shallow copy entity
			METAViewObjectRetrieval copy = new METAViewObjectRetrieval();
			...
			copy.AcceptChanges();
			return (METAViewObjectRetrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewObjectRetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewObjectRetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewObjectRetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewObjectRetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewObjectRetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewObjectRetrievalBase Object1, METAViewObjectRetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewObjectRetrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewObjectRetrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewObjectRetrieval columns.
	/// </summary>
	[Serializable]
	public enum METAViewObjectRetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
