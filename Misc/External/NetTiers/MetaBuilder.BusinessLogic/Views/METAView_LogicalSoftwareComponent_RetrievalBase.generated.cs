/*
	...
	Important: Do not modify this file. Edit the file METAView_LogicalSoftwareComponent_Retrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_LogicalSoftwareComponent_RetrievalBase")]
	public abstract partial class METAView_LogicalSoftwareComponent_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_LogicalSoftwareComponent_RetrievalBase"/> instance.
		///</summary>
		public METAView_LogicalSoftwareComponent_RetrievalBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_LogicalSoftwareComponent_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_dataSourceID"></param>
		///<param name="_dataSourceName"></param>
		public static METAView_LogicalSoftwareComponent_Retrieval CreateMETAView_LogicalSoftwareComponent_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _abbreviation, System.String _description, System.String _isBusinessExternal, System.String _architectureStatus, System.String _architectureStatusDate, System.String _designRationale, System.String _generalRemarks, System.String _gapType, System.String _dataSourceID, System.String _dataSourceName)
		{
			METAView_LogicalSoftwareComponent_Retrieval newMETAView_LogicalSoftwareComponent_Retrieval = new METAView_LogicalSoftwareComponent_Retrieval();
			newMETAView_LogicalSoftwareComponent_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_LogicalSoftwareComponent_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_LogicalSoftwareComponent_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_LogicalSoftwareComponent_Retrieval.pkid = _pkid;
			newMETAView_LogicalSoftwareComponent_Retrieval.Machine = _machine;
			newMETAView_LogicalSoftwareComponent_Retrieval.VCMachineID = _vCMachineID;
			newMETAView_LogicalSoftwareComponent_Retrieval.Name = _name;
			newMETAView_LogicalSoftwareComponent_Retrieval.Abbreviation = _abbreviation;
			newMETAView_LogicalSoftwareComponent_Retrieval.Description = _description;
			newMETAView_LogicalSoftwareComponent_Retrieval.IsBusinessExternal = _isBusinessExternal;
			newMETAView_LogicalSoftwareComponent_Retrieval.ArchitectureStatus = _architectureStatus;
			newMETAView_LogicalSoftwareComponent_Retrieval.ArchitectureStatusDate = _architectureStatusDate;
			newMETAView_LogicalSoftwareComponent_Retrieval.DesignRationale = _designRationale;
			newMETAView_LogicalSoftwareComponent_Retrieval.GeneralRemarks = _generalRemarks;
			newMETAView_LogicalSoftwareComponent_Retrieval.GapType = _gapType;
			newMETAView_LogicalSoftwareComponent_Retrieval.DataSourceID = _dataSourceID;
			newMETAView_LogicalSoftwareComponent_Retrieval.DataSourceName = _dataSourceName;
			return newMETAView_LogicalSoftwareComponent_Retrieval;
		}
		...
		{
			get { return "METAView_LogicalSoftwareComponent_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_LogicalSoftwareComponent_RetrievalBase Entity 
		///</summary>
		public virtual METAView_LogicalSoftwareComponent_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_LogicalSoftwareComponent_Retrieval copy = new METAView_LogicalSoftwareComponent_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_LogicalSoftwareComponent_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_LogicalSoftwareComponent_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_LogicalSoftwareComponent_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_LogicalSoftwareComponent_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_LogicalSoftwareComponent_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_LogicalSoftwareComponent_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_LogicalSoftwareComponent_RetrievalBase Object1, METAView_LogicalSoftwareComponent_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_LogicalSoftwareComponent_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_LogicalSoftwareComponent_Retrieval, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{18}{17}- WorkspaceName: {0}{17}- WorkspaceTypeId: {1}{17}- VCStatusID: {2}{17}- pkid: {3}{17}- Machine: {4}{17}- VCMachineID: {5}{17}- Name: {6}{17}- Abbreviation: {7}{17}- Description: {8}{17}- IsBusinessExternal: {9}{17}- ArchitectureStatus: {10}{17}- ArchitectureStatusDate: {11}{17}- DesignRationale: {12}{17}- GeneralRemarks: {13}{17}- GapType: {14}{17}- DataSourceID: {15}{17}- DataSourceName: {16}{17}", 
				this.WorkspaceName,
	...
	/// <summary>
	/// Enumerate the METAView_LogicalSoftwareComponent_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_LogicalSoftwareComponent_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
