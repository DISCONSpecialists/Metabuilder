...
namespace MetaBuilder.Graphing.Shapes
{
    public class ArrowBuilder
    {
        ...
        private GoGroup CreateConcurrentLabel()
        {
            ...
            strLeft.Pen = new Pen(Color.Black, 0.5f);
            strLeft.Brush = Brushes.Black;//new SolidBrush(Color.Black);
            grp.Add(strLeft);
        ...
        private GoGroup CreateStartLabel()
        {
            ...
            ellipse.Width = 13;
            ellipse.Selectable = false;
            grpEllipseStart.Selectable = false;
        ...
        private GoGroup CreateSynchronizedLabel()
        {
            ...
            grpConcurrent.Selectable = false;
        ...
        private GoGroup CreateNonConcurrentLabel()
        {
            ...
            strDiagonal.Pen = new Pen(Color.Black, 0.5f);
            strDiagonal.Brush = Brushes.Black;//new SolidBrush(Color.Black);
