/*
	...
	Important: Do not modify this file. Edit the file METAViewDatedResponsibilityListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewDatedResponsibilityListingBase")]
	public abstract partial class METAViewDatedResponsibilityListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewDatedResponsibilityListingBase"/> instance.
		///</summary>
		public METAViewDatedResponsibilityListingBase()
		{
		}		
		...
		public METAViewDatedResponsibilityListingBase(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewDatedResponsibilityListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAViewDatedResponsibilityListing CreateMETAViewDatedResponsibilityListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAViewDatedResponsibilityListing newMETAViewDatedResponsibilityListing = new METAViewDatedResponsibilityListing();
			newMETAViewDatedResponsibilityListing.WorkspaceName = _workspaceName;
			newMETAViewDatedResponsibilityListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewDatedResponsibilityListing.VCStatusID = _vCStatusID;
			newMETAViewDatedResponsibilityListing.Pkid = _pkid;
			newMETAViewDatedResponsibilityListing.Machine = _machine;
			newMETAViewDatedResponsibilityListing.VCMachineID = _vCMachineID;
			return newMETAViewDatedResponsibilityListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewDatedResponsibilityListingBase Entity 
		///</summary>
		public virtual METAViewDatedResponsibilityListingBase Copy()
		{
			//shallow copy entity
			METAViewDatedResponsibilityListing copy = new METAViewDatedResponsibilityListing();
			...
			copy.AcceptChanges();
			return (METAViewDatedResponsibilityListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewDatedResponsibilityListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewDatedResponsibilityListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewDatedResponsibilityListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewDatedResponsibilityListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewDatedResponsibilityListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewDatedResponsibilityListingBase Object1, METAViewDatedResponsibilityListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewDatedResponsibilityListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewDatedResponsibilityListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewDatedResponsibilityListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewDatedResponsibilityListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
