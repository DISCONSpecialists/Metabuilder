/*
	...
	Important: Do not modify this file. Edit the file METAView_DataFlowIndicator_Retrieval.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAView_DataFlowIndicator_RetrievalBase")]
	public abstract partial class METAView_DataFlowIndicator_RetrievalBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAView_DataFlowIndicator_RetrievalBase"/> instance.
		///</summary>
		public METAView_DataFlowIndicator_RetrievalBase()
		{
		}		
		...
		public METAView_DataFlowIndicator_RetrievalBase(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAView_DataFlowIndicator_Retrieval"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeId"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_machine"></param>
		///<param name="_vCMachineID"></param>
		public static METAView_DataFlowIndicator_Retrieval CreateMETAView_DataFlowIndicator_Retrieval(System.String _workspaceName, System.Int32? _workspaceTypeId, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID)
		{
			METAView_DataFlowIndicator_Retrieval newMETAView_DataFlowIndicator_Retrieval = new METAView_DataFlowIndicator_Retrieval();
			newMETAView_DataFlowIndicator_Retrieval.WorkspaceName = _workspaceName;
			newMETAView_DataFlowIndicator_Retrieval.WorkspaceTypeId = _workspaceTypeId;
			newMETAView_DataFlowIndicator_Retrieval.VCStatusID = _vCStatusID;
			newMETAView_DataFlowIndicator_Retrieval.pkid = _pkid;
			newMETAView_DataFlowIndicator_Retrieval.Machine = _machine;
			newMETAView_DataFlowIndicator_Retrieval.VCMachineID = _vCMachineID;
			return newMETAView_DataFlowIndicator_Retrieval;
		}
		...
		{
			get { return "METAView_DataFlowIndicator_Retrieval"; }
		}
		...
		///<summary>
		///  Returns a Typed METAView_DataFlowIndicator_RetrievalBase Entity 
		///</summary>
		public virtual METAView_DataFlowIndicator_RetrievalBase Copy()
		{
			//shallow copy entity
			METAView_DataFlowIndicator_Retrieval copy = new METAView_DataFlowIndicator_Retrieval();
			...
			copy.AcceptChanges();
			return (METAView_DataFlowIndicator_Retrieval)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAView_DataFlowIndicator_RetrievalBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAView_DataFlowIndicator_RetrievalBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAView_DataFlowIndicator_RetrievalBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAView_DataFlowIndicator_RetrievalBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAView_DataFlowIndicator_RetrievalBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAView_DataFlowIndicator_RetrievalBase Object1, METAView_DataFlowIndicator_RetrievalBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAView_DataFlowIndicator_Retrieval entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAView_DataFlowIndicator_Retrieval, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAView_DataFlowIndicator_Retrieval columns.
	/// </summary>
	[Serializable]
	public enum METAView_DataFlowIndicator_RetrievalColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
