/*
	...
	Important: Do not modify this file. Edit the file METAViewCSFListing.cs instead.
*/
...
namespace MetaBuilder.BusinessLogic
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("METAViewCSFListingBase")]
	public abstract partial class METAViewCSFListingBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="METAViewCSFListingBase"/> instance.
		///</summary>
		public METAViewCSFListingBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="METAViewCSFListing"/> instance.
		///</summary>
		///<param name="_workspaceName"></param>
		///<param name="_workspaceTypeID"></param>
		///<param name="_vCStatusID"></param>
		...
		///<param name="_customField3"></param>
		///<param name="_gapType"></param>
		public static METAViewCSFListing CreateMETAViewCSFListing(System.String _workspaceName, System.Int32? _workspaceTypeID, System.Int32 _vCStatusID, System.Int32 _pkid, System.String _machine, System.String _vCMachineID, System.String _name, System.String _number, System.String _customField1, System.String _customField2, System.String _customField3, System.String _gapType)
		{
			METAViewCSFListing newMETAViewCSFListing = new METAViewCSFListing();
			newMETAViewCSFListing.WorkspaceName = _workspaceName;
			newMETAViewCSFListing.WorkspaceTypeID = _workspaceTypeID;
			newMETAViewCSFListing.VCStatusID = _vCStatusID;
			newMETAViewCSFListing.Pkid = _pkid;
			newMETAViewCSFListing.Machine = _machine;
			newMETAViewCSFListing.VCMachineID = _vCMachineID;
			newMETAViewCSFListing.Name = _name;
			newMETAViewCSFListing.Number = _number;
			newMETAViewCSFListing.CustomField1 = _customField1;
			newMETAViewCSFListing.CustomField2 = _customField2;
			newMETAViewCSFListing.CustomField3 = _customField3;
			newMETAViewCSFListing.GapType = _gapType;
			return newMETAViewCSFListing;
		}
		...
		///<summary>
		///  Returns a Typed METAViewCSFListingBase Entity 
		///</summary>
		public virtual METAViewCSFListingBase Copy()
		{
			//shallow copy entity
			METAViewCSFListing copy = new METAViewCSFListing();
			...
			copy.AcceptChanges();
			return (METAViewCSFListing)copy;
		}
		...
		///<returns>true if toObject is a <see cref="METAViewCSFListingBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(METAViewCSFListingBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="METAViewCSFListingBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="METAViewCSFListingBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="METAViewCSFListingBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(METAViewCSFListingBase Object1, METAViewCSFListingBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(METAViewCSFListing entity, string propertyName)
		{
			switch (propertyName)
			{
				case "WorkspaceName":
		...
		{			
			return GetPropertyValueByName(this as METAViewCSFListing, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the METAViewCSFListing columns.
	/// </summary>
	[Serializable]
	public enum METAViewCSFListingColumn
	{
		/// <summary>
		/// WorkspaceName : 
		/// </summary>
