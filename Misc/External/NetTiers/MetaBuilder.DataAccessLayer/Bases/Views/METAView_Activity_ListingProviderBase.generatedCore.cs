		...
		protected VList<METAView_Activity_Listing> Fill(IDataReader reader, VList<METAView_Activity_Listing> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.Description = (reader.IsDBNull(((int)METAView_Activity_ListingColumn.Description)))?null:(System.String)reader[((int)METAView_Activity_ListingColumn.Description)];
					//entity.Description = (Convert.IsDBNull(reader["Description"]))?string.Empty:(System.String)reader["Description"];
					entity.Abbreviation = (reader.IsDBNull(((int)METAView_Activity_ListingColumn.Abbreviation)))?null:(System.String)reader[((int)METAView_Activity_ListingColumn.Abbreviation)];
					//entity.Abbreviation = (Convert.IsDBNull(reader["Abbreviation"]))?string.Empty:(System.String)reader["Abbreviation"];
					entity.IsBusinessExternal = (reader.IsDBNull(((int)METAView_Activity_ListingColumn.IsBusinessExternal)))?null:(System.String)reader[((int)METAView_Activity_ListingColumn.IsBusinessExternal)];
					...
					entity.DataSourceID = (reader.IsDBNull(((int)METAView_Activity_ListingColumn.DataSourceID)))?null:(System.String)reader[((int)METAView_Activity_ListingColumn.DataSourceID)];
					//entity.DataSourceID = (Convert.IsDBNull(reader["DataSourceID"]))?string.Empty:(System.String)reader["DataSourceID"];
					entity.DataSourceName = (reader.IsDBNull(((int)METAView_Activity_ListingColumn.DataSourceName)))?null:(System.String)reader[((int)METAView_Activity_ListingColumn.DataSourceName)];
					//entity.DataSourceName = (Convert.IsDBNull(reader["DataSourceName"]))?string.Empty:(System.String)reader["DataSourceName"];
					entity.GeneralRemarks = (reader.IsDBNull(((int)METAView_Activity_ListingColumn.GeneralRemarks)))?null:(System.String)reader[((int)METAView_Activity_ListingColumn.GeneralRemarks)];
					//entity.GeneralRemarks = (Convert.IsDBNull(reader["GeneralRemarks"]))?string.Empty:(System.String)reader["GeneralRemarks"];
					entity.ArchitectureStatus = (reader.IsDBNull(((int)METAView_Activity_ListingColumn.ArchitectureStatus)))?null:(System.String)reader[((int)METAView_Activity_ListingColumn.ArchitectureStatus)];
					...
					entity.ArchitectureStatusDate = (reader.IsDBNull(((int)METAView_Activity_ListingColumn.ArchitectureStatusDate)))?null:(System.String)reader[((int)METAView_Activity_ListingColumn.ArchitectureStatusDate)];
					...
					entity.DesignRationale = (reader.IsDBNull(((int)METAView_Activity_ListingColumn.DesignRationale)))?null:(System.String)reader[((int)METAView_Activity_ListingColumn.DesignRationale)];
