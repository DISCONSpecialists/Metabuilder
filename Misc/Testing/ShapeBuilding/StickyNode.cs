...
namespace ShapeBuilding
{
    ...
    [Serializable]
    public class StickyNode : GoSubGraph, ISticker
    {
        // Let users resize these nodes; text changes don't resize the Background.
        public StickyNode()
        {
            this.Add(new VCS(100, 100));//, 500, 300, true));
            this.BorderPen = new Pen(Color.Transparent, 0);
    ...
    {
        public StickyDraggingTool(GoView view)
            : base(view)
        { }
